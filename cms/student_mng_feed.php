				...
				<div class="block-border">
					...
					<div class="block-content">
						<table id="table-example" class="table">
							...
							<tbody>
                            <?php 
							$qry=mysql_query("SELECT distinct p_id FROM afeedback WHERE ay_id=$acyear");
							$count=1;
			  while($row1=mysql_fetch_array($qry))
        		{
					$pid=$row1['p_id'];
					$parentlist1=mysql_query("SELECT * FROM afeedback WHERE p_id=$pid AND ay_id=$acyear"); 
				...
				?>
                                ...
                                <?php $select_record2=mysql_query("SELECT * FROM afeedback WHERE c_id=$cid AND s_id=$sid AND p_id=$pid AND ay_id=$acyear AND status='1' AND send='parent'");						
								$unread=0;
					while($classtest21=mysql_fetch_array($select_record2))
					{ $unread++;
					}
					$unread1=0;
					$parentli1=mysql_query("SELECT * FROM afeedback WHERE p_id=$pid AND ay_id=$acyear"); 
					...
					{ $unread1++;
                                ...
                                <td><center><?php echo $unread1; ?></center></td>
                                 ...
                                 <center><a href="astudent_mng_feedback.php?bid=<?php echo $bid; ?>&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>&pid=<?php echo $pid; ?>"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> View</button></a></center>
                                 </td>
								</tr> 
                                 <?php 
							$count++;
