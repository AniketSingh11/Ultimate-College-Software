            ...
            <div class="grid_12">
				<div class="block-border">
					...
					<div class="block-content">
						<table id="table-example" class="table">
							...
							$sid=$_GET['sid']; 
							$ssid=$_GET['ssid']; 
							$qry=mysql_query("SELECT * FROM mfinvoice WHERE c_id=$cid AND s_id=$sid AND ss_id=$ssid AND bid=$bid AND ay_id=$acyear");
							$count=1;
			  while($row=mysql_fetch_array($qry))
				...
				?>
								...
								<td class="view"><center><a href="mfeesinvoice_report_detail.php?fiid=<?php echo $row['fi_id'];?>&bid=<?php echo $bid;?>"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> View</button></a></center></td>
								 <?php 
							$count++;
							} ?>                               																
							</tbody>
