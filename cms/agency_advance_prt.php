       ...
       <header class="clearfix">
        ...
        <main>
            <div id="details" class="clearfix">
                <div id="client">
                    <div class="to">TO:</div>
                    <h2 class="name"><?php echo $row['a_name']; ?></h2>
                    <div class="address"><?php echo nl2br($row["a_address"]); ?></div>
                </div>
                <div id="invoice">

                    <div class="date">Date of Bill: <?php echo date("d/m/Y", strtotime($row["adv_date"])); ?></div>
                    <div class="date">Receipt No: <?= $row["rec_no"]; ?></div>
                </div>

            </div>
            <center><h2> Advance Payment Receipt</h2></center><br><br>
            <?php if ($ptype) {
                ?>
                <table border="0" cellspacing="0" cellpadding="0">
                    <thead>
                        <tr>
                            ...
                            <th class="desc" colspan="4">Agency Name</th>
                    ...
                    <tr>
                        ...
                        <td class="desc" colspan="4"><?= $row['a_name']; ?></td>
                        <td class="unit"><center><?php echo $row['adv_purpose']; ?></center></td>      
                    <td class="total"><?php echo number_format($row['adv_amt'], 2); ?></td>
                    </tr>
                    ...
                    <tfoot>
                        ...
                        <?php
                        $amount = number_format($row['adv_amt'], 2);
                        echo convert_number_to_words(str_replace('.00', '', $row['adv_amt']));
                        ?> Rupees Only
                    </center>
                    </td>
                ...
                <h3><b> <?php if ($ptype == "card") { ?>  Card Number: <?php
                        ...
                        ?> 
                        <?php if ($ptype == "cheque") { ?>
                            Cheque Number: <?php echo $row['pay_number']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            Bank Name: <?php echo $row['bank']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cheque Date: <?php
                            echo $row['c_date'];
                        }
                        ?>
