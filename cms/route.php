    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover">Route Master</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Route Master</h1>
                <a href="route_add.php" title="add"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> Add New</button></a>
				<?php $msg=$_GET['msg'];
				if($msg=="dsucc"){?>
            ...
            <div class="grid_12">
					...
					<div class="block-content">
						<table id="table-example" class="table">
							<thead>
								<tr>
									<th>S.No</th>
                                    <th><center>Route Master Name</center></th>
							...
							<tbody>
                            <?php 
							$qry=mysql_query("SELECT * FROM route");
							$count=1;
			  while($row=mysql_fetch_array($qry))
				...
				?>
								...
								<td><center><?php echo $row['r_name']; ?></center></td>
                                ...
                                <td><center><?php echo $row['r_contact']; ?></center></td>
                                ...
                                <td class="view"><center><a href="stopping.php?rid=<?php echo $row['r_id'];?>"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> View</button></a></center></td>
								<td class="action"><a href="route_edit.php?rid=<?php echo $row['r_id'];?>" title="Edit"><img src="./img/edit.png" alt="edit"></a> <a href="route_delete.php?rid=<?php echo $row['r_id']; ?>" class="delete" title="delete" onClick="return confirm('are you sure you wish to delete this record');"><img src="./img/del.png" alt="delete"></a></td>
								</tr> 
                                 <?php 
							$count++;
							} ?>                               																
