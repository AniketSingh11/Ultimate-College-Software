				...
				<div class="block-border">
					...
					<div class="block-content">
						<table id="table-example" class="table">
                            ...
                            $emp_query="select * from staff_loan where st_id='$stid'  order by l_id desc";
                            		...
                            		$loanpay=mysql_fetch_array($loanpay1);
                            		    ?>
                            										 <tr>
                                                                         ...
                                                                         <td><center><a href="view_staffloandetails.php?id=<?php echo $l_id;?>&stid=<?php echo $emp_id;?>"<button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> View</button></a></center></td>	
                                        <td><a title="Details" href="javascript:void(0);" onclick="$('#info-dialog<?php echo $emp_count;?>').dialog({ modal: true });" ><img src="./img/detail.png" alt="Details"></a></td>
                                                                                            </tr>
								   <!-- Modal Box Content -->
