 ...
 if (isset($_POST['submit']))
{
	...
	$sql="INSERT INTO bank_withdrawl (date,date_day,date_month,date_year,account_no,b_name,withdrawl_by,amount,ba_id,ay_id,cheque_no) VALUES
('$date','$date_day','$date_month','$date_year','$acc_no','$b_name','$withdrawl_by','$amount','$baid1','$acyear','$chequeno')";
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover"><a href="bwithdrawl_mng.php?baid=<?php echo $baid; ?>" title="month">Bank withdrawl Details</a></li>
                <li class="no-hover">Add New Bank withdrawl</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Add New Bank withdrawl</h1>                
			<a href="bwithdrawl_mng.php?baid=<?php echo $baid; ?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
            <div style="float:right">
             	Current Hand Cash Total :<button class="btn btn-small btn-success"><?=$currentcash?> Rs/-</button>
                <?php if($baid){?>
             &nbsp; | &nbsp;
             	Account Total :<button class="btn btn-small btn-success"><?=$accountamount?> Rs/-</button> <?php } ?>
             </div>
			</div>
            <div class="grid_12">
            <?php 
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Add New Bank withdrawl Details</h1><span></span>
					</div>
                    ...
                    <div class="_25">
                        ...
                        <div class="_25">
							<p>
                                ...
                                <input id="withdrawl_by" name="withdrawl_by" class="required" type="text" value="" />
                            </p>
						</div>
                        <div class="_25">
							<p>
                                <label for="textfield">Self Cheque No <span class="error">*</span></label>
                                <input id="cheque_no" name="cheque_no" class="required" type="text" value="" />
                            </p>
						</div>
                        <div class="_50">
							<p>
                                <label for="textfield">Amount <span class="error">*</span></label>
                                <input id="amount" name="amount" class="required" type="text" value="" <?php if($baid){?> max="<?=$accountamount?>"<?php } ?> />
                            </p>
						</div>
						<div class="clear"></div>
