...
<div style="margin-left:32px;font-size:11px;">EMIS.No :<b><?php echo $row['eno']; ?></b></div>
...
<center><b style="font-weight:bold;font-size:12.5px;">DECLARATION BY PARENT OR GUARDIAN</b></center>
