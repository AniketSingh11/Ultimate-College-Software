...
{	
	...
	$sql="UPDATE student SET admission_number='$admin_no',application='$application',firstname='$fname',lastname='$lname',middlename='$mname',dob='$dob',day='$date_day',month='$date_month',year='$date_year',gender='$gender',blood='$blood',nation='$belong',reg='$religion',caste='$caste',sub_caste='$subcaste',fathersname='$p_name',email='$email',address1='$address1',address2='$address2',city_id='$village',country='$country',pin='$pincode',phone_number='$phone',user_status='$status',fathersocupation='$p_occup',p_income='$p_income',m_name='$m_name',m_occup='$m_occup',m_income='$m_income',from_school='$from_school',doa='$doa',mother_tongue='$m_tongue',height='$height',weight='$weight',std_leaving='$leaving',no_date_tran='$notc',dol='$dol',reason_leaving='$reason_leaving',remarks='$remarks',b_id='$bid',stype='$stype',fdis_id='$fdis_id',r_id='$rid',sp_id='$spid',busfeestype='$busfeestype',ay_id='$acyear',photo='$newfilename',sel_hostel='$sel_hostel',mlate_join='$mlate_join',mpd_id='$mpd_id',blate_join='$blate_join',mode='$mode',s_ship='$s_ship',s_reson='$s_reson',second_lang='$second_lang',route='$route',phone2='$phone2',roll_no='$roll_no' WHERE ss_id='$ssid'";
...
$qry=mysql_query("UPDATE student SET p_id='$pid1' WHERE ss_id='$ssid'");
    ...
    exit;
		...
		if($gender=='M'){
			...
			$photo=$admin_no.".JPG";
		//}
		$sql="UPDATE student SET admission_number='$admin_no',application='$application',firstname='$fname',lastname='$lname',middlename='$mname',dob='$dob',day='$date_day',month='$date_month',year='$date_year',gender='$gender',blood='$blood',nation='$belong',reg='$religion',caste='$caste',sub_caste='$subcaste',fathersname='$p_name',email='$email',address1='$address1',address2='$address2',city_id='$village',country='$country',pin='$pincode',phone_number='$phone',user_status='$status',fathersocupation='$p_occup',p_income='$p_income',m_name='$m_name',m_occup='$m_occup',m_income='$m_income',from_school='$from_school',doa='$doa',mother_tongue='$m_tongue',height='$height',weight='$weight',std_leaving='$leaving',no_date_tran='$notc',dol='$dol',reason_leaving='$reason_leaving',remarks='$remarks',b_id='$bid',stype='$stype',fdis_id='$fdis_id',r_id='$rid',sp_id='$spid',busfeestype='$busfeestype',ay_id='$acyear',photo='$photo',sel_hostel='$sel_hostel',mlate_join='$mlate_join',mpd_id='$mpd_id',blate_join='$blate_join',mode='$mode',s_ship='$s_ship',s_reson='$s_reson',second_lang='$second_lang',route='$route',phone2='$phone2',roll_no='$roll_no' WHERE ss_id='$ssid'";
					...
					<form id="validate-form" class="block-content form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="_25">
                                    <p>
                                        ...
                                        <input id="admin_no1" name="application"  type="text" value="<?php echo $row['application']; ?>" />
                                    </p>
                                </div>
						...
						<div class="_25">
                                    <p>
                                        ...
                                        <input id="" name="roll_no" type="text" value="<?php echo $row['roll_no']; ?>" />
                                    </p>
                                </div>
                        <div class="_25">
							<p>
                       ...
                       <div class="_25">
						...
						<div class="_25">
							<p>
                                ...
                                <input id="textfield" name="phone2" class="required" type="text" value="<?php echo $row['phone2']; ?>" />
                            </p>
						</div>
                        ...
                        <?php $castelist=array("BC","MBC","DNC","SC","ST","SC(A)","OC","BC (M)","REFUGEE"); ?>
                        <div class="_25">
							<p>
                                ...
                                <?php $castevalue=$row['caste'];
									for ($cmonth = 0; $cmonth < count($castelist); $cmonth++) {
                        ...
                        <div class="_25">
						 ...
						 <div class="_50" style="clear: both;">
							<p>
                               ...
                               <select name="s_ship" class="required" onchange="sreson(this.value);">
									<?php if($row['s_reson']=="Yes") { ?>
									<option value="Yes" selected>Yes</option>
									<?php } else { ?>
									<option value="Yes">Yes</option>
									<?php } ?>
									<?php if($row['s_reson']=="No") { ?>
						 ...
						 <div class="_50" id="sreson" style="display: none;">
							<p>
                                ...
                                <input id="textfield" name="s_reson" type="text" value="<?= $row['s_reson'];?>" />
                            </p>
						</div>
						<?php } else {	?>
						<div class="_50" id="sreson">
							<p>
                                <label for="textfield">Scholar ship Details </label>
                                <input id="textfield" name="s_reson" type="text" value="<?= $row['s_reson'];?>" />
                            </p>
						...
						<?php }	?>
						 ...
						 <div class="_50">
                            ...
                            <input id="textfield"  name="second_lang" value="<?= $row['second_lang']?>" />
						</div>
							...
							<p>
								<label for="select" >Stopping Point :</label>
                               		<?php $spid=$row['sp_id'];
                                            ...
                                            echo '<select name="spid" id="spid" onchange="findRoot(this.value);"> <option value="0">Please select</option>';
