    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Bill Paid Manage</li>
			</ul>
            ...
            <?php 
					...
					if($aid){
							 $agencylist=mysql_query("SELECT * FROM agency WHERE a_id=$aid"); 
								  ...
								  ?>
			<div class="grid_12">
				<h1><?php  if($aid){ echo $agency['a_name'];} else{ echo "All";} ?> Bill Paid Manage</h1>
			 ...
			 <a href="export_exponsei.php?aid=<?php echo $aid;?>" title="Download" style="margin-left:10px;"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> Download Excel</button></a>
            ...
            <div class="grid_12">
            	<div class="block-border">
					<div class="block-header">
                    	<h1><?php  if($aid){ echo $agency['a_name'];} else{ echo "All";} ?> Bill Paid Details</h1>
                        <span></span>
					</div>
					...
					$aid1=$row['a_id'];
					 $agencylist1=mysql_query("SELECT * FROM agency WHERE a_id=$aid1"); 
								...
								<td><center>Rs. <?php echo number_format($row['amount'],2); ?></center></td> 
                                 ...
                                 <a href="exponse_mngi_edit.php?epid=<?php echo $row['ep_id'];?>" title="Edit"><img src="./img/edit.png" alt="edit"></a>
                                 
                                 <a href="exponse_mngi_delete.php?epid=<?php echo $row['ep_id']; ?>" class="delete" title="Bill Reject" rel="tooltip-top" onClick="return confirm('are you sure you wish to delete this record');"><img src="./img/del.png" alt="delete"></a>
                                 <?php } ?>
                                 </td>
								</tr> 
