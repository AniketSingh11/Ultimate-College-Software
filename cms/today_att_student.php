    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Today Present StudentList</li>
			</ul>
		...
		<div id="main-content">        		
            ...
            <div class="block-border">
					...
					<form id="validate-form" class="block-content form" target="_blank" method="get" action="today_att_student_prt.php">
						<div class="_25">
							<p>
