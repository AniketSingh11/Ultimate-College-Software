...
<body id="top">
    ...
    <div id="container">
                    ...
                    if ($sdate && $edate) {
                        ...
                        <div class="grid_12">
                            ...
                            <div id="invoice" class="widget widget-plain">			
                                    ...
                                    <table class="table table-striped" id="table-example">	
                                        ...
                                        <tbody>
                                            ...
                                            while ($row5 = mysql_fetch_assoc($qry5)) {
                                               ...
                                               ///fg_amount_ch = 0;
                                                $feeslist1 = mysql_query("SELECT * FROM finvoice WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $startdate . "' AND '" . $enddate . "' AND ay_id=$acyear and c_status!='1' AND i_status='0' AND cat LIKE 'CL%' group by (fi_year*10000) + (fi_month*100) + fi_day order by fi_id");
                                               
                                              
                                                while ($fees2 = mysql_fetch_assoc($feeslist1)) {
                                                    $sameday=$fees2['fi_year'].$fees2['fi_month'].$fees2['fi_day'];
                                                    $feeslist2 = mysql_query("SELECT * FROM finvoice WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $sameday . "' AND '" . $sameday . "' AND ay_id=$acyear and c_status!='1' AND i_status='0' AND cat LIKE 'CL%'");
                                               
                                                $n=0;
                                                 $fg_amount_cl = 0;
                                                while ($fees1 = mysql_fetch_assoc($feeslist2)) {
                                                    if($n==0){
                                                        $cls=$fees1['fr_no'];
                                                        $n++;
                                                    }
                                         ...
                                         if ($fg_amount_cl != 0) {
                                            ...
                                            <tr>
                                                <td><?php echo $count; ?></td>          
                                                <td><center>(<?php echo $fees2['fi_day'].'/'.$fees2['fi_month'].'/'.$fees2['fi_year'];?>) KG Term Fees (<?= $frmmto?>)</center></td>
                                                <td class="total"><center>-</center></td>
                                        ...
                                        $feeslist1 = mysql_query("SELECT * FROM finvoice WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $startdate . "' AND '" . $enddate . "' AND ay_id=$acyear and c_status!='1' AND i_status='0' AND cat LIKE 'CM%' group by (fi_year*10000) + (fi_month*100) + fi_day order by fi_id");
                                               
                                               
                                               
                                                    while ($fees2 = mysql_fetch_assoc($feeslist1)) {
                                                    $sameday=$fees2['fi_year'].$fees2['fi_month'].$fees2['fi_day'];
                                                    $feeslist2 = mysql_query("SELECT * FROM finvoice WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $sameday . "' AND '" . $sameday . "' AND ay_id=$acyear and c_status!='1' AND i_status='0' AND cat LIKE 'CM%'");
                                         ...
                                         if ($fg_amount_cm != 0) {
                                            ...
                                            <tr>
                                                <td><?php echo $count; ?></td>          
                                                <td><center>(<?php echo $fees2['fi_day'].'/'.$fees2['fi_month'].'/'.$fees2['fi_year'];?>) HS Term Fees (<?= $frmmto?>)</center></td>
                                                <td class="total"><center>-</center></td>
                                            ...
                                            $count++;
                                                ...
                                                $feeslist1 = mysql_query("SELECT * FROM finvoice WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $startdate . "' AND '" . $enddate . "' AND ay_id=$acyear and c_status!='1' AND i_status='0' AND cat LIKE 'CH%' group by (fi_year*10000) + (fi_month*100) + fi_day order by fi_id");
                                               
                                                while ($fees2 = mysql_fetch_assoc($feeslist1)) {
                                                    $sameday=$fees2['fi_year'].$fees2['fi_month'].$fees2['fi_day'];
                                                    $feeslist2 = mysql_query("SELECT * FROM finvoice WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $sameday . "' AND '" . $sameday . "' AND ay_id=$acyear and c_status!='1' AND i_status='0' AND cat LIKE 'CH%'");
                                         ...
                                         if ($fg_amount_ch != 0) {
                                            ...
                                            <tr>
                                                <td><?php echo $count; ?></td>          
                                                <td><center>(<?php echo $fees2['fi_day'].'/'.$fees2['fi_month'].'/'.$fees2['fi_year'];?>) HSS Term Fees (<?= $frmmto?>)</center></td>
                                                <td class="total"><center>-</center></td>
                                        ...
                                        $other=mysql_query("SELECT * FROM finvoice_others WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $startdate. "' AND '" . $enddate. "' AND ay_id='" . $acyear. "' and c_status!='1' AND i_status='0' group by (fi_year*10000) + (fi_month*100) + fi_day");

                                        //$book=0;
                                        while($all=mysql_fetch_assoc($other)){
                                            $sameday=$all['fi_year'].$all['fi_month'].$all['fi_day'];
                                           $other1=mysql_query("SELECT * FROM finvoice_others WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $sameday. "' AND '" . $sameday. "' AND ay_id='" . $acyear. "' and c_status!='1' AND i_status='0'");
                                        $book=0;
                                        while($all1=mysql_fetch_assoc($other1)){
                                            $book+=$all1['fi_total'];
                                       ...
                                       if($book!=0) {
                                        ...
                                        <tr>
                                                    ...
                                                    <td><center>(<?php echo $all['fi_day'].'/'.$all['fi_month'].'/'.$all['fi_year'];?>) Books, Notes & Other Items Fess</center></td>
                                                <td class="total"><center>-</center></td>
                                ...
                                <td colspan="4" class="sub_total"><center><b>Other Fees</b></center></td>
                                        ...
                                        while ($row1 = mysql_fetch_assoc($classl)) {
                                            ...
                                            $booklist1 = mysql_query("SELECT * FROM income WHERE (date_year*10000) + (date_month*100) + date_day between '" . $startdate . "' AND '" . $enddate . "' AND inc_id=$incid group by (date_year*10000) + (date_month*100) + date_day");

                                            while ($bus1 = mysql_fetch_assoc($booklist1)) {
                                                $in_amount = 0;
                                                $sameday=$bus1['date_year'].$bus1['date_month'].$bus1['date_day'];
                                            $booklist2 = mysql_query("SELECT amount FROM income WHERE (date_year*10000) + (date_month*100) + date_day between '" . $sameday . "' AND '" . $sameday . "' AND inc_id=$incid");
                                             $in_amount = 0;
                                             while ($bus2 = mysql_fetch_assoc($booklist2)) {
                                                $bamont1 = $bus2['amount'];
                                                $in_amount += $bamont1;
                                                $total +=$in_amount;
                                            }
                                            if ($in_amount != 0) {
                                                ...
                                                <tr>
                                                    <td><?php echo $count; ?></td>			
                                                    <td><center>(<?php echo $bus1['date_day'].'/'.$bus1['date_month'].'/'.$bus1['date_year']?>) <?= $row1['in_category'] ?></center></td>
                                                <td class="total"><center>-</center></td>
                                        ...
                                        while ($row6 = mysql_fetch_assoc($qry6)) {
                                            ...
                                            while ($exrow = mysql_fetch_assoc($exsqry)) {
                                                ...
                                                if ($count1 == 0) {
                                                    ...
                                                    //$exc_amount = 0;
                                                    $feeslist1 = mysql_query("SELECT * FROM exponses WHERE (date_year*10000) + (date_month*100) + date_day between '" . $startdate . "' AND '" . $enddate . "' AND exc_id=$exc_id  AND  exs_id IN (" . implode(',', $myarray) . ") AND type=0 group by (date_year*10000) + (date_month*100) + date_day");
                                                    while ($fees1 = mysql_fetch_assoc($feeslist1)) {
                                                    $exc_amount = 0;
                                                    $sameday=$fees1['date_year'].$fees1['date_month'].$fees1['date_day'];
                                                    $feeslist2 = mysql_query("SELECT status,amount,pending FROM exponses WHERE (date_year*10000) + (date_month*100) + date_day between '" . $sameday . "' AND '" . $sameday . "' AND exc_id=$exc_id  AND  exs_id IN (" . implode(',', $myarray) . ") AND type=0");
                                                    while ($fees2 = mysql_fetch_assoc($feeslist2)) {    

                                                        $type = $fees2['type'];
                                                        $status = $fees2['status'];
                                                        $amount1 = $fees2['amount'];
                                                        if ($status == '1') {
                                                            $exc_amount += $amount1;
                                                        }
                                                    }
                                                    //parcial qoutation payment
                                                    $feeslist3 = mysql_query("SELECT ex_id,amount FROM exponses_bill_summary WHERE (date_year*10000) + (date_month*100) + date_day between '" . $sameday . "' AND '" . $sameday . "' AND exc_id=$exc_id");
                                                    while ($fees3 = mysql_fetch_assoc($feeslist3)) {
                                                        $amount1 = $fees3['amount'];
                                                        $exid = $fees3['ex_id'];
                                                    ...
                                                    if ($exc_amount != 0) {
                                                        ...
                                                        <tr>
                                                            <td><?php echo $count; ?></td>			
                                                            <td><center>(<?php echo $fees1['date_day'].'/'.$fees1['date_month'].'/'.$fees1['date_year'];?>)<?php echo $subexname; ?></center></td>
                                                        <?php if ($e_category == '1') { ?>
                                                            <td class="total"><center>-</center></td>
                                                            <td class="total"><center>-</center></td>
                                        ...
                                        /**********************************daily Allowance ******************************** */
                                        $d_amount = 0;
                                        $booklist1 = mysql_query("SELECT * FROM exp_allowance WHERE (cdate >= '$startdate1' AND cdate <= '$enddate1') group by cdate");
                                        while ($bus1 = mysql_fetch_assoc($booklist1)) {
                                            $sameday=$bus1['cdate'];
                                            $booklist2 = mysql_query("SELECT total_amount FROM exp_allowance WHERE (cdate >= '$sameday' AND cdate <= '$sameday')");
                                        while ($bus2 = mysql_fetch_assoc($booklist2)) {
                                            $bamont1 = $bus2['total_amount'];
                                            $d_amount += $bamont1;
                                        }
                                        if ($d_amount != 0) {
                                            $etotal +=$d_amount;
                                        ...
                                        $feeslist2 = mysql_query("SELECT * FROM staff_month_salary WHERE (date_year*10000) + (date_month*100) + date_day between '" . $startdate . "' AND '" . $enddate . "' AND st_id=$pstid1 group by (date_year*10000) + (date_month*100) + date_day");

                                        while ($fees2 = mysql_fetch_assoc($feeslist2)) {
                                            $exc_amount1 = 0;
                                             $sameday=$fees2['date_year'].$fees2['date_month'].$fees2['date_day'];
                                            $feeslist3 = mysql_query("SELECT n_salary FROM staff_month_salary WHERE (date_year*10000) + (date_month*100) + date_day between '" . $sameday . "' AND '" . $sameday . "' AND st_id=$pstid1 ");
                                        while ($fees3 = mysql_fetch_assoc($feeslist3)) {
                                            $amount2 = $fees3['n_salary'];
                                            $exc_amount1 += $amount2;
                                        }
                                        $etotal +=$exc_amount1;
                                        if ($exc_amount1 != 0) {
                                            ...
                                            <tr>
                                                <td><?php echo $count; ?></td>			
                                                <td><b><center>(<?php echo $fees2['date_day'].'/'.$fees2['date_month'].'/'.$fees2['date_year'];?>)Principal Salary</center></b></td>
                         ...
                         /**********************************Teaching Staff Salary ******************************** */
                                        ...
                                        $feeslist2 = mysql_query("SELECT * FROM staff_month_salary WHERE (date_year*10000) + (date_month*100) + date_day between '" . $startdate . "' AND '" . $enddate . "' AND st_id AND st_id!=$pstid1 group by (date_year*10000) + (date_month*100) + date_day");
                                        while ($fees2 = mysql_fetch_assoc($feeslist2)) {
                                        $exc_amount1 = 0; 
                                        $sameday=$fees2['date_year'].$fees2['date_month'].$fees2['date_day'];  
                                        $feeslist3 = mysql_query("SELECT n_salary FROM staff_month_salary WHERE (date_year*10000) + (date_month*100) + date_day between '" . $sameday . "' AND '" . $sameday . "' AND st_id AND st_id!=$pstid1");
                                        while ($fees3 = mysql_fetch_assoc($feeslist3)) {    
                                            $amount2 = $fees3['n_salary'];
                                            $exc_amount1 += $amount2;
                                        }
                                        ...
                                        if ($exc_amount1 != 0) {
                                            ...
                                            <tr>
                                                <td><?php echo $count; ?></td>			
                                                <td><b><center>(<?php echo $fees2['date_day'].'/'.$fees2['date_month'].'/'.$fees2['date_year'];?>)Teaching Staff Salary</center></b></td>
                                                <td class="total"><center>Rs. <?php echo number_format($exc_amount1, 2); ?></center></td>
                                            <td class="total"><center>-</center></td>
                                            <td class="total"><center>-</center></td>
                                            </tr>
        ...
        /*********************************Non-Teaching Staff Salary ******************************** */
                                        ...
                                        $feeslist2 = mysql_query("SELECT * FROM staff_month_salary WHERE (date_year*10000) + (date_month*100) + date_day between '" . $startdate . "' AND '" . $enddate . "' AND (o_id OR d_id) group by (date_year*10000) + (date_month*100) + date_day");
                                        while ($fees2 = mysql_fetch_assoc($feeslist2)) {
                                        $exc_amount1 = 0;   
                                        $sameday=$fees2['date_year'].$fees2['date_month'].$fees2['date_day'];
                                        $feeslist3 = mysql_query("SELECT n_salary FROM staff_month_salary WHERE (date_year*10000) + (date_month*100) + date_day between '" . $sameday . "' AND '" . $sameday . "' AND (o_id OR d_id)");
                                        ...
                                        if ($exc_amount1 != 0) {
                                            ...
                                            <tr>
                                                <td><?php echo $count; ?></td>			
                                                <td><b><center>(<?php echo $fees2['date_day'].'/'.$fees2['date_month'].'/'.$fees2['date_year'];?>)Non-Teaching Staff Salary</center></b></td>
                                                <td class="total"><center>Rs. <?php echo number_format($exc_amount1, 2); ?></center></td>
                                            <td class="total"><center>-</center></td>
                                            <td class="total"><center>-</center></td>
                                            </tr>
            ...
            /********************************** Staff Salary Advance  ******************************** */
                                        ...
                                        $feeslist2 = mysql_query("SELECT * FROM staff_advance WHERE (year*10000) + (month*100) + day between '" . $startdate . "' AND '" . $enddate . "' AND status=0 group by (year*10000) + (month*100) + day");
                                        while ($fees2 = mysql_fetch_assoc($feeslist2)) {
                                        $exc_amount1 = 0;
                                        $sameday=$fees2['year'].$fees2['month'].$fees2['day'];
                                        $feeslist3 = mysql_query("SELECT a_amount FROM staff_advance WHERE (year*10000) + (month*100) + day between '" . $sameday . "' AND '" . $sameday . "' AND status=0");
                                        while ($fees3 = mysql_fetch_assoc($feeslist3)) {
                                            $amount2 = $fees3['a_amount'];
                                            $exc_amount1 += $amount2;
                                        }
                                        $etotal +=$exc_amount1;
                                        if ($exc_amount1 != 0) {
                                            ...
                                            <tr>
                                                <td><?php echo $count; ?></td>			
                                                <td><b><center>(<?php echo $fees2['day'].'/'.$fees2['month'].'/'.$fees2['year'];?>)Staff Salary Advance </center></b></td>
                                                <td class="total"><center>Rs. <?php echo number_format($exc_amount1, 2); ?></center></td>
                                            <td class="total"><center>-</center></td>
                                            <td class="total"><center>-</center></td>
                                            </tr>
            ...
            /********************************* EPF - ESI Contribution ******************************** */
                                        ...
                                        while ($allded2 = mysql_fetch_assoc($alldedlist2)) {
                                            ...
                                            $adname = $allded2['name'];
                                            //$exc_amount1 = 0;
                                            $feeslist2 = mysql_query("SELECT b.pevalue,b.amount,a.year,a.month,a.day FROM staff_month_salary a, staff_month_salary_summary b WHERE (a.year*10000) + (a.month*100) + a.day between '" . $startdate . "' AND '" . $enddate . "' AND a.st_ms_id = b.st_ms_id AND b.ad_id=$adid AND b.pevalue group by (a.year*10000) + (a.month*100) + a.day");
                                            while ($fees2 = mysql_fetch_assoc($feeslist2)) {
                                                $sameday=$fees2['year'].$fees2['month'].$fees2['day'];
                                            $exc_amount1 = 0;
                                            $feeslist3 = mysql_query("SELECT b.pevalue,b.amount FROM staff_month_salary a, staff_month_salary_summary b WHERE (a.year*10000) + (a.month*100) + a.day between '" . $sameday . "' AND '" . $sameday . "' AND a.st_ms_id = b.st_ms_id AND b.ad_id=$adid AND b.pevalue");
                                            while ($fees3 = mysql_fetch_assoc($feeslist3)) {    
                                                $staffpreamount = $fees3['amount'];
                                                $preamount = $fees3['pevalue'];
                                                if ($staffpreamount) {
                                            ...
                                            if ($exc_amount1 != 0) {
                                                ...
                                                <tr>
                                                    <td><?php echo $count; ?></td>			
                                                    <td><b><center>(<?php $fees2['day'].'/'.$fees2['month'].'/'.$fees2['year'];?>)<?php echo $adname . " Contribution"; ?></center></b></td>
                                                    <td class="total"><center>Rs. <?php echo number_format($exc_amount1, 2); ?></center></td>
                                                <td class="total"><center>-</center></td>
                                                <td class="total"><center>-</center></td>
                                                </tr>
