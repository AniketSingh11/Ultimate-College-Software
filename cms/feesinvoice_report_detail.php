    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><a href="javascript: window.history.go(-1)" title="Fees Payment">Fees Income Report </a></li> 
		...
		<div id="main-content">
			...
			?>
                ...
                <ul class="client_details">
					...
					<li>Stu. Category: <b><?php if($scateg=='1'){ echo "After IB"; }else{ echo "Before IB";}?></li>					
				</ul>
                <ul class="client_details">
