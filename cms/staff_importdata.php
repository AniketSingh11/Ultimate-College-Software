 ...
 if($_SERVER['REQUEST_METHOD']=="POST")
 {
     ...
     */
     ...
     if($_FILES["file1"]["size"] > 0)
     {
      ...
      $array_name1=mysql_real_escape_string($emapData[1]);
      $array_name2=mysql_real_escape_string($emapData[2]);
      $array_name3=mysql_real_escape_string($emapData[3]);
      $array_name4=mysql_real_escape_string($emapData[4]);
      $array_name5=mysql_real_escape_string($emapData[5]);
      $array_name6=mysql_real_escape_string($emapData[6]);
      $array_name7=mysql_real_escape_string($emapData[7]);
      $array_name8=mysql_real_escape_string($emapData[8]);
      $array_name9=mysql_real_escape_string($emapData[9]);
      $array_name10=mysql_real_escape_string($emapData[10]);
      $array_name11=mysql_real_escape_string($emapData[11]);
      $array_name12=mysql_real_escape_string($emapData[12]);
      $array_name13=mysql_real_escape_string($emapData[13]);
			...
			<div class="grid_12">
             ...
             <a href="staff.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
                ...
                <div class="alert success"><span class="hide">x</span>Your Record Successfully Imported !!!</div>
                 <?php  }?>     
                  <a href="sample_staff.csv" target="_blank" style="margin:0px 10px 0 0px; float:right;"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/inbox-download.png"> Download Sample File</button></a>
