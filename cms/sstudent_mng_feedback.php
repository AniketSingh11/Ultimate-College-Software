...
('$stid','$pid','$title','$msg','$todaydate','$cid','$sid','$bid','$acyear','1','staff')");
	 if($sql){
		 	 header("Location:sstudent_mng_feedback.php?bid=$bid&cid=$cid&sid=$sid&ssid=$ssid&pid=$pid&msg=succ");		 	 
	 }else{
		 header("Location:sstudent_mng_feedback.php?stid=$stid&msg=err");
	 }
 }
 ?>
</head>
    ...
    <?php 
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><a href="sboard_select_class_feed.php?bid=<?php echo $bid; ?>" title="Select Class">Class List</a></li>
                <li class="no-hover"><a href="sstudent_mng_feed.php?bid=<?php echo $bid; ?>&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>" title="Feedback list">Feedback list</a></li>
		...
		<div id="main-content">
            ...
            <a href="sstudent_mng_feed.php?bid=<?php echo $bid; ?>&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
            <div class="grid_12">
            </div>
			<?php
            ...
            <div class="grid_12">
				<div class="block-border">
                  ...
                  <tr style="border:1px solid #C1C0C0;">
                      <td width="150px;">
                          <?php if($send=="staff"){ echo "<strong> You<br></strong><span style=' font-size:12px'>".$subject3['date']."</span> "; } else { echo "<strong> ".$result3['p_name']."<br></strong><span style=' font-size:12px'>".$subject3['date']."</span> ";}?>                      </td>
