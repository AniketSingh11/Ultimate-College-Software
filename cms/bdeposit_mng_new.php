...
('$date','$date_day','$date_month','$date_year','$acc_no','$b_name','$deposit_by','$amount','$baid1','$acyear')";
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Add New Bank Deposit</li>
			</ul>
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Add New Bank Deposit Details</h1><span></span>
					</div>
