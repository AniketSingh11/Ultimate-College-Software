					...
					<form id="validate-form" class="block-content form" action="" method="post">
                       ...
                       <div class="_25">
                            <p>
                                ...
                                <input id="textfield" name="tmr_no" class="required" type="text" value="<?= $row['tmr_no']?>"/>
                            </p>
                        </div>
                        <?php }  else {?>
                        <input id="textfield" name="cert_no"  type="hidden" value="0000"/>
                        <input id="textfield" name="reg_no"  type="hidden" value="0000" />
                         <input id="textfield" name="tmr_no"  type="hidden" value="0000" />
                        <?php }	?> 
						...
						<div class="_50">
							<p>
                                ...
                                a) <input id="textfield" name="personmarka" type="text" value="<?= $pm[0]?>" />
                            </p>
						</div>
                        <div class="_50">
                            <p>
                                <label for="textfield"><br></label>
                                b) <input id="textfield" name="personmarkb" type="text" value="<?= $pm[1]?>" />
                            </p>
                        </div>
						<div class="_100">
							<p>
					...
					<div class="_50">
							...
							<p>
                               ...
                               <?php if($row['scholarship']=="Yes"){
                                ...
                                if($row['scholarship']=="" || $row['scholarship']=="0"){
                                	echo '<option value="No">No</option>';
                                	echo '<option value="Yes">Yes</option>';
                                }
                                ?>
                                ...
                                <?php if($row['scholarship']=="Yes") {?>
                                <span id="sreson"><input id="textfield" name="scholarshipreason"  type="text" value="<?php echo $row['scholarshipreason'];?>" /></span>
                                <?php } ?>
                                <?php if($row['scholarship']=="No") {?>
                                <span id="sreson" style="display:none;"><input id="textfield" name="scholarshipreason"  type="text" value="" /></span>
                                <?php } ?>
                                <?php if($row['scholarship']=="" || $row['scholarship']=="0") {?>
                                <span id="sreson" style="display:none;"><input id="textfield" name="scholarshipreason"  type="text" value="" /></span>
                                <?php } ?>
                            </p>
						 </div>
						...
						<div class="_100">
							<p>
                                ...
                                <input id="purpose"  name="purpose" type="text" value="<?php echo $row['purpose'];?>" />
                            </p>
						</div>
						<div class="_50">
							<p>
						...
						<div class="_25">
							<p>
                                ...
                                <input id="textfield" name="cos"  type="text" value="<?php echo $row['cos'];?>" />								
							</p>
						</div>
						 <div class="_25">
							<p>
