    ...
    <?php 
		...
		<div id="main-content">
			...
			<div class="grid_12">
				...
				<a href="mexport_studentwisereport.php?cid=<?=$cid?>&sid=<?=$sid?>&ay_id=<?=$acyear?>"><button class="btn btn-small btn-success"><img src="img/icons/packs/fugue/16x16/table--plus.png"> Download Excel</button></a>
            ...
            <div class="grid_12">
				<div class="block-border">
					...
					<div class="block-content">
						<table id="table-example" class="table">
							...
							<tbody>
                            <?php 
							$qry=mysql_query("SELECT * FROM student WHERE c_id=$cid AND s_id=$sid AND ay_id=$acyear AND user_status='1' ORDER BY firstname ASC");
							$count=1;
			  while($row=mysql_fetch_array($qry))
        		{?>
                                ...
                                <td class="view"><center><a href="mstudent_feesinvoice.php?ssid=<?php echo $row['ss_id'];?>&bid=<?php echo $bid;?>"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png">View</button></a></center></td>
...
// Code that uses other library's $ can follow here.
  ...
  <script type="text/javascript">
	...
	function change_function() { 
	 ...
	 window.location.href = 'm_studentwise_income_report.php?bid='+cid;	  
	} 
  </script>
  <!-- end scripts-->
