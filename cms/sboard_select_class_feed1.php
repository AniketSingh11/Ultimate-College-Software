 ...
 <!--! end of #search-bar -->
    ...
    <?php 
		...
		<div id="main-content">
			...
			<a href="sboard_select_stu_feed1.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
            
			<div class="grid_12">
				<h1>Select Your Class to Student Feedback</h1>				
			</div>
			...
			<div class="grid_12">
				<div class="block-border">
					<div class="block-header">
						<h1>List of Your Class to Student Feedback</h1><span></span>
					</div>
			  ...
			  while($row=mysql_fetch_array($qry))
				...
				?>
							<li>
								<a href="sstudent_mng_feed1.php?bid=<?php echo $row['b_id']; ?>&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>">
