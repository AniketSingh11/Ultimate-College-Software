 ...
 if (isset($_POST['submit']))
{
	...
	if($otherfees=='0'){
		...
		$sql="INSERT INTO mfgroup_detail (name,type,otherfees,fees_amount) VALUES
('$fgname','$type','$otherfees','$fees_amount')";
$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
    if($result){
        header("Location:mfgroup_detail_add.php?msg=succ");
    }
    exit;
}
 ?>
    ...
    <div id="main" role="main">    	
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Add New Fees Group Type </li>
			</ul>
