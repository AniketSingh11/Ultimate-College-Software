    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<div class="grid_12">
				...
				<div class="alert success"><span class="hide">x</span>Hey there! Welcome to the <strong>&quot;School Management Solution &quot;</strong> admin Panel. I hope you enjoy your stay and please make sure, that you visit the other pages.</div>
			</div>
				...
				<div class="block-border">
					...
					<div class="block-content">
						<ul class="block-list with-icon">
							<li class="i-16-calendar">Library Management System</li>
							<li class="i-16-application">Hostel Management System</li>
							<li class="i-16-bookmark">Book Inventory</li>
							<li class="i-16-chart">Payroll Management System</li>
