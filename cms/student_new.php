			...
			$count=0;
	         while (($emapData = fgetcsv($file, 10000, ",")) !== FALSE)
	         {
			  ...
			  $photo=$emapData[1].".JPG";
	           ...
	           $sql="INSERT INTO student (admission_number,firstname,lastname,dob,day,month,year,gender,blood,nation,reg,caste,sub_caste,fathersname,email,password,address1,address2,city_id,country,pin,phone_number,user_status,joined_date,c_id,s_id,fathersocupation,p_income,m_name,m_occup,m_income,doa,mother_tongue,height,weight,remarks,b_id,stype,fdis_id,ay_id,photo) VALUES('$emapData[1]','$emapData[2]','$emapData[3]','$emapData[11]','$date_day','$date_month','$date_year','$emapData[12]','$emapData[17]','$emapData[13]','$emapData[14]','$emapData[15]','$emapData[16]','$emapData[4]','$emapData[18]','$emapData[1]','$emapData[20]','$emapData[21]','$emapData[22]','$emapData[23]','$emapData[24]','$emapData[19]','1','$todaydate','$cid','$sid','$emapData[5]','$emapData[6]','$emapData[7]','$emapData[8]','$emapData[9]','$emapData[10]','$emapData[25]','$emapData[26]','$emapData[27]','$emapData[28]','$bid','Old','1','$acyear','$photo')";
