    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<div class="grid_12">
                ...
                <a href="cheque_moveto_bank.php?bid=<?php echo $bid;?>" title="add" style="margin-left:10px;"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> Cheque Move To Bank</button></a>
            ...
            <div class="grid_12">
			  ...
			  while($row=mysql_fetch_array($qry))
				...
				?>
								...
								<td class="view"><center><a href="chequefeesinvoice_detail.php?fiid=<?php echo $row['fi_id'];?>&bid=<?php echo $bid;?>"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> Edit</button></a></center></td>
								</tr>
								 <?php 
							$count++;
							} ?>                               																
