...
$title = '';	
   ...
   $agencylist=mysql_query($qery);
	...
	$content .= stripslashes($agency['a_name']).',';
	$objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, $agency['a_name']);  $column++;
   ...
   $totalpayamount=0;
	...
	/*****************************************sheet 2 *************************************************/
$objPHPExcel->getActiveSheet()->setTitle("Finance Agencywise Report");

// Redirect output to a client’s web browser (Excel5)
header('Content-Type: application/vnd.ms-excel');
header("Content-Disposition: attachment;filename=Finance Agencywise Report.xls");
