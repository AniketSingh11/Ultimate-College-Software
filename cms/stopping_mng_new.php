...
$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
	...
	//die();
	if($result){
        header("Location:stopping_mng_new.php?rid=$rid&msg=succ");
    }
    exit;
}
?>
		...
		<div id="main-content">
            ...
            <?php } ?>
               ...
               <!-- <p><input type="button" class="input-button" id="btn-get" value="Get items" /></p>-->
                ...
                <label for="textfield"><center>Stopping Place List </center></label>
			  ...
			  while($row=mysql_fetch_array($qry))
				...
				<div class="_50 left" style="height:600px; overflow:scroll;">
                <label for="textfield"><center><?php  echo $class['r_name'];?> - Stopping List </center></label>
					<ul class="sortable-list" id="left">
                    <?php 
...
<input type="hidden" id="lastarray" value="<?php echo $res_arr_values;?>"/>
			...
			</div><?php //print_r($res_arr_values); 
  ...
  <!-- end scripts-->
   <script type="text/javascript">
	...
	$(document).ready(function() {
                $(".add").click(function() {
                    $('<div class="field"><div class="_75"><p><label for="textfield">Stopping Place Name : </label><input type="text" id="textfield" name="sp_name[]" /></p></div><span class="_25 rem" style="margin-top:30px;" ><a href="javascript:void(0);" class="btn btn-small btn-error">Remove</span></div>').appendTo(".contents");
                });
