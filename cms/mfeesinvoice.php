 ...
 <!--! end of #search-bar -->
    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Fees Invoice</h1>
                <a href="mboard_select_feesinvoice.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
                <a href="mbilling.php?bid=<?php echo $bid;?>"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> Add New</button></a>
                ...
                <div class="alert success"><span class="hide">x</span>Your Record Successfully Deleted !!!</div>
                 <?php } 
				  $qry1=mysql_query("SELECT * FROM mfinvoice WHERE bid=$bid AND ay_id=$acyear AND c_status!='1' AND i_status='0'");
							$total=0;
				...
				<div class="block-border">
					...
					<div class="block-content">
						<table id="table-example" class="table">
							...
							$qry=mysql_query("SELECT * FROM mfinvoice WHERE bid=$bid AND ay_id=$acyear AND c_status!='1' AND i_status='0' ORDER BY fi_id DESC");
							$count=1;
...
// Code that uses other library's $ can follow here.
  ...
  <script type="text/javascript">
	...
	function change_function() { 
	 ...
	 window.location.href = 'mfeesinvoice.php?bid='+cid;	  
	}
  </script>
  <!-- end scripts-->
