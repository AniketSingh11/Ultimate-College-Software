 ...
 if (isset($_POST['submit']))
{
	...
	$qry=mysql_query("UPDATE syllabus_covered SET day='$date_day',month='$date_month',year='$date_year',date='$date',peroid='$period',detail='$detail' WHERE id='$id'");	
    if($qry){
       $msg="succ";
    }
}
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Edit Syllabus covered</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Edit <?php echo $class['c_name']."-".$section['s_name'] ;?> Syllabus covered <b>(<?php echo $slist['s_name'];?>)</b></h1>                
            ...
            <?php //$msg=$_GET['msg'];
			if($msg=="succ"){?>			
            <div class="alert success"><span class="hide">x</span>Your Syllabus covered Details Successfully Edited!!!</div>
            <?php } ?>
				<div class="block-border">
					<div class="block-header">
						<h1>Edit <?php echo $class['c_name']."-".$section['s_name'];?> Syllabus covered <b>(<?php echo $slist['s_name'];?>)</b></h1><span></span>
					</div>
                    <?php 
						$scoveredlist1=mysql_query("SELECT * FROM syllabus_covered WHERE id='$id'"); 
								   $scovered=mysql_fetch_array($scoveredlist1);	
								   ?>
					<form id="validate-form" class="block-content form" action="" method="post">
						<div class="_25">
							<p>
                                <label for="textfield">Date:<span class="error">*</span></label>
                                <input id="datepicker" name="date" class="required" type="text" value="<?php echo $scovered['date'];?>"/>
                            </p>
						</div>
                        <div class="_50">
							<p>
                                <label for="textfield">Period: <span class="error">*</span></label>
                                <input id="textfield" name="period" class="required" type="text" value="<?php echo $scovered['peroid'];?>"/>
                            </p>
						</div>
                        <div class="_100">
							<p><label for="textarea">Class Taken Details : <span class="error">*</span></label>
                            <textarea id="textarea" name="detail" rows="12" class="required" cols="40"><?php echo $scovered['detail'];?></textarea></p>
						</div>                        
						<div class="clear"></div>
