            ...
            <div id="main-content">
                <div class="container_12">
                    ...
                    <div class="grid_12">
                        ...
                        <a href="agency_advance_add.php" title="add"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> Add New</button></a>
                                ...
                                <table id="table-example" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysql_fetch_array($qry)) {
                                            ...
                                            $adv_pay_qry = mysql_query("SELECT * FROM advance_payment where a_id=" . $row['a_id']);
                                            $advpay_row = mysql_fetch_array($adv_pay_qry);
                                            ?>
                                            <tr class="gradeX">
                                        ...
                                        <td class="action">
                                            ...
                                            <?php } if (empty($advpay_row)) { ?>
                                                <a href="agency_advance_edit.php?aid=<?php echo $row['adv_id']; ?>" title="Edit"><img src="./img/edit.png" alt="edit"></a> 
                                                <a href="agency_advance_delete.php?aid=<?php echo $row['adv_id']; ?>" class="delete" title="delete" onClick="return confirm('are you sure you wish to delete this record');"><img src="./img/del.png" alt="delete"></a>
                                            <?php } ?>
                                        </td>
                                        </tr> 
                                        <?php
