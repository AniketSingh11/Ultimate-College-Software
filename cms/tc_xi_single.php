                    ...
                    <input id="textfield" name="eno" class="required" type="hidden" readonly value="<?php echo "EMIS".str_pad($emisno, 5, '0', STR_PAD_LEFT);?>" />
						...
						<div class="_50">
							<p>
                                ...
                                <input id="textfield" readonly name="revenueplace" class="required" type="text" value="<?php echo 'CHENNAI' ?>" />
                            </p>
						</div>
						<div class="_50">
							<p>
                                <label for="textfield">Name of the Revenue District : <span class="error">*</span></label>
                                <input id="textfield" readonly name="schoolplace" class="required" type="text" value="<?php echo 'CHENNAI' ?>" />
                            </p>
						</div>
                        ...
                        <div class="_50" style="margin-left:50px;">
							<p>
                                ...
                                <input id="textfield" readonly name="dobfigure" type="text" value="<?php echo $student['dob']; ?>" />
                            </p>
						</div>
                        <div class="_50" style="margin-left:50px;">
							<p>
...
?>
                                <input id="textfield" readonly name="dobword" type="text" value="<?= $ans?>" />
                            </p>
						</div>
						<div class="_50">
							<p>
						...
						<div class="_100">
							...
							?>
                                ...
                                <input id="textfield" name="doandclass" readonly class="required" type="text" value="<?php echo $student['doa'].' - '.$classname.' / '.$doawords;?>" />
                            </p>
						 </div>
                        ...
                        <div class="_100">
							<p>
                                ...
                                <input id="textfield" readonly name="leaving" class="required" type="text" value="<?php echo $classword?>"/>
                            </p>
						 </div>
						 <?php if($namereleave=='XI' || $namereleave=='XII') { ?>`
						 <div class="_50">
							<p>
						...
						<div class="_25">
							<p>
                                ...
                                <input id="textfield" readonly name="academic_year" class="required" type="text" value="<?php echo $ace_year?>" />
                            </p>
						</div>
                        <div class="_25">
							<p>
								<label for="select">Standard(s) Studied : <span class="error">*</span></label>
                                <input id="textfield" readonly name="standard" class="required" type="text" value="<?php echo $namereleave;?>" />								
							</p>
						</div>
                        ...
                        <div class="_50">
							<p>
                                ...
                                <input id="textfield" readonly name="first_lan" type="text" value="<?= $student['second_lang']?>" />
							</p>
						</div>
						<div class="_50">
							<p>
                                <label for="textfield">Medium Instruction :</label>
                                <input id="textfield" readonly name="med_ins1" type="text" value="<?php echo $board['medium'];?>" />
                            </p>
						</div>
