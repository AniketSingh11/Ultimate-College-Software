 ...
 <!--! end of #search-bar -->
    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<div class="grid_12">
            <a href="fundinvoice.php?bid=<?php echo $bid;?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
            <a href="feesinvoice_detail.php?fiid=<?php echo $ffi_id;?>&bid=<?php echo $bid;?>" target="_blank" style=" float:right"><button class="btn btn-small btn-warning" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> Fee Invoice Details</button></a>
			...
			?>
                ...
                <input type="submit" value="Print" name="Print" onClick="window.open('fundinvoice_prt.php?fiid=<?php echo $ffi_id; ?>')" class="btn btn-green" style="width:120px; float:right;">&nbsp;&nbsp;
                </td>
                </tr>
					</tbody>
                  </table>
