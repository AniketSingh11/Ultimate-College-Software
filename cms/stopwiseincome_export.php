...
header("Content-Disposition: attachment; filename=buswise-fees-income-report.csv");
...
$rowCount = 3;
	 ...
	 $qry="SELECT * FROM bfinvoice WHERE sp_id=$spid AND ay_id=$ayid AND c_status!='1' AND i_status='0'";
...
$content .= " Totol : ".$total."\n\n";
$title .= "stopwise Fees Income Report - ".$stop['stop_name']." ( Board-".$b_name." )\n\n";
...
header("Content-Disposition: attachment;filename=buswise-fees-income-report($row5[r_name]).xls");
