 ...
 if (isset($_POST['submit']))
{
	...
	$alreadylist=mysql_query("SELECT * FROM result WHERE ss_id=$ssid AND c_id=$cid AND s_id=$sid AND sub_id=$subid AND ay_id=$acyear"); 
	
	$alcount=mysql_num_rows($alreadylist);
	if($alcount<1){
 ...
 <!--! end of #search-bar -->
    ...
    <div id="main" role="main">
		...
		<div id="main-content">
            ...
            <?php } if($msg=="already"){?>			
            <div class="alert error"><span class="hide">x</span>This Student Result already created!!!</div>
            <?php } ?>
					...
					<form id="validate-form" class="block-content form" action="" method="post">
                        ...
                        <div class="_25">
							<p>
                                ...
                                <span class="">
                                <input style="opacity: 0;" name="result" type="radio" value="PASS" checked> Pass</input> 
                                <input style="opacity: 0;" name="result" type="radio" value="FAIL"> Fail</input>
                                </span> 
                            </p>
						</div>
                        <div class="_100">
