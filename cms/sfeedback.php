    ...
    <?php 
		...
		<div id="main-content">
			...
			<div id="info-dialog<?php echo $count;?>" title="<?php echo $row['admission_number']; ?>, This student details" style="display: none;">
                ...
                <p>Middle Name : <strong><?php echo $row['lastname']; ?></strong>  </p>   
                
                <p>Last Name of Pupil : <strong><?php echo $row['middlename']; ?></strong>  </p>   
                
                <p>Name of Parent / Guardian : <strong><?php echo $row['fathersname']; ?></strong>  </p>   
                
                <p>Occupation of Parent or Guardian : <strong><?php echo $row['fathersocupation']; ?></strong>  </p>   
                
                <p>Standard & School from which pupil has come :  <strong><?php echo $row['from_school']; ?> </strong></p>   
                
                <p>Whether an ESLC issued by the Dept. was produced on admission : <strong><?php echo $row['eslc']; ?></strong>  </p>   
                
                <p>Whether a T.C. from a secondary school was produced on admission : <strong><?php echo $row['tc']; ?></strong>  </p>   
                ...
                <p>Whether protected from small-pox or not : <strong><?php echo $row['protected']; ?></strong> </p>   
                
                <p>Nationality & state to which the pupil belongs : <strong><?php echo $row['nation']; ?></strong>  </p>   
                ...
                <p>Mother Tongue of the Pubil : <strong><?php echo $row['mother_tongue']; ?></strong> </p>   
                
                <p>Std. on leaving : <strong><?php echo $row['std_leaving']; ?></strong>  </p>   
                
                <p>No. & Date of Transfer Certificate produced : <strong><?php echo $row['no_date_tran']; ?></strong>  </p>   
                
                <p>Date of leaving : <strong><?php echo $row['dol']; ?> </strong></p>  
                
                <p>Reason for leaving : <strong><?php echo $row['reason_leaving']; ?></strong> </p>
                
                <p>School to which the pubil has gone : <strong><?php echo $row['school_pubil']; ?></strong> </p>
