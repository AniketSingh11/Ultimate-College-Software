 ...
 if (isset($_POST['submit']))
{
	...
	$stid=$_POST['stid'];
		...
		$sql="INSERT INTO classtest (title,day,month,year,date,detail,c_id,s_id,m_id,st_id,sub_id,b_id,ay_id) VALUES
('$title','$date_day','$date_month','$date_year','$date','$detail','$cid','$sid','$mid','$stid','$subid','$bid','$acyear')";

$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
    if($result){
        header("Location:classtest_single.php?cid=$cid&sid=$sid&mid=$mid&subid=$subid&bid=$bid&msg=succ");
    }
    exit;
}
 ...
 <!--! end of #search-bar -->
    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Add New <?php echo $class['c_name']."-".$section['s_name']." (".$month['m_name'].")";?> Class Test <b>(<?php echo $slist1['s_name'];?>)</b></h1>                
