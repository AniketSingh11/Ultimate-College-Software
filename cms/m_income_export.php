...
header("Expires: 0");
	 ...
	 $qry="SELECT * FROM mfinvoice WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $startdate. "' AND '" . $enddate. "' AND ay_id='$ayid' ";
...
if($bid=='All'){
    ...
    $qry="SELECT * FROM mfinvoice WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $startdate. "' AND '" . $enddate. "' AND ay_id='$ayid' and c_status!='1' AND i_status='0' ";
    if(!empty($bid) && $bid!='All') { $qry .= " AND bid = '" . $bid. "'"; }
...
$objPHPExcel->getActiveSheet()->setTitle("Monthly Fees Income Report");
