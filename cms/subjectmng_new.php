			...
			$count=0;
	         while (($emapData = fgetcsv($file, 10000, ",")) !== FALSE)
	         {
	          ...
	          //It wiil insert a row to our subject table from our csv file`
	           $sql = "INSERT INTO subjectlist (s_code,s_name,c_id,s_id,b_id,ay_id,s_type,extra_sub,paper) values('$emapData[1]','$emapData[2]','$cid','$sid','$bid','$acyear',$emapData[4],$emapData[5],$emapData[3])";
	         //we are using mysql_query function. it returns a resource on true else False on error
	         $result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
				if(! $result )
				{
					
						header("Location:subjectmng_new.php?sid=$sid&cid=$cid&bid=$bid&msg=eonfile");
						exit;
				}
				header("Location:subjectmng_new.php?sid=$sid&cid=$cid&bid=$bid&msg=succ");
				}
				$count++;
	         }
	         fclose($file);
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover"><a href="subject_mng.php?cid=<?php echo $cid; ?>&sid=<?php echo $sid;?>&bid=<?php echo $bid;?>" title="subject">Subject Management</a></li>
                <li class="no-hover">Import Student Details</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Import Subejct Datas (<?php echo $class['c_name']."-".$section['s_name'];?>)</h1>                
			<a href="subject_mng.php?cid=<?php echo $cid; ?>&sid=<?php echo $sid;?>&bid=<?php echo $bid;?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
             <a href="sample/subject_sample.csv" target="_blank" style="margin:0px 10px 0 0px; float:right;"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/inbox-download.png"> Download Sample File</button></a>
			</div>
            <div class="grid_12">
            <?php $msg=$_GET['msg'];
			if($msg=="succ"){?>			
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Import Subject Details</h1><span></span>
					</div>
