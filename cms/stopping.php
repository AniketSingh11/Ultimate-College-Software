    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<div class="grid_12">
                ...
                <a href="stopping_new.php?rid=<?php echo $rid;?>" title="add" style="margin-left:10px;"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> Add / Edit </button></a>
                &nbsp;&nbsp;&nbsp;<a href="stopping_arrange.php?rid=<?php echo $rid;?>"><button class="btn btn-small btn-warning" ><img src="img/icons/packs/fugue/16x16/tick.png"> Stopping Point Arrange </button></a>
				...
				<?php $msg=$_GET['msg'];
				if($msg=="dsucc"){?>
                <div class="alert success"><span class="hide">x</span>Your Record Successfully removed !!!</div>
                 <?php } ?>                   
			</div>
            <div class="grid_12">
			  ...
			  while($row=mysql_fetch_array($qry))
				...
				?>
                                ...
                                <button class="btn btn-small btn-success" >Active</button><?php }else{?><button class="btn btn-small btn-gray" >Inactive</button> <?php } ?>
								 ...
								 <td class="action"><a href="stopping_new.php?rid=<?php echo $rid;?>" title="Edit"><img src="./img/edit.png" alt="edit"></a> <a href="stopping_delete.php?spid=<?php echo $row['stop_id']; ?>&rid=<?php echo $rid; ?>" class="delete" title="delete" onClick="return confirm('are you sure you wish to delete this record');"><img src="./img/del.png" alt="delete"></a></td>
								</tr> 
                                 <?php 
							$count++;
							} ?>                               																
