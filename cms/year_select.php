 ...
 if (isset($_POST['submit']))
{
    ...
    //if($qry){
        ...
        header("Location:year_select.php?msg=succ");
    //}
    exit;
}
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Select Academic Year</li>
			</ul>
		...
		<div id="main-content">
            ...
            <?php $msg=$_GET['msg'];
			if($msg=="succ"){?>			
            <div class="alert success"><span class="hide">x</span>Your Academy Year Successfully changed!!!</div>
            <?php } ?>
            
				<div class="block-border">
					<div class="block-header">
						<h1>Select Academic Year</h1><span></span>
					</div>
					<form id="validate-form" class="block-content form" action="" method="post">
						<div class="_50">
							<p>
								...
								<label><input type="radio" name="year" value="<?php echo $row1['ay_id']; ?>" checked/><?php echo $row1['y_name']; ?></label>
                                <?php }else{ ?>
                                <label><input type="radio" name="year" value="<?php echo $row1['ay_id']; ?>" /><?php echo $row1['y_name']; ?></label>                        
                                <?php } } ?>								
							</p>
						</div>
						<div class="clear"></div>
