    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<div class="grid_12">
				...
				<span style="width:100px"><a href="reject_fees_download.php"><button class="btn btn-small btn-green"><img src="img/icons/packs/fugue/16x16/inbox-download.png"> Download Report </button></a></span>
                ...
                <div class="alert success"><span class="hide">x</span>Your Record Successfully Deleted !!!</div>
                 <?php } 
				  $qry1=mysql_query("SELECT * FROM finvoice WHERE bid=$bid AND ay_id=$acyear AND i_status='1'");
							$total=0;
				...
				<div class="block-border">
					...
					<div class="block-content">
						<table id="table-example" class="table">
							...
							<tbody>
                            <?php 
							$qry=mysql_query("SELECT * FROM finvoice WHERE bid=$bid AND ay_id=$acyear AND i_status='1'");
							$count=1;
