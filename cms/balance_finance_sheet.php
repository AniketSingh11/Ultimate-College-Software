...
<body id="top">
    ...
    <div id="container">
        ...
        <div id="main" role="main">
            ...
            $getay_id = $_GET['ay_id'];
            if ($getay_id) {
                $ayear = mysql_query("SELECT * FROM year WHERE ay_id='$getay_id'");
            ...
            <div id="title-bar">
                <ul id="breadcrumbs">
                    ...
                    <li> <?php echo $syear . " - " . $eyear ?> Finance Year Full Ledger</li>
                </ul>
                <div class="_25" style="float:right">
                    <label for="select">Academic Year:</label>
                    <?php
                    $classl = "SELECT * FROM year";
                    $result1 = mysql_query($classl) or die(mysql_error());
                    echo '<select name="ayid" id="ayid" class="required" onchange="change_function()">';
                    while ($row1 = mysql_fetch_assoc($result1)):
                        if ($acyear == $row1['ay_id']) {
                            echo "<option value='{$row1['ay_id']}' selected>{$row1['y_name']}</option>\n";
                        } else {
                            echo "<option value='{$row1['ay_id']}'>{$row1['y_name']}</option>\n";
                        }
                    endwhile;
                    echo '</select>';
                    ?>
            ...
            <div id="main-content">
                <div class="container_12">
                    ...
                    if ($sdate && $edate) {
                        ?>
                        <div class="grid_12">
                            <h1><?php echo $syear . " - " . $eyear ?> Finance Year Full Ledger</h1>
                                ...
                                <div class="widget-content">
                                    <table class="table table-striped" id="table-example">	
                                        ...
                                        <tbody>
                                            ...
                                            $total = 0;
                                            $indisplay = 1;
                                            $qry5 = mysql_query("SELECT fg_id,fg_name FROM fgroup");
                                            while ($row5 = mysql_fetch_assoc($qry5)) {/*
                                              ...
                                              {
                                              $fi_id=$fees['fi_id'];
                                              $feesummarry=mysql_query("SELECT amount FROM fsalessumarry WHERE fi_id=$fi_id AND fg_id=$fg_id");
                                       ...
                                       $book=0;
                                        ...
                                        $other=mysql_query("SELECT * FROM tc_xi_kg WHERE ay_id='" . $acyear. "'");
                                        ...
                                        <tr>
                                                ...
                                                <td class="total"><center>-</center></td>
                                                <td class="total"><center>Rs. <?php echo number_format($tc, 2); ?></center></td>
                                                <td class="total"><center>-</center></td>
                                                </tr>
                                        <?php } ?> 
...
$f=1;
                                        $bamountthisyear = 0;
                                        $bus_lastyear = 0;
                                        $booklist1 = mysql_query("SELECT fi_total,fr_no,pending FROM bfinvoice WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $startdate . "' AND '" . $enddate . "' AND c_status!='1' AND i_status='0'");
                                        ...
                                        if ($bamountthisyear != 0) {
                                            ...
                                            <tr>
                                                <td><?php echo $count; ?></td>			
                                                <td><b><center>Bus Fees(<?= $start_binv.'-'.$end_binv; ?>)</center></b></td>
                                                <td class="total"><center>-</center></td>
                    ...
                    ?>
                                        ...
                                        if ($exc_amount1 != 0) {
                                            ...
                                            <tr>
                                                <td><?php echo $count; ?></td>			
                                                <td><b><center>Staff Loan </center></b></td>
                                                <td class="total"><center>Rs. <?php echo number_format($exc_amount1, 2); ?></center></td>
                                            <td class="total"><center>-</center></td>
                                            <td class="total"><center>-</center></td>
                                            </tr>
                                        ...
                                        <td class="sub_total"><center><?php $total = $total + $book;
    ...
    ?>
                                        ...
                                        <tr class="total_bar">
                                            <td class="sub_total" colspan="2"><?php $finaltotal1 = $finaltotal - $etotal1;
    ...
    ?></td>
                            ...
                            <a href="balancesheet_year_prt.php?ay_id=<?= $acyear ?>" target="_blank"><input type="submit" value="Print Income & Expense Ledger" name="Print" class="btn btn-green" style="width:250px"> </a>
                            <a href="balance_sheet_ledger_excel.php?ayid=<?php echo $acyear; ?>" target="_blank"><input type="submit" value="Download Income & Expense Ledger" name="Download" class="btn btn-green" style="width:280px"> </a>
...
?>
    ...
    <script type="text/javascript">
        ...
        function change_function() {
            var cid = document.getElementById('ayid').value;
            window.location.href = 'balance_finance_sheet.php?ay_id=' + cid;
        }
    </script>
    <!-- end scripts-->
