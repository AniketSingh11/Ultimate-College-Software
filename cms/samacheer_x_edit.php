    ...
    <div id="main" role="main">    				
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Edit X-Samacheer Certificate</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Edit X-Samacheer Certificate</h1>                
            ...
            <center><a href="samacheer_x_prt.php?sxid=<?php echo $_GET['sxid'];?>" target="_blank"><button class="btn btn-small btn-warning" ><img src="img/icons/packs/fugue/16x16/block--arrow.png"> Click Here To Print the Last Edited Certificate</button></a></center>
            </div>
            <?php } 
							$sxid=$_GET['sxid'];
			...
			?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Edit X-Samacheer Certificate</h1><span></span>
					</div>
                    ...
                    <div class="_25">
                        ...
                        <div class="_25">
							<p>
                                ...
                                <input id="textfield" name="xmno" class="required" type="text" value="<?php echo $row['xmno']; ?>" />
                            </p>
						</div>
						<div class="_25">
							<p>
                        ...
                        <div class="_50">
							<p>
                                ...
                                <input id="datepicker" name="leaving" type="text" value="<?php echo $row['leaving']; ?>" />
                            </p>
						</div>
                        <div class="_100">
							<p>
