 ...
 <!--! end of #search-bar -->
    ...
    <?php 
		...
		<div id="main-content">
			...
			<div class="grid_12">
                ...
                <a href="sboard_select_stu1.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
			...
			<div class="grid_12">
				<div class="block-border">
					<div class="block-header">
						<h1>List of You Class</h1><span></span>
					</div>
			  ...
			  while($row=mysql_fetch_array($qry))
				...
				?>
							<li>
								<a href="srank_card.php?bid=<?php echo $row['b_id']; ?>&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>">
  ...
  <script type="text/javascript">
	...
	function change_function() { 
	 ...
	 window.location.href = 'sboard_select_classrank.php?bid='+cid;	  
	} 
  </script>
  <!-- end scripts-->
