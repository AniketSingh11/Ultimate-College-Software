  ...
  .block-content-invoice1{
	  ...
	  margin:30px
		...
		border: 2px solid #a9a6a6;
                        ...
                        <center><h2>SCHOOL DISCOUNT FUND RECEIPT</h2></center><span style="float:right; margin-right:10px"><strong>SI.No</strong> : 55247</span>
				...
				<table class="table table-striped" id="table-example">	
                    ...
                    <tr>
							<td>1</td>			
							<td colspan="4"><center>Total Fees Amount</center></td>
							<td class="total"><?php echo number_format($invoice['fi_total'],2);?></td>
                        </tr>
                        <tr>
							<td>2</td>			
							<td colspan="4"><center>Student Paid Amount</center></td>
							<td class="total"><?php echo number_format($invoice['poor_student_pay'],2);?></td>
                        </tr>
                        <tr>
							<td class="sub_total"></td>
							<td class="sub_total" colspan="4">Subtotal : ( <?php echo number_format($invoice['fi_total'],2)." - ".number_format($invoice['poor_student_pay'],2);?> ) </td>
...
<?php $amount=number_format($invoice['fi_total'],2);
						if(floor($amount)==$amount){
							$amount1=floor($amount);
							 echo convert_number_to_words($invoice['fund_amount']);
						}else{
						 echo convert_number_to_words($amount); }?> Rupees Only
</center></td>
							<td class="grand_total" width="170px">Total Discount From School:</td>
