		...
		<div id="main-content">
			...
			<div class="grid_12">
                ...
                <div class="alert success"><span class="hide">x</span>Your Record Successfully Deleted !!!</div>
                 <?php } 
				  $qry1=mysql_query("SELECT * FROM mfinvoice WHERE bid=$bid AND ay_id=$acyear AND i_status='1'");
							$total=0;
            ...
            <div class="grid_12">
				<div class="block-border">
					...
					<div class="block-content">
						<table id="table-example" class="table">
							...
							<tbody>
                            <?php 
							$qry=mysql_query("SELECT * FROM mfinvoice WHERE bid=$bid AND ay_id=$acyear AND i_status='1'");
							$count=1;
			  while($row=mysql_fetch_array($qry))
				...
				?>
								...
								<td class="view"><center><a href="mfeesinvoice_reject_detail.php?fiid=<?php echo $row['fi_id'];?>&bid=<?php echo $bid;?>"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> View</button></a></center></td>
								 <?php 
							$count++;
							} ?>                               																
							</tbody>
