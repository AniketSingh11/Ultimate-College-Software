 ...
 if (isset($_POST['submit']))
{
	...
	if($image[error]!=4){
		...
		if (!is_valid_type($image)) {
    		...
    		header("Location:vehicle_edit.php?vid=$vid&msg=eronimg");
    		exit;
			}
			
			if(($lastphoto !='vehile_avatar.png')){ 
			unlink("./img/vehicle/".$lastphoto);
			}
		
			if (move_uploaded_file($image['tmp_name'], $TARGET_PATH)) {
$sql="UPDATE vehicle SET v_no='$v_no',v_regno='$v_regno',v_mno='$v_mno',v_cname='$v_cname',v_capacity='$v_capacity',photo='".$image['name']."',status='$status',vin_startdate='$vin_startdate',vin_enddate='$vin_enddate',vfc_startdate='$vfc_startdate',vfc_enddate='$vfc_enddate',pollution_startdate='$pollution_startdate',pollution_enddate='$pollution_enddate',tax_startdate='$tax_startdate',tax_enddate='$tax_enddate',permit_startdate='$permit_startdate',permit_enddate='$permit_enddate' WHERE v_id='$vid'";

		$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
			if($result){
				header("Location:vehicle_edit.php?vid=$vid&msg=succ");
			}
			exit;
			} else {
				//$_SESSION['error'] = "Could not upload file.  Check read/write persmissions on the directory";
				header("Location:vehicle_edit.php?vid=$vid&msg=eronfile");
				exit;
			}
		...
		$sql="UPDATE vehicle SET v_no='$v_no',v_regno='$v_regno',v_mno='$v_mno',v_cname='$v_cname',v_capacity='$v_capacity',photo='$photo',status='$status',vin_startdate='$vin_startdate',vin_enddate='$vin_enddate',vfc_startdate='$vfc_startdate',vfc_enddate='$vfc_enddate',pollution_startdate='$pollution_startdate',pollution_enddate='$pollution_enddate',tax_startdate='$tax_startdate',tax_enddate='$tax_enddate',permit_startdate='$permit_startdate',permit_enddate='$permit_enddate' WHERE v_id='$vid'";
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Edit Vehicle Details</li>
			</ul>
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Edit Vehicle Details</h1><span></span>
					</div>
                    <?php 
					$vid=$_GET['vid'];
							$stafflist=mysql_query("SELECT * FROM vehicle WHERE v_id=$vid"); 
					...
					<form id="validate-form" class="block-content form" action="" method="post" enctype="multipart/form-data">
						<div class="_100">
							<p>
                                ...
                                <input id="textfield" name="v_no" class="required" type="text" value="<?php  echo $staff['v_no'];?>" />
                            </p>
						</div>
                        <div class="_50">
							<p>
                                <label for="textfield">Vehicle Reg.no : <span class="error">*</span></label>
                                <input id="textfield" name="v_regno" class="required" type="text" value="<?php  echo $staff['v_regno'];?>" />
                            </p>
						</div>
                        <div class="_50">
							<p>
                                <label for="textfield">Vehicle Model No :</label>
                                <input id="textfield" name="v_mno"  type="text" value="<?php  echo $staff['v_mno'];?>" />
                            </p>
						</div>
                        <div class="_50">
							<p>
                                <label for="textfield">Vehicle Company Name :</label>
                                <input id="textfield" name="v_cname"  type="text" value="<?php  echo $staff['v_cname'];?>" />
                            </p>
						</div>
                        <div class="_50">
							<p>
                                <label for="textfield">Vehicle Capacity : <span class="error">*</span> <span>( Without Driver And Bus.Assit )</span></label>
                                <input id="textfield" name="capacity" class="required" type="text" value="<?php  echo $staff['v_capacity'];?>" />
                            </p>
						</div>
						...
						<div class="_25">
							<p>
                                ...
                                <input id="datepicker1" name="vin_startdate" class="required" type="text" value="<?php  echo date("d/m/Y",strtotime($staff['vin_startdate']));?>" />
                            </p>
						</div>
						<div class="_25">
							<p>
                                <label for="textfield">Insurance End Date : <span class="error">*</span> </label>
                                <input id="datepicker2" name="vin_enddate" class="required" type="text" value="<?php  echo date("d/m/Y",strtotime($staff['vin_enddate']));?>" />
                            </p>
						</div>
						...
						<div class="_25">
							<p>
                                ...
                                <input id="datepicker3" name="vfc_startdate" class="required" type="text" value="<?php  echo date("d/m/Y",strtotime($staff['vfc_startdate']));?>" />
                            </p>
						</div>
						...
						<div class="_25">
							<p>
                                ...
                                <input id="datepicker4" name="vfc_enddate" class="required" type="text" value="<?php  echo date("d/m/Y",strtotime($staff['vfc_enddate']));?>" />
                            </p>
						</div>
                        ...
                        <div class="_25">
							<p>
                                ...
                                <input id="datepicker5" name="pollution_startdate" class="required" type="text" value="<?php  if($staff['pollution_startdate']){ echo date("d/m/Y",strtotime($staff['pollution_startdate'])); }?>" />
                            </p>
						</div>
						...
						<div class="_25">
							<p>
                                ...
                                <input id="datepicker6" name="pollution_enddate" class="required" type="text" value="<?php if($staff['pollution_startdate']){ echo date("d/m/Y",strtotime($staff['pollution_enddate'])); }?>" />
                            </p>
						</div>
                        ...
                        <div class="_25">
							<p>
                                ...
                                <input id="datepicker7" name="tax_startdate" class="required" type="text" value="<?php if($staff['pollution_startdate']){ echo date("d/m/Y",strtotime($staff['tax_startdate'])); }?>" />
                            </p>
						</div>
						...
						<div class="_25">
							<p>
                                ...
                                <input id="datepicker8" name="tax_enddate" class="required" type="text" value="<?php if($staff['pollution_startdate']){ echo date("d/m/Y",strtotime($staff['tax_enddate'])); }?>" />
                            </p>
						</div>
                        ...
                        <div class="_25">
							<p>
                                ...
                                <input id="datepicker9" name="permit_startdate" class="required" type="text" value="<?php if($staff['pollution_startdate']){ echo date("d/m/Y",strtotime($staff['permit_startdate'])); }?>" />
                            </p>
						</div>
						...
						<div class="_25">
							<p>
                                ...
                                <input id="datepicker10" name="permit_enddate" class="required" type="text" value="<?php if($staff['pollution_startdate']){ echo date("d/m/Y",strtotime($staff['permit_enddate'])); }?>" />
                            </p>
						</div>
