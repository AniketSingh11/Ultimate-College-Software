    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover"><a href="withdrawl_mng.php?baid=<?php echo $baid; ?>" title="month">Bank withdrawal</a></li>
                <li class="no-hover">Add <?php  echo $class['name']."-".$class['account_no'];?> Bank withdrawal</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Add <?php  echo $class['name']."-".$class['account_no'];?> Bank withdrawal</h1>                
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Add New Bank withdrawal Details</h1><span></span>
					</div>
                    ...
                    <div class="_25">
                        ...
                        <div class="_25">
							<p>
                                <label for="textfield">withdrawaled By <span class="error">*</span></label>
