    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<div class="grid_12">
                ...
                <a href="board_select_fundinvoice.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
                ...
                <div class="alert success"><span class="hide">x</span>Your Record Successfully Deleted !!!</div>
                 <?php } 
				  $qry1=mysql_query("SELECT * FROM finvoice WHERE bid=$bid AND ay_id=$acyear AND funds='1' and c_status!='1' ");
							$total=0;
            ...
            <div class="grid_12">
				<div class="block-border">
					...
					<div class="block-content">
						<table id="table-example" class="table">
							...
							$qry=mysql_query("SELECT * FROM finvoice WHERE bid=$bid AND ay_id=$acyear AND funds='1' and c_status!='1' order by fi_id desc");
							$count=1;
			  while($row=mysql_fetch_array($qry))
				...
				?>
								...
								<td class="view"><center><a href="fundinvoice_detail.php?fiid=<?php echo $row['fi_id'];?>&bid=<?php echo $bid;?>"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> View</button></a></center></td>
								 <?php 
							$count++;
							} ?>                               																
							</tbody>
...
// Code that uses other library's $ can follow here.
  ...
  <script type="text/javascript">
	...
	function change_function() { 
	 ...
	 window.location.href = 'fundinvoice.php?bid='+cid;	  
	} 
  </script>
  <!-- end scripts-->
