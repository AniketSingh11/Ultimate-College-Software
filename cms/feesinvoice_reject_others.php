    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover">Reject Fees Invoice</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				...
				<span style="width:100px"><a href="reject_fees_download_others.php"><button class="btn btn-small btn-green"><img src="img/icons/packs/fugue/16x16/inbox-download.png"> Download Report </button></a></span>
                ...
                <div class="alert success"><span class="hide">x</span>Your Record Successfully Updated !!!</div>
                 <?php }
				  ...
				  $qry1=mysql_query("SELECT * FROM finvoice_others WHERE bid=$bid AND ay_id=$acyear AND i_status='1'");
							$total=0;
				...
				<div class="block-border">
					...
					<div class="block-content">
						<table id="table-example" class="table">
							...
							<tbody>
                            <?php 
							$qry=mysql_query("SELECT * FROM finvoice_others WHERE bid=$bid AND ay_id=$acyear AND i_status='1'");
							$count=1;
...
// Code that uses other library's $ can follow here.
  ...
  <script type="text/javascript">
	...
	function change_function() { 
	 ...
	 window.location.href = 'feesinvoice_reject.php?bid='+cid;	  
	}
  </script>
  <!-- end scripts-->
