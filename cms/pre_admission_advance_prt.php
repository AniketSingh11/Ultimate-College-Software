...
<body bgcolor="#FFFFFF" style="font-size:16px;" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
...
<style type="text/css">
  ...
  .block-content-invoice1{
	...
	.total{ float:right; margin-right:50px;}
                        ...
                        <p><span style="position:absolute; left:200px"><?php echo $invoice['name'];?></span><span style="position:absolute; left:690px"> <?php echo $invoice['rec_no'];?></span></p><br>
                        <p><span style="position:absolute; left:200px"><?php echo $row['c_name']; if($row1['s_name']){ echo "-".$row1['s_name'];}?></span><span style="position:absolute; left:690px"> <?php echo $invoice['cday']."/".$invoice['cmonth']."/".$invoice['cyear'];?></span></p>
				...
				<table class="table table-striped" id="table-example" cellpadding="0" cellspacing="0" style="clear:none;text-align:left; width:100%; margin-top:40px;">	
                	<tbody>
                    	<tr>
							<td colspan="5"><center>Registration Fee</center></td>
                    	...
                    	<tr class="total_bar">
							<td class="grand_total1" colspan="4" width="220px"><center>
 <?php $amount=number_format($invoice['amount'],2);
						if(floor($amount)==$amount){
							$amount1=floor($amount);
							 echo convert_number_to_words($invoice['amount']);
						}else{
						 echo convert_number_to_words($amount); }?> Rupees Only
</center></td>
							<td class="grand_total1" width="120px" style=" text-align:right">Total:</td>
							<td class="grand_total1 total">Rs. <?php echo number_format($invoice['amount'],2);?></td>
						</tr>
                    ...
                    <td colspan="6">
                    <div>
                  <span style="float:left; margin-left:200px;top:160px; position:absolute"><?php echo $invoice['cby'];?></strong></span>
                  </div>
                  </td>
                    </tr>
                    </tfoot>
