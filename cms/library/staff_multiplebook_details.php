 ...
 include("header.php");
  ...
  if(isset($_POST["submit"]))
  {
      ...
      $selbookid=explode(",",trim($_POST["sel_book"]));
      ...
      if($avilable_qty!="0" && $chk!="1")
      {
	   ...
	   // header("location: staff_book_details.php?msg=succ&bid=$bid");
      }else{
          
        //  header("location: staff_book_details.php?msg=err&err_msg=$err_msg&bid=$bid");
 ...
 // header("location: staff_multiplebook_details.php?msg=err&err_msg=$err_msg&bid=$bid");
  }else{
      
     header("location: staff_multiplebook_details.php?msg=succ");
  }
 ...
 <div id="wrapper">
     ...
     <div id="content">	
		 <div id="content-header">
			 <h1> Apply Multiple Book <a  onclick="history.go(-1);"><button type="button" class="btn btn-success"> <i class="fa fa-angle-double-left"></i> Back</button></a></h1>
		 </div>  <!-- #content-header -->	
...
<div class="col-sm-12">
                                 ...
                                 <div class="form-group">
									...
									<select id="staff" onchange="select_book()" name="staff" data-required="true" class="form-control" style="width:50%">
                                        ...
                                        <option value="<?php echo $st_id;?>"><?php echo  $emp_display["staff_id"]."-".$emp_display["fname"]." ".$emp_display["lname"]; ?></option>
                                  <?php } ?>								
                            		</select>
								</div> 
 ...
 {   
	 ...
	 var request =$.ajax({
		    ...
		    url: "ajax_staffbook_details.php",
 ...
 function change_function1(){ 
	    ...
	    var bid =document.getElementById('bid').value;
		 window.location.href = 'staff_multiplebook_details.php?bid='+bid;
 ...
 function select_employee() { 
	  ...
	  if(employee>0){
		  window.location="staff_multiple_details.php?emp="+employee;
	  }	
}
