 ...
 <div id="wrapper">
     ...
     <div id="content">		
		 ...
		 <div id="content-header">
			 <h1> Loan Details List</h1><?php if($year || $ltype){?><span style="float:right; margin-right:30px;"><b>Filter by : </b><?php if($year){ echo " Year = ".$year;} if($ltype && $year){ echo " | "; } if($ltype){ echo " Loan Type = ".$ltype;}?></span><?php } ?>
		 </div>  <!-- #content-header -->	
...
<?php } ?>	 <div class="row">
						...
						while($loantype=mysql_fetch_array($loan_typelist))
						{
                            ...
                            <div class="btn-group" style="float:right; margin-right:10px;">
							  ...
							  <ul class="dropdown-menu" role="menu">
                                  ...
                                  <li <?php if($year=="2013"){ echo 'class="active"';}?>><a href="loan_list.php?year=2013<?php if($ltype){ echo "&ltype=".$ltype;}?>">2013</a></li>
                                  <li <?php if($year=="2014"){ echo 'class="active"';}?>><a href="loan_list.php?year=2014<?php if($ltype){ echo "&ltype=".$ltype;}?>">2014</a></li>
                                  <li <?php if($year=="2015"){ echo 'class="active"';}?>><a href="loan_list.php?year=2015<?php if($ltype){ echo "&ltype=".$ltype;}?>">2015</a></li>
							  </ul>
							</div>
						 </div>  <!-- /.portlet-header -->
		...
		?>                             
										 <tr>
                                             ...
                                             <td><a href="loan_pay_list.php?id=<?php echo $l_id;?>&stid=<?php echo $emp_id;?>"<button type="button" class="btn btn-secondary">View</button></a></td>	
                                             <td><a title="Loan Details" href="#loanModal<?php echo $emp_count.''.$emp_id;?>" data-toggle="modal"><img src="img/layout/view.png"/></a> 
                                             <a title="Employee Details" href="#styledModal<?php echo $emp_count.''.$emp_id;?>" data-toggle="modal"><img src="img/layout/user.png"/></a>
        ...
        <div id="loanModal<?php echo $emp_count.''.$emp_id;?>" class="modal modal-styled fade">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h3 class="modal-title"><?php echo $emp_display["fname"]." ".$emp_display["lname"]; ?> - Loan Details</h3>
      </div>
