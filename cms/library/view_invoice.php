...
?>
		 ...
		 <tr>
              ...
              <a target="_blank" href='library_print_invoice.php?bin_id=<?=$_GET['bin_id']?>&sid=<?=$_GET['sid']?>'>  <input type="button" value="Print Invoice" class="btn btn-success btn-small btn-green">&nbsp;&nbsp;</a>
