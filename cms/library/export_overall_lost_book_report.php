...
$acyear_name=$ay['y_name'];
        ...
        $result=mysql_query("SELECT * FROM lms_lostbooks order by lb_id desc") or die(mysql_error());
...
$reader->setReadDataOnly(false);
     ...
     /*   for ($i = 1; $i < mysql_num_fields($result); $i++)
        ...
        */
        ...
        while($emp_display1 = mysql_fetch_array($result))
       ...
       // Redirect output to a client’s web browser (Excel5)
        ...
        header("Content-Disposition: attachment;filename=overall_lost_Book_report-list.xls");
