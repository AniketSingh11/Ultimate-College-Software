 ...
 <div id="wrapper">
     ...
     <div id="content">		
		 ...
		 <div id="content-header">
			 <h1>Specimen Book Details </h1><?php if($filter){?><span style="float:right; margin-right:30px;"><b>Filter by : </b> <?php echo $cat_name;?></span><?php } ?>
		 </div>  <!-- #content-header -->	
				 ...
				 <div class="col-md-12">
					 <div class="portlet">
						 <div class="portlet-header">
							...
							<div class="btn-group" style="float:right;">
							  ...
							  <ul class="dropdown-menu" role="menu">
                                <li <?php if(!$filter){ echo 'class="active"';}?>><a href="book_details_list1.php">Over All</a></li>
                            <?php 
									...
									?>
										...
										<li   <?php if($_GET["filt"]==$row["c_id"]){?>class="active" <?php }?> ><a href="book_details_list1.php?filt=<?=$row["c_id"]?>"><?=stripslashes($row["category_name"]);?></a></li>
									 <?php }?>
						 ...
						 <div class="portlet-content">
						   ...
						   <center> <a href="export_overall_specimen_book_report.php?filt=<?=$filter?>"> <button type="button" class="btn btn-warning">Download Excel</button></a></center>
                             ...
                             <table 
								...
								data-paginate="true">
									...
									<tbody>
										...
										if($filter!=""){
											$emp_query="select * from lms_book  where category='$filter' and  status='0' and specimen='1' order by b_id desc";
										}else{
											$emp_query="select * from lms_book  where status='0' and specimen='1' order by b_id desc";
										}
