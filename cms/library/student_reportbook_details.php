...
<?php if($s_id){ ?>  
        <center>     <a href="export_studentbook_report.php?ay_id=<?=$acyear?>&s_id=<?=$s_id?>">    <button type="button" class="btn btn-warning">   Download Excel</button></a>  <a title="view" href="#info-dialog_<?php echo $s_id;?>" data-toggle="modal">    <button type="button" class="btn btn-warning">   Student profile</button></a></center>
...
<?php         
 ...
 function change_function1(){ 
	    ...
	    var student = parseFloat(document.getElementById('student').value);
		 ...
		 window.location.href = "student_reportbook_details.php?sid="+student+'&bid='+bid;
 ...
 function select_employee() { 
     ...
     var bid=document.getElementById('bid').value;
	  ...
	  if(student>0){
		  window.location="student_reportbook_details.php?sid="+student+'&bid='+bid;
	  }	
}
