...
$reader->setReadDataOnly(false);
     ...
     /*   for ($i = 1; $i < mysql_num_fields($result); $i++)
        ...
        */
        ...
        $result=mysql_query("select * from lms_staff_borrowbook  where  staff_id='$s_id'  and ay_id='$ayid'  order by status asc");
        ...
        header("Content-Disposition: attachment;filename=StaffBook_report-list($staff_number-$fname).xls");
