 ...
 <div id="wrapper">
     ...
     <div id="content">	
		 <div id="content-header">
			 <h1>  Student Return Pending Book Status <a  onclick="history.go(-1);"><button type="button" class="btn btn-success"> <i class="fa fa-angle-double-left"></i> Back</button></a></h1>
		 </div>  <!-- #content-header -->	
...
<?php   if(isset($_GET['bid']))
            ...
            ?>
                ...
                <label for="select">Board :</label>
					 ...
					 <h3>						 
						Student Return Pending Book Status 
					 </h3>			 
				 </div>  <!-- /.portlet-header -->			
<form id="validate-enhanced" action="" class="form parsley-form" method="post" enctype="multipart/form-data" name="first">
    ...
    <center>     <a href="export_pending_studentbook_report.php?ay_id=<?=$acyear?>&b_id=<?=$bid?>">    <button type="button" class="btn btn-warning">   Download Excel</button></a></center>
									...
									<thead>
										<tr>
                                            ...
                                            <!--  <th data-filterable="true" data-sortable="true">From Date</th>	--> 
                                             <th data-filterable="true" data-sortable="true">Renew Date </th>		
