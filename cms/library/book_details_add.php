 ...
 include("header.php");
  ...
  if(isset($_POST["submit"]))
  {
	...
	if($book_title!="" && $category!="" && $a_name!="" && $qty!="" && $publisher!="" && $purchase_date!="" && $shelf_no!="" && is_numeric($qty))
	{
	    ...
	    $query="insert into lms_book(category,book_title,author_name,publisher,edition,qty,avilable_qty,shelf_no,creation_date,purchase_date,mrp_rs,specimen)
	    values('$category','$book_title','$a_name','$publisher','$edition','$qty','$qty','$shelf_no','$date','$purchase_date','$mrp_rs','$sp_book')";
...
<div class="col-sm-6">
                                ...
                                <div class="form-group">
								 ...
								 <div class="form-group">
									...
									<input class="form-control txt" type="text" placeholder="Start date" name="purchase_date" data-minlength="10"   data-maxlength="10" value="<?=$_POST["purchase_date"];?>" id="dpStart" data-date-format="dd/mm/yyyy" data-date-autoclose="true" data-required="true" >
                        ...
                        <div class="col-sm-6">
							    ...
							    <div class="form-group">
							     ...
							     <div class="form-group">
									...
									<input type="text" id="mrp_rs" name="mrp_rs"  value="<?=$_POST["mrp_rs"]?>" class="form-control" >
								 </div>
								  
								 <div class="form-group">
									<label for="name">specimen book :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" id="sp_book" name="sp_book"  checked="checked"  value='0' class="form-control" >No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" id="sp_book" name="sp_book"   value='1' class="form-control" >Yes
								 </div>
