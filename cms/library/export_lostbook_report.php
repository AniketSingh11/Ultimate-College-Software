...
$reader->setReadDataOnly(false);
     ...
     /*   for ($i = 1; $i < mysql_num_fields($result); $i++)
        ...
        */
        ...
        $objPHPExcel->getActiveSheet()->getColumnDimension('H')->setWidth(12);cellFont("H2","Calibri");
        ...
        */
        ...
        $objPHPExcel->getActiveSheet()->getColumnDimension('F')->setWidth(12);cellFont("F2","Calibri");
        $objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, "Academic Year");;$column++;
        ...
        header("Content-Disposition: attachment;filename=LostBook_report-list($booktitle).xls");
