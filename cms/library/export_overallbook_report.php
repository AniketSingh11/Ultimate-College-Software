...
if($filter!=""){
    $result=mysql_query("SELECT * FROM lms_book   where category='$filter' and status='0' and specimen='0' order by b_id desc") or die(mysql_error());
  
}else{
        $result=mysql_query("SELECT * FROM lms_book  where status='0' and specimen='0' order by b_id desc") or die(mysql_error());
}
...
$reader->setReadDataOnly(false);
     ...
     /*   for ($i = 1; $i < mysql_num_fields($result); $i++)
        ...
        */
        ...
        header("Content-Disposition: attachment;filename=overallBook_report-list.xls");
