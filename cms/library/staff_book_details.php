 ...
 include("header.php");
  ...
  if(isset($_POST["submit"]))
  {
      ...
      $res1=mysql_query("select * from lms_staff_borrowbook where staff_id='$staff_id' and  book_id='$book_id' and book_number='$book_number' and status='0'") or die(mysql_error());
      $chk=0;
      ...
      {
        $query="insert into lms_staff_borrowbook(staff_id,book_id,start_date,creation_date,ay_id,book_number)
	          values('$staff_id','$book_id','$from_date','$date','$acyear','$book_number')";
