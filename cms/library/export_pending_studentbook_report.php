...
$acyear_name=$ay['y_name'];
        ...
        $result = mysql_query("SELECT * FROM lms_student_borrowbook  where  ay_id='$ayid' and  b_id='$bid' and  status='0'") or die(mysql_error());
...
$reader->setReadDataOnly(false);
     ...
     /*   for ($i = 1; $i < mysql_num_fields($result); $i++)
        ...
        */
        ...
        header('Content-Disposition: attachment;filename="Pending_StudentBook_report-list.xls"');
