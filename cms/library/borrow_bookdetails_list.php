 ...
 <div id="wrapper">
     ...
     <div id="content">		
		 ...
		 <div id="content-header">
			 <h1> Borrow Book Details </h1><?php if($filter){?><span style="float:right; margin-right:30px;"><b>Filter by : </b> <?php echo $cat_name;?></span><?php } ?>
		 </div>  <!-- #content-header -->	
							...
							>
									...
									<tbody>
										<?php	
											...
											$emp_query="select * from lms_student_borrowbook  where status='0' and ay_id='$acyear' and  b_id='$bid' order by date_time asc";
...
function change_function1(){ 
    ...
    var bid =document.getElementById('bid').value;
	 window.location.href = 'borrow_bookdetails_list.php?bid='+bid;
