...
<style type="text/css">
 ...
 <div id="wrapper">
     ...
     <?php
				 $stid=$_GET["id"];
$emp_query="select * from staff where st_id='$stid'";
$emp_result=mysql_query($emp_query);
$emp_display=mysql_fetch_array($emp_result);
?>		
		
		 <div id="content-header">
			 <h1> <?php echo $emp_display["staff_id"] ; ?> Salary Details </h1>
		 </div>  <!-- #content-header -->	
...
<?php } ?>
				 ...
				 <div class="col-md-12">
					 ...
					 <div class="portlet">
						 ...
						 <div class="portlet-header">
                             ...
                             <a href="salary_add.php" title="Add Employee"><button type="button" class="btn btn-warning">Add salary</button></a>
                             
                             <!--<p class="add_link"><a href="emp_details_add.php" ><img src="img/layout/add.png" /></a></p>-->
									...
									<thead>
										<tr>
											<th data-sortable="true">S.No</th>
											 <th data-filterable="true" data-sortable="true">Salary Amount</th>
											 <th data-filterable="true" data-sortable="true" data-direction="asc">Start Date</th>
                                             <th data-filterable="true" data-sortable="true">End Date </th>											 
											 <th data-filterable="true" class="hidden-xs hidden-sm">Total Expriances</th>
                                             <th data-filterable="true" data-sortable="true">Position</th>                                             
                                             <th data-filterable="true" data-sortable="true" >Employee Type</th>
                                             <th data-filterable="false" class="hidden-xs hidden-sm">Action</th>
										</tr>
									</thead>
									<tbody>
										<?php		
		$emp_query="select * from staff_salary where st_id='$stid' order by sts_id desc";
		$emp_result=mysql_query($emp_query);
		$emp_count=1;
		...
		?>                             
										 <tr>
                                             ...
                                             <td><a href="" title="Salary Details"><button type="button" class="btn btn-sm btn-success">
