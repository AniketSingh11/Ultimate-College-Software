 ...
 <div id="wrapper">
     ...
     <div id="content">	
		 <div id="content-header">
			 <h1>Student No Paid Fine Amount Book Report </h1>
		 </div>  <!-- #content-header -->	
...
<?php   if(isset($_GET['bid']))
            ...
            ?>
                ...
                <label for="select">Board :</label>
					 ...
					 <h3>						 
						Student No Paid Fine Amount Book Report
					 </h3>			 
				 </div>  <!-- /.portlet-header -->			
        ...
        <center>      <a title="view" href="#info-dialog_<?php echo $s_id;?>" data-toggle="modal">    <button type="button" class="btn btn-warning">   Student profile</button></a></center>
                             ...
                             <table 
								...
								data-paginate="true">
									...
									<tbody>
										<?php	
								 	$emp_query="select * from lms_student_borrowbook  where ay_id='$acyear' and student_id='$s_id' and b_id='$bid' and status='1' and fine_amount!='0' and paid_status='0' ";
...
<?php         
 ...
 function change_function1(){ 
	    ...
	    var student = parseFloat(document.getElementById('student').value);
		 ...
		 window.location.href = "student_nopaidamount_details.php?sid="+student+'&bid='+bid;
 ...
 function select_employee() { 
     ...
     var bid=document.getElementById('bid').value;
	  ...
	  if(student>0){
		  window.location="student_nopaidamount_details.php?sid="+student+'&bid='+bid;
	  }	
}
