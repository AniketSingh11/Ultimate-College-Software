...
$acyear_name=$ay['y_name'];
        ...
        $result = mysql_query("SELECT * FROM lms_student_borrowbook  where  `student_id`='$s_id' AND `ay_id`='$ayid'") or die(mysql_error());
...
$reader->setReadDataOnly(false);
     ...
     /*   for ($i = 1; $i < mysql_num_fields($result); $i++)
        ...
        */
        ...
        header("Content-Disposition: attachment;filename=StudentBook_report-list($student_number-$firstname).xls");
