 ...
 <div id="wrapper">
     ...
     <div id="content">		
		 ...
		 <div id="content-header">
			<h1> Employee Salary Details <a href="emp_salary_detail_print.php" title="Print" target="_blank" ><button type="button" class="btn btn-success">Print</button></a></h1>
			
			<?php if($filter){?><span style="float:right; margin-right:30px;"><b>Filter by : </b> Employee Type = <?php echo $filter;?></span><?php } ?>
		 </div>  <!-- #content-header -->	
...
<?php } ?>		 <div class="row">
						 ...
						 <div class="portlet-header">
                            ...
                            <div class="btn-group" style="float:right;">
							  ...
							  <ul class="dropdown-menu" role="menu">
                                <li <?php if(!$filter){ echo 'class="active"';}?>><a href="emp_salary_detail.php">Over All</a></li>
							    <li <?php if($filter=="Teaching"){ echo 'class="active"';}?>><a href="emp_salary_detail.php?filt=Teaching">Teaching</a></li>
							    <li <?php if($filter=="Non-Teaching"){ echo 'class="active"';}?>><a href="emp_salary_detail.php?filt=Non-Teaching">Non-Teaching</a></li>
							  </ul>
							</div>
						 </div>  <!-- /.portlet-header -->
						 <div class="portlet-content">
							...
							>
									...
									<tbody>
										...
										if($filter=="Teaching"){
											$emp_query="select * from staff where s_type='Teaching' and status =  '1' and relivestatus='0' order by fname asc";
										}else if($filter=="Non-Teaching"){
											$emp_query="select * from staff where s_type='Non-Teaching' and status =  '1' and relivestatus='0' order by fname asc";
										}else{
		...
		?>                             
										 <tr>
                                             ...
                                             <td><a href="salary_detail.php?id=<?php echo $emp_id; ?>&syear=<?php echo $ay['s_year'].'&eyear='.$ay['e_year'];?>" title="Salary Details"><button type="button" class="btn btn-sm btn-success">
