			  ...
			  <div class="progress-bar <?php echo $process;?>" role="progressbar" aria-valuenow="<?php echo $emp_display["per_cent"]; ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $emp_display["per_cent"]; ?>%;">
			    <span class="sr-only"> <?php echo $emp_display["per_cent"]; ?>% Complete</span>
                                ...
                                <button class="btn btn-sm btn-success" >Active</button><?php }else{?><button class="btn btn-sm btn-gray" >Inactive</button> <?php } ?>
                                             ...
                                             <a title="edit" href="allw_ded_edit.php?id=<?php echo $emp_id; ?>"><img src="img/layout/edit.png"/></a> 
											  <?php if($_SESSION['admin_type']=="0" || in_array("allw_ded_list.php", $permissions_record_delete) ){ ?>
											 <a title="delete" href="allw_ded_delete.php?id=<?php echo $emp_id; ?>" onClick="return confirm('are you sure you wish to delete this record');"><img src="img/layout/delete.png"/></a>
			  ...
			  <div class="progress-bar <?php echo $process;?>" role="progressbar" aria-valuenow="<?php echo $emp_display["per_cent"]; ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $emp_display["per_cent"]; ?>%;">
			    <span class="sr-only"> <?php echo $emp_display["per_cent"]; ?>% Complete</span>
                                ...
                                <button class="btn btn-sm btn-success" >Active</button><?php }else{?><button class="btn btn-sm btn-gray" >Inactive</button> <?php } ?>
                                             ...
                                             <td><a title="edit" href="allw_ded_edit.php?id=<?php echo $emp_id; ?>"><img src="img/layout/edit.png"/></a> 
											 <?php if($_SESSION['admin_type']=="0" || in_array("allw_ded_list.php", $permissions_record_delete) ){ ?>
											 <a title="delete" href="allw_ded_delete.php?id=<?php echo $emp_id; ?>" onClick="return confirm('are you sure you wish to delete this record');"><img src="img/layout/delete.png"/></a> 
											 <?php } ?>
											 </td>	
