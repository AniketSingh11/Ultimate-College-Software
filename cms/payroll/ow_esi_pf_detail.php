 ...
 <div id="wrapper">
     ...
     <div id="content">		
		 ...
		 <div id="content-header">
			 <h1> Other Workers ESI AND PF Detail </h1><?php if($filter){?><span style="float:right; margin-right:30px;"><b>Filter by : </b> Employee Type = <?php echo $filter;?></span><?php } ?>
		 </div>  <!-- #content-header -->	
...
<?php } ?>		 <div class="row">
				 <div class="col-md-12">
					 <div class="portlet">
						 <div class="portlet-header">
							 <h3>
								Other Workers ESI AND PF Detail 
							 </h3>
                            <div class="btn-group" style="float:right;">
                              ...
                              <li <?php if(empty($cid)){?> class="active"<?php }?>><a href="ow_esi_pf_detail.php">All</a></li>
                              <?php 
							  		$classl = "SELECT * FROM others_category";
                                    $result1 = mysql_query($classl) or die(mysql_error());
									while ($row1 = mysql_fetch_assoc($result1)){
								?>
                                <li <?php if($cid==$row1['oc_id']){?> class="active"<?php }?>><a href="ow_esi_pf_detail.php?cid=<?=$row1['oc_id']?>"><?=$row1['category_name']?></a></li><?php } ?>
							  </ul>
							</div>
						 </div>  <!-- /.portlet-header -->
		...
		while($emp_display=mysql_fetch_array($emp_result))
		{
			...
			$ocid=$emp_display["category_id"];
				...
				$emp_result0=mysql_query("select id from staff_salary where o_id=$emp_id AND deduction order by id desc");
		...
		?>                             
										 <tr>
                                             ...
                                             <td><a href="esi_pf_detail1.php?id=<?php echo $emp_id; ?>&syear=<?php echo $ay['s_year'].'&eyear='.$ay['e_year'];?>" title="Salary Details"><button type="button" class="btn btn-sm btn-success">
