...
while($loan1=mysql_fetch_array($loanlist1))
{
	$totalpay +=$loan1['amount'];
	 ...
	 $user = $_SESSION['uname'];	
			if($net_salary>0){			
$query="insert into staff_daily_salary(st_id,o_id,d_id,staff_name,staff_id,date,day,month,year,g_salary,n_salary,d_total,loan_pay,total_leave,doj,position,role,accno,tleave,tlob,ay_id,a_id,date_day,date_month,date_year,login_user_name)values('$stid','$oid','$did','$staff_name','$staff_id','$salary_date','$sdate_day','$sdate_month','$sdate_year','$gross_total','$net_salary','$deduction_total','$l_pay','$tleave','$doj','$position','$role','$accno','$tleave','$tlob','$acyear','$advace_id','$sdate_day1','$sdate_month1','$sdate_year1','$user')";
