...
<?php } ?>	 <div class="row">
		...
		?>                             
										 <tr>
                                             ...
                                             <?php if(!$loanpay){?> 
											 <?php if($_SESSION['admin_type']=="0" || in_array("loan_list.php", $permissions_record_delete) ){ ?>
											 <a title="delete" href="loan_delete.php?id=<?php echo $l_id;?>" onClick="return confirm('are you sure you wish to delete this record');"><img src="img/layout/delete.png"/></a> 
