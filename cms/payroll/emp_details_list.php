 ...
 <div id="wrapper">
     ...
     <div id="content">		
		 ...
		 <div id="content-header">
			 <h1> Employee Details </h1><?php if($filter){?><span style="float:right; margin-right:30px;"><b>Filter by : </b> Employee Type = <?php echo $filter;?></span><?php } ?>
		 </div>  <!-- #content-header -->	
...
<?php } ?>		 <div class="row">
				 <div class="col-md-12">
					 <div class="portlet">
						 <div class="portlet-header">
                             ...
                             <a href="emp_details_add.php" title="Add Employee"><button type="button" class="btn btn-warning">Add Employee</button></a>
							<div class="btn-group" style="float:right;">
							  <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown">
							    Filter by Employee Type <span class="caret"></span>
							  </button>
							  <ul class="dropdown-menu" role="menu">
                                <li <?php if(!$filter){ echo 'class="active"';}?>><a href="emp_details_list.php">Over All</a></li>
							    <li <?php if($filter=="Teaching"){ echo 'class="active"';}?>><a href="emp_details_list.php?filt=Teaching">Teaching</a></li>
							    <li <?php if($filter=="Non-Teaching"){ echo 'class="active"';}?>><a href="emp_details_list.php?filt=Non-Teaching">Non-Teaching</a></li>
							  </ul>
							</div>
						 </div>  <!-- /.portlet-header -->
						 <div class="portlet-content">
							...
							>
									...
									<tbody>
										...
										if($filter=="Teaching"){
											$emp_query="select * from staff where s_type='Teaching' AND relivestatus=0 order by fname asc";
										}else if($filter=="Non-Teaching"){
											$emp_query="select * from staff where s_type='Non-Teaching' AND relivestatus=0 order by fname asc";
										}else{
											$emp_query="select * from staff where relivestatus=0 order by fname asc";
										}
		...
		?>                             
										 <tr>
                                             ...
                                             <td><a href="emp_salary_list.php?id=<?php echo $emp_id; ?>" title="Salary Details"><button type="button" class="btn btn-sm btn-success">
								<i class="fa fa-cogs"></i> View
							</button></a></td>
                                             								 
											 <td><a title="view" href="#styledModal<?php echo $emp_count.''.$emp_id;?>" data-toggle="modal"><img src="img/layout/view.png"/></a> <a title="edit" href="emp_details_edit.php?id=<?php echo $emp_id; ?>"><img src="img/layout/edit.png"/></a> 
											 <?php if($_SESSION['admin_type']=="0" || in_array("emp_details_list.php", $permissions_record_delete) ){ ?>
												<a title="delete" href="emp_details_delete.php?id=<?php echo $emp_id; ?>" onClick="return confirm('are you sure you wish to delete this record');"><img src="img/layout/delete.png"/></a>
											 <?php } ?>
											 </td>
										 </tr>
		<?php 
