...
$oid=$_GET['id'];
  ...
  foreach($_POST['deduction'] as $value1)
  {
	...
	$query="insert into staff_salary(salary,allowance,deduction,date,o_id,status,extra_salary,extra_salary_type)values('$salary','$allowance','$deduction','$date1','$oid','1','$ex_salary','$extrasalary_type')";
