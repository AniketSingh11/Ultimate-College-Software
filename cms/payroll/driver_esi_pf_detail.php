 ...
 <div id="wrapper">
     ...
     <div id="content">				
		 <div id="content-header">
			 <h1> Driver ESI and PF Details </h1><?php if($filter){?><span style="float:right; margin-right:30px;"><b>Filter by : </b> Driver Type = <?php echo $filter;?></span><?php } ?>
		 </div>  <!-- #content-header -->	
...
<?php } ?>		 <div class="row">
				 <div class="col-md-12">
					 <div class="portlet">
						 <div class="portlet-header">
							 <h3>
								Driver ESI and PF Details List 
							 </h3>
                            <div class="btn-group" style="float:right;">
							  ...
							  <ul class="dropdown-menu" role="menu">
                                <li <?php if(!$filter){ echo 'class="active"';}?>><a href="driver_esi_pf_detail.php">Over All</a></li>
							    <li <?php if($filter=="Driver"){ echo 'class="active"';}?>><a href="driver_esi_pf_detail.php?filt=Driver">Driver</a></li>
							    <li <?php if($filter=="Non-Driver"){ echo 'class="active"';}?>><a href="driver_esi_pf_detail.php?filt=Non-Driver">Non-Driver</a></li>
							  </ul>
							</div>
						 </div>  <!-- /.portlet-header -->
		...
		while($emp_display=mysql_fetch_array($emp_result))
		{
			...
			$emp_result0=mysql_query("select id from staff_salary where d_id=$emp_id AND deduction order by id desc");
		...
		?>                             
										 <tr>
                                             ...
                                             <td><a href="esi_pf_detail2.php?id=<?php echo $emp_id; ?>&syear=<?php echo $ay['s_year'].'&eyear='.$ay['e_year'];?>" title="leave Details"><button type="button" class="btn btn-sm btn-success">
