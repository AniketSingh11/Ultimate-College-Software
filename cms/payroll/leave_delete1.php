...
if($_SESSION['admin_type']=="0" || in_array("leave_detail.php", $permissions_record_delete) ){
...
if($result)
{
	header("location:leave_detail.php?id=$stid&syear=$syear&eyear=$eyear&msg=dsucc");
}
else
{
	header("location:leave_detail.php?id=$stid&syear=$syear&eyear=$eyear&msg=err");
}
}
else
{
	header("location:leave_detail.php?id=$stid&syear=$syear&eyear=$eyear");
}
?>
