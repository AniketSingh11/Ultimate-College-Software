...
if($result)
{
	header("location:leave_detail2.php?id=$stid&syear=$syear&eyear=$eyear&msg=dsucc");
}
else
{
	header("location:leave_detail2.php?id=$stid&syear=$syear&eyear=$eyear&msg=err");
}
}
else
{
	header("location:leave_detail2.php?id=$stid&syear=$syear&eyear=$eyear");
}
?>
