...
// Code that uses other library's $ can follow here.
  ...
  <script type="text/javascript">
	...
	function change_function() { 
	 ...
	 window.location.href = 'ow_leave_list_print.php?cid='+cid;	  
	} 
  </script>
  <!-- end scripts-->
...
window.location.href="ow_leave_list_print.php?&cid="+document.getElementById('cid').value;
