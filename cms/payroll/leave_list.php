 	 ...
 	 <div class="row">
		...
		?>                             
                                ...
                                <button class="btn btn-small btn-warning" >Pending</button><?php }else if($emp_display['status']=='1'){?><button class="btn btn-small btn-success" >Approved</button> <?php } else{?><button class="btn btn-small btn-primary">Rejected</button><?php } ?></td>
											 ...
											 <td><a title="view" href="#styledModal<?php echo $emp_count.''.$id;?>" data-toggle="modal"><img src="img/layout/view.png"/></a> <a title="edit" href="leave_edit.php?id=<?php echo $id; ?>"><img src="img/layout/edit.png"/></a> 
											<?php if($_SESSION['admin_type']=="0" || in_array("leave_list.php", $permissions_record_delete) ){ ?>
												<a title="delete" href="leave_delete.php?id=<?php echo $id; ?>" onClick="return confirm('are you sure you wish to delete this record');"><img src="img/layout/delete.png"/></a> 
											<?php } ?>
											 </td>
										 </tr>
		<?php         
