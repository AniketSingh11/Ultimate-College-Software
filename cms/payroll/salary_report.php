			 ...
			 <div class="col-md-12">
					 <div class="portlet">
						 <div class="portlet-header">
                             ...
                             <a href="salary_report_add.php" title="Salary Report Generate"><button type="button" class="btn btn-warning">Salary Report Generate</button></a>
                            <div class="btn-group" style="float:right; margin-right:10px;">
							  <button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown">
							    Filter by Year <span class="caret"></span>
							  </button>
							  <ul class="dropdown-menu" role="menu">
                              <li <?php if(!$year){ echo 'class="active"';}?>><a href="salary_report.php">Over All</a></li>
                              <?php for($i=$start;$i<=$tyear;$i++){ ?>
                               <li <?php if($year==$i){ echo 'class="active"';}?>><a href="salary_report.php?year=<?php echo $i;?>"><?php echo $i;?></a></li>
								  <?php } ?>
							  </ul>
							</div>
						 </div>  <!-- /.portlet-header -->
						 <div class="portlet-content">						
							...
							>
									<thead>
										<tr>
											<th data-sortable="true">S.No</th>
                                             ...
                                             <th data-filterable="true" data-sortable="true">To</th>
											 <th data-filterable="true" data-sortable="true">Subject </th>
                                             <th data-filterable="true" data-sortable="true">cheque No </th>	
									...
									<tbody>
										<?php	
											$emp_query="select * from staff_salary_report";										
											if($year){
								...
								while($emp_display=mysql_fetch_array($emp_result))
								{
									...
									$emp_result1=mysql_query("select n_salary from staff_month_salary where month=$month and year=$year ");
									$total1=0;
									while($emp_display1=mysql_fetch_array($emp_result1))
									{
										$total1 +=$emp_display1["n_salary"];	
									}
		?>                             
										 <tr>
											 <td><?php echo $emp_count ;?> </td>
                                             <td><?php echo $emp_display["month"]."-".$emp_display["year"]; ?> </td>
                                             <td><?php echo $emp_display["to_address"]; ?> </td>
                                             <td><?php echo $emp_display["subject"]; ?> </td>
                                             <td><?php echo $emp_display["cheque_no"]; ?> </td>
                                             <td>Rs. <?php echo round($total1); ?> </td> 
                                             <td>
                                             <a title="edit" href="salary_report_edit.php?id=<?php echo $id; ?>"><img src="img/layout/edit.png"/></a>
											<?php if($_SESSION['admin_type']=="0" || in_array("salary_report.php", $permissions_record_delete) ){ ?>
                                              <a title="delete" href="salary_report_delete.php?id=<?php echo $id;?>" onClick="return confirm('are you sure you wish to delete this record');"><img src="img/layout/delete.png"/></a>
											<?php } ?>
                                              <a title="Print" href="salary_report_prt.php?id=<?php echo $id; ?>" target="_blank"><img src="img/layout/print.png"/></a></td>
										 </tr>
		<?php         
		$emp_count++;		
        }        
