...
?>		 <div class="row">
		...
		?>                             
                                ...
                                <button class="btn btn-small btn-success" >Active</button><?php }else{?><button class="btn btn-small btn-gray" >Inactive</button> <?php } ?>
                                             ...
                                             <td><a title="edit" href="leave_type_edit.php?id=<?php echo $lt_id; ?>"><img src="img/layout/edit.png"/></a>
											 <?php if($others==0){?> 
											 <?php if($_SESSION['admin_type']=="0" || in_array("leave_type.php", $permissions_record_delete) ){ ?>
												<a title="delete" href="leave_type_delete.php?id=<?php echo $lt_id; ?>" onClick="return confirm('are you sure you wish to delete this record');"><img src="img/layout/delete.png"/></a>
											 <?php } ?> 
											 <?php } ?> 
											 </td>
										 </tr>
