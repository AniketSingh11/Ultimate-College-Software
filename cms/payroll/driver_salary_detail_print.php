                                  ...
                                  <th><center>Gender</center></th>
                                    ...
                                    <?php
									  ...
									  if($d_type)
									  {
										...
										$qry=mysql_query("SELECT * FROM driver where d_type='$d_type' and status='1' AND relivestatus=0 ORDER BY fname asc");	
										
									  }
									  else
									  {
										  $qry=mysql_query("SELECT * FROM driver where status='1' AND relivestatus=0 ORDER BY fname asc");	
									  }
							$count=1;
...
//alert(s_type);
window.location.href="driver_salary_detail_print.php?d_type="+document.getElementById('d_type').value;
