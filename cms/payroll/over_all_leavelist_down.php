...
$objPHPExcel->getActiveSheet()->setCellValue("D4","A");
$objPHPExcel->getActiveSheet()->getColumnDimension("D4")->setWidth(50);cellFont("D1","Calibri");

$objPHPExcel->getActiveSheet()->setCellValue("E4","T");
$objPHPExcel->getActiveSheet()->getColumnDimension("E4")->setWidth(50);cellFont("D1","Calibri");

$objPHPExcel->getActiveSheet()->setCellValue("F4","R");
$objPHPExcel->getActiveSheet()->getColumnDimension("F4")->setWidth(50);cellFont("D1","Calibri");
...
$objPHPExcel->getActiveSheet()->setCellValue("G4","A");
$objPHPExcel->getActiveSheet()->getColumnDimension("G4")->setWidth(50);cellFont("D1","Calibri");

$objPHPExcel->getActiveSheet()->setCellValue("H4","T");
$objPHPExcel->getActiveSheet()->getColumnDimension("H4")->setWidth(50);cellFont("D1","Calibri");

$objPHPExcel->getActiveSheet()->setCellValue("I4","R");
$objPHPExcel->getActiveSheet()->getColumnDimension("I4")->setWidth(50);cellFont("D1","Calibri");



$objPHPExcel->getActiveSheet()->setCellValue("J4","A");
$objPHPExcel->getActiveSheet()->getColumnDimension("J4")->setWidth(50);cellFont("D1","Calibri");

$objPHPExcel->getActiveSheet()->setCellValue("K4","T");
$objPHPExcel->getActiveSheet()->getColumnDimension("K4")->setWidth(50);cellFont("D1","Calibri");

$objPHPExcel->getActiveSheet()->setCellValue("L4","R");
$objPHPExcel->getActiveSheet()->getColumnDimension("L4")->setWidth(50);cellFont("D1","Calibri");



$objPHPExcel->getActiveSheet()->setCellValue("M4","A");
$objPHPExcel->getActiveSheet()->getColumnDimension("M4")->setWidth(50);cellFont("D1","Calibri");

$objPHPExcel->getActiveSheet()->setCellValue("N4","T");
$objPHPExcel->getActiveSheet()->getColumnDimension("N4")->setWidth(50);cellFont("D1","Calibri");

$objPHPExcel->getActiveSheet()->setCellValue("O4","R");
$objPHPExcel->getActiveSheet()->getColumnDimension("O4")->setWidth(50);cellFont("D1","Calibri");



$objPHPExcel->getActiveSheet()->setCellValue("P4","A");
$objPHPExcel->getActiveSheet()->getColumnDimension("P4")->setWidth(50);cellFont("D1","Calibri");

$objPHPExcel->getActiveSheet()->setCellValue("Q4","T");
$objPHPExcel->getActiveSheet()->getColumnDimension("Q4")->setWidth(50);cellFont("D1","Calibri");

$objPHPExcel->getActiveSheet()->setCellValue("R4","R");
$objPHPExcel->getActiveSheet()->getColumnDimension("R4")->setWidth(50);cellFont("D1","Calibri");



$objPHPExcel->getActiveSheet()->setCellValue("S4","A");
$objPHPExcel->getActiveSheet()->getColumnDimension("S4")->setWidth(50);cellFont("D1","Calibri");

$objPHPExcel->getActiveSheet()->setCellValue("T4","T");
$objPHPExcel->getActiveSheet()->getColumnDimension("T4")->setWidth(50);cellFont("D1","Calibri");

$objPHPExcel->getActiveSheet()->setCellValue("U4","R");
$objPHPExcel->getActiveSheet()->getColumnDimension("U4")->setWidth(50);cellFont("D1","Calibri");
									}
  ...
  $objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount,"staff");  $column++;
	   ...
	   $objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount,$tleave);$column++;
		...
		while($emp_display4=mysql_fetch_array($emp_result4))
		{
			...
			$tleave=0;
			$emp_query5="select * from staff_leave where status='1' AND (st_id=$emp_id AND l_type=$lt_id) AND ((year=$syear AND month>'5') OR (year=$eyear AND month<='5'))";
			...
			$rleave1=$emp_display4["l_total"]-$tleave;
			if($other){ $rleave="0";}else{$rleave=$rleave1;}
			if($emp_display4["l_total"]==""){ $aleave="0";}else{$aleave=$emp_display4["l_total"];}
//echo $tleave.'ddd'.$rleave.'ddd'.$emp_display7["l_total"];die;
$objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, $aleave);  $column++;
$objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, $tleave);  $column++;
...
//echo $tleave.'ddd'.$rleave.'ddd'.$aleave;die;		
		}
	//
			//////////////////////////Others////////////////////////
...
$leaveid=$_GET['ltid'];
		...
		while($emp_display7=mysql_fetch_array($emp_result7))
		{
			...
			$rleave1=$emp_display7["l_total"]-$tleave;
				if($other){ $rleave="0";}else{$rleave=$rleave1;}
			if($emp_display7["l_total"]==""){ $aleave="0";}else{$aleave=$emp_display7["l_total"];}
	       		$objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, $aleave);  $column++;
$objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, $tleave);  $column++;
$objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, $rleave);  $column++;
$rleave=0;
...
$objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount,$emp_display["fname"]);  $column++;$rowcount++;										
  ...
  $objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount,"staff");  $column++;
		...
		while($emp_display1=mysql_fetch_array($emp_result1))
		{
			...
			$rleave1=$emp_display1["l_total"]-$tleave;
					if($other){ $rleave="0";}else{$rleave=$rleave1;}
					if($emp_display1["l_total"]==""){ $aleave="0";}else{$aleave=$emp_display1["l_total"];}
	  	       		$objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, $aleave);  $column++;
$objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, $tleave);  $column++;
$objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, $rleave);  $column++;
$rleave=0;
