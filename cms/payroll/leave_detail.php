		 ...
		 <div id="content-container">
			 <div class="row">
				...
				<div class="portlet-content">	
                        ...
                        <a href="leave_detail_down.php?id=<?php echo $sid."&syear=".$syear."&eyear=".$eyear."&acid=".$acyear."&type=st";?>" title="Download Report"><button type="button" class="btn btn-success">Download Report</button></a>
		...
		while($emp_display=mysql_fetch_array($emp_result))
		{
			...
			$emp_id=$emp_display["st_id"];	
                                ...
                                <button class="btn btn-small btn-warning" >Pending</button><?php }else if($emp_display['status']=='1'){?><button class="btn btn-small btn-success" >Approved</button> <?php } else{?><button class="btn btn-small btn-primary">Rejected</button><?php } ?></td>
											 ...
											 <td><a title="view" href="#styledModal<?php echo $id.$emp_id;?>" data-toggle="modal"><img src="img/layout/view.png"/></a> <a title="edit" href="leave_detail_edit.php?id=<?php echo $id; ?>"><img src="img/layout/edit.png"/></a> 
											  <?php if($_SESSION['admin_type']=="0" || in_array("leave_detail.php", $permissions_record_delete) ){ ?>
												<a title="delete" href="leave_delete1.php?id=<?php echo $id; ?>&stid=<?php echo $sid;?>" onClick="return confirm('are you sure you wish to delete this record');"><img src="img/layout/delete.png"/></a> 
											  <?php } ?>
											 </td>
										 </tr>
		<?php 
