...
$year=date("Y");
$d_id=$_GET['id'];
$stafflist1=mysql_query("SELECT * FROM driver WHERE d_id=$d_id"); 
...
?>
		 <div id="content-header">
			 <h1> <?php echo $staff1['fname']." ".$staff1['lname']." - (".$syear."-".$eyear.")";;?> ESI and PF Details <a href="driver_esi_pf_detail.php"><button type="button" class="btn btn-success"> <i class="fa fa-angle-double-left"></i> Back</button></a></h1>
		 </div>  <!-- #content-header -->	
				 ...
				 <div class="col-md-12">
					 <div class="portlet">
						 <div class="portlet-header">
							 <h3>
								<?php echo $staff1['fname']." ".$staff1['lname']." - (".$syear."-".$eyear.")";?> ESI and PF Details List 
							 </h3>    
                             ...
                             <a href="esi_pf_detail_down2.php?id=<?php echo $d_id."&syear=".$syear."&eyear=".$eyear."&acid=".$acyear;?>" title="Download Report"><button type="button" class="btn btn-success">Download Report</button></a>                         
							  ...
							  while($row=mysql_fetch_array($qry))
								{
									$syear1=$row['s_year'];
									$eyaer1=$row['e_year'];?>
                                  <li <?php if($row['y_name']==$yearstring){ echo 'class="active"';}?>><a href="esi_pf_detail2.php?id=<?php echo $d_id;?>&syear=<?php echo $syear1."&eyear=".$eyaer1;?>"><?php echo $row['y_name'];?></a></li>
                                  <?php } ?>                             		
							  </ul>
							</div>                            
                         </div>  <!-- /.portlet-header -->
						 <div class="portlet-content">
							...
							>
								  ...
								  $emp_query="SELECT DISTINCT a.* FROM staff_month_salary a, staff_month_salary_summary b WHERE a.d_id=$d_id AND ((a.year=$syear AND a.month>5) OR (a.year=$eyear AND a.month<=5)) AND a.st_ms_id = b.st_ms_id AND b.ad_id IN (".implode(',',$myarray).") AND b.pevalue AND b.amount"; 
							...
							?>                             
										 <tr>
                                             ...
                                             <td><a title="view" href="#styledModal<?php echo $emp_count.''.$emp_id;?>" data-toggle="modal"><img src="img/layout/view.png"/></a> <a title="Print" href="monthly_salary_print.php?id=<?php echo $emp_id; ?>&stid=<?php echo $st_id."&type=st"; ?>" target="_blank"><img src="img/layout/print.png"/></a> </td>
										 </tr>
		<?php 
		$emp_count++;
        }
                            ...
                            <tr>
                                ...
                                <td width="50%">
                                	<table>
                                    	<tr>
                                            ...
                                            <td style="border:none;">:</td>
                                            <td width="48%" style="border:none;"><b><?php if($emp_display['staff_id']){ echo $emp_display['staff_id'];}else{ echo $staff['driver_id'];}?></b></td>
                                        </tr>
                                        <tr>
                              ...
                              <tr>
                                <td width="50%" style="border-right:1px solid #CCCCCC">
                                	<table>
                                    <?php
									    $emp_query1="select * from staff_month_salary_summary where type='0' and st_ms_id=$emp_id and d_id=$stid order by sum_id asc";
                                ...
                                <td width="50%">
                                	<table>
                                    	<?php
									    $emp_query1="select * from staff_month_salary_summary where type='1' and st_ms_id=$emp_id and d_id=$stid order by sum_id asc";
										$emp_result1=mysql_query($emp_query1);
										$emp_count1=1;
										while($emp_display1=mysql_fetch_array($emp_result1))
										{
