...
?>
		 <div id="content-header">
			 <h1> <?php echo $months[$m_value]." - ".$y_value;?> Salary Details </h1>
		 </div>  <!-- #content-header -->	
				 ...
				 <div class="col-md-12">
					 <div class="portlet">
						 <div class="portlet-header">
							 <h3>
								<?php echo $months[$m_value]." - ".$y_value;?> Salary Details List 
							 </h3>  <a href="monthly_salary_multiple.php" title="Add Employee Salary"><button type="button" class="btn btn-warning" style="font-size: 13px;">Multiple Salary Generate</button></a>   
                             <a href="monthly_salary_single.php" title="Add Employee Salary"><button type="button" class="btn btn-warning" style="font-size: 13px;">Single Salary Generate</button></a>           
                             <a href="monthly_salary_down.php?m=<?php echo $m_value."&syear=".$syear."&eyear=".$eyear."&acid=".$acyear;?>" title="Download Report"><button type="button" class="btn btn-success" style="font-size: 13px;">Download Report</button></a> 
                             <a href="monthly_salary_down_full.php?m=<?php echo $m_value."&syear=".$syear."&eyear=".$eyear."&acid=".$acyear;?>" title="Download Report"><button type="button" class="btn btn-warining" style="font-size: 13px;">Download FullReport</button></a>     
<a href="monthly_salary_prt_full.php?m=<?php echo $m_value."&syear=".$syear."&eyear=".$eyear."&acid=".$acyear;?>" title="Print Report"><button type="button" class="btn btn-warining" style="font-size: 13px;">Print FullReport</button></a>								 
							  ...
							  while($row=mysql_fetch_array($qry))
								{
									$syear1=$row['s_year'];
									$eyaer1=$row['e_year'];?>
                                  <li <?php if($row['y_name']==$yearstring){ echo 'class="active"';}?>><a href="monthly_salary.php?m=<?php echo $m_value;?>&syear=<?php echo $syear1."&eyear=".$eyaer1;?>"><?php echo $row['y_name'];?></a></li>
                                  <?php } ?>                             		
							  </ul>
							</div>
							  ...
							  <ul class="dropdown-menu" role="menu">
                                <?php                                  
                                    foreach($months as $x => $x_value) {
									   if($x==$m_value){
                                    ?>
                                <li class="active"><a href="monthly_salary.php?m=<?php echo $x;?>&syear=<?php echo $syear;?>&eyear=<?php echo $eyear;?>"><?php echo $x_value; ?></a></li>
                                <?php }else{ ?>
                                <li><a href="monthly_salary.php?m=<?php echo $x;?>&syear=<?php echo $syear;?>&eyear=<?php echo $eyear;?>"><?php echo $x_value; ?></a></li>
                                <?php } }?>
							  </ul>
							</div>
                         </div>  <!-- /.portlet-header -->
						 <div class="portlet-content">
							...
							>
									...
									<tbody>
										<?php	
							  $emp_query="select * from staff_month_salary where month=$m_value and year=$y_value order by staff_id desc";										
							...
							?>                             
										 <tr>
                                             ...
                                             <td><a title="view" href="#styledModal<?php echo $emp_id;?>" data-toggle="modal"><img src="img/layout/view.png"/></a> <a title="Print" href="monthly_salary_print.php?id=<?php echo $emp_id; ?>&stid=<?php if($st_id){ echo $st_id."&type=st";}else if($o_id){ echo $o_id."&type=ow";}else if($d_id){ echo $d_id."&type=dr";}?>" target="_blank"><img src="img/layout/print.png"/></a>
                                             <a title="Edit" href="monthly_salary_edit.php?id=<?php echo $emp_id; ?>&stid=<?php if($st_id){ echo $st_id."&type=st";}else if($o_id){ echo $o_id."&type=ow";}else if($d_id){ echo $d_id."&type=dr";}?>" target="_blank"><img src="img/layout/edit.png"/></a>
											<?php if($_SESSION['admin_type']=="0" || in_array("monthly_salary.php", $permissions_record_delete) ){ ?>
												<a title="delete" href="monthly_salary_delete.php?id=<?php echo $emp_id."&m=".$m_value."&syear=".$syear."&eyear=".$eyear;?>" onClick="return confirm('are you sure you wish to delete this record');"><img src="img/layout/delete.png"/></a>
											<?php } ?>
                                              </td>
										 </tr>
		<?php 
        ...
        ?>							
                         ...
                         <div class="portlet-header">
							 <h3>
								<?php echo $months[$m_value]." - ".$y_value;?> Salary Not Genreated List
							 </h3>
						 </div>  <!-- /.portlet-header -->
                         <div class="portlet-content">
							 <div class="table-responsive">
							...
							>
									...
									<tbody>
										<?php	
											$emp_query="select t1.staff_id,t1.fname,t1.s_type,t1.email,t1.phone_no,t1.position from staff t1 LEFT JOIN staff_month_salary t2 ON t1.st_id = t2.st_id AND t2.month=$m_value AND t2.year=$y_value WHERE t2.st_id IS NULL AND t1.status='1' and t1.s_type='0' and t1.relivestatus='0'";
							$emp_result=mysql_query($emp_query);
							$emp_count=1;
							while($emp_display=mysql_fetch_array($emp_result))
							{
        ...
        ?>			
        <?php	
											$emp_query="select t1.others_id,t1.fname,t1.category_id,t1.email,t1.phone_no,t1.position from others t1 LEFT JOIN staff_month_salary t2 ON t1.o_id = t2.o_id AND t2.month=$m_value AND t2.year=$y_value WHERE t2.o_id IS NULL AND t1.status='1' and t1.relivestatus='0' AND t1.s_type='0'";
							$emp_result=mysql_query($emp_query);
							while($emp_display=mysql_fetch_array($emp_result))
							{
        ...
        ?>		
        <?php	
							$emp_query="select t1.driver_id,t1.fname,t1.d_type,t1.email,t1.phone_no,t1.position from driver t1 LEFT JOIN staff_month_salary t2 ON t1.d_id = t2.d_id AND t2.month=$m_value AND t2.year=$y_value WHERE t2.d_id IS NULL AND t1.status='1' and t1.relivestatus='0' AND t1.s_type='0'";
							$emp_result=mysql_query($emp_query);
							while($emp_display=mysql_fetch_array($emp_result))
							{
 ...
 <?php
					$emp_query="select * from staff_month_salary where month=$m_value and year=$y_value order by st_ms_id desc";								
							...
							while($emp_display=mysql_fetch_array($emp_result))
							{
								...
								$extra_salary=$emp_display["extra_salary"];
								if($stid){
		...
		?>  
<div id="styledModal<?php echo $emp_id;?>" class="modal modal-styled fade">
