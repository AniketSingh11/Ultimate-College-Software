<?php
 include("header.php");
  ...
  if(isset($_POST["submit"]))
  {
	...
	$user = $_SESSION['uname'];
  	$query="insert into staff_advance(st_id,o_id,d_id,staff_id,staff_name,staff_type,a_date,a_amount,day,month,year,status,login_user_name)values('$stid','$oid','$did','$staff_id','$staff_name','$role','$salary_date','$l_amount','$sdate_day','$sdate_month','$sdate_year','0','$user')";
...
<form id="validate-enhanced" action="" class="form parsley-form" method="post" enctype="multipart/form-data" name="first">
             ...
             <?php 
				 ...
				 $monthly_pay=0;
				 if($type=='st'){		
$emp_query11="select fname,lname,staff_id,s_type from staff where st_id='$s_id' and status='1' and relivestatus='0'";
