...
<h3><?php
if($d_type=="Driver")
echo "Driver Leave Details List";
else if($d_type=="Non-Driver")
echo "Non-Driver Leave Details List";
else
echo "Driver Leave Details List"; 
...
// Code that uses other library's $ can follow here.
  ...
  <script type="text/javascript">
	...
	function change_function() { 
	 ...
	 window.location.href = 'driver_leave_list_print.php?d_type='+d_type;	  
	} 
  </script>
  <!-- end scripts-->
...
//alert(s_type);
window.location.href="driver_leave_list_print.php?d_type="+document.getElementById('d_type').value;
