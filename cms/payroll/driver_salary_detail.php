 ...
 <div id="wrapper">
     ...
     <div id="content">				
		 <div id="content-header">
			 <h1> Driver Salary Details <a href="driver_salary_detail_print.php?" title="Print" target="_blank" ><button type="button" class="btn btn-success">Print</button></a></h1><?php if($filter){?><span style="float:right; margin-right:30px;"><b>Filter by : </b> Driver Type = <?php echo $filter;?></span><?php } ?>
		 </div>  <!-- #content-header -->	
...
<?php } ?>		 <div class="row">
						 ...
						 <div class="portlet-header">
                            ...
                            <div class="btn-group" style="float:right;">
							  ...
							  <ul class="dropdown-menu" role="menu">
                                <li <?php if(!$filter){ echo 'class="active"';}?>><a href="driver_salary_detail.php">Over All</a></li>
							    <li <?php if($filter=="Driver"){ echo 'class="active"';}?>><a href="driver_salary_detail.php?filt=Driver">Driver</a></li>
							    <li <?php if($filter=="Non-Driver"){ echo 'class="active"';}?>><a href="driver_salary_detail.php?filt=Non-Driver">Non-Driver</a></li>
							  </ul>
							</div>
						 </div>  <!-- /.portlet-header -->
		...
		?>                             
										 <tr>
                                             ...
                                             <td><a href="salary_detail2.php?id=<?php echo $emp_id; ?>&syear=<?php echo $ay['s_year'].'&eyear='.$ay['e_year'];?>" title="leave Details"><button type="button" class="btn btn-sm btn-success">
