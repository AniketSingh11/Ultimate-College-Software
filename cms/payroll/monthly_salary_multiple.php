...
if($type=='st'){	 
$emp_query11="select * from staff where st_id='$s_id' and status='1' and relivestatus='0'";
...
$emp_query11="select * from others where o_id='$s_id' and status='1' and relivestatus='0'";
$emp_result11=mysql_query($emp_query11);
$employee11=mysql_fetch_array($emp_result11);
...
$emp_query11="select * from driver where d_id='$s_id' and status='1' and relivestatus='0'";
$emp_result11=mysql_query($emp_query11);
$employee11=mysql_fetch_array($emp_result11);
...
$query="insert into staff_month_salary(st_id,o_id,d_id,staff_name,staff_id,date,day,month,year,g_salary,n_salary,d_total,loan_pay,total_leave,doj,position,role,accno,tleave,tlob,ay_id,a_id,date_day,date_month,date_year,extra_salary,extra_salary_type,login_user_name)values('$stid','$oid','$did','$staff_name','$staff_id','$salary_date','$sdate_day','$sdate_month','$sdate_year','$gross_total','$net_salary','$deduction_total','$l_pay','$tleave','$doj','$position','$role','$accno','$tleave','$tlob','$acyear','$advace_id','$sdate_day1','$sdate_month1','$sdate_year1','$extra_salary','$extra_salary_type','$user')";
	...
	$emp_query1="select * from staff_allw_ded where type='Deductions' order by id asc";
									...
									else
									{
                                      ...
                                      $query1="insert into staff_month_salary_summary(st_ms_id,st_id,o_id,d_id,name,amount,type,ad_id,pevalue)values('$lastid','$stid','$oid','$did','$dname','$d_salary','1','$emp_id1','$pevalue1')"; 
                                        }else{
                                   
										$query1="insert into staff_month_salary_summary(st_ms_id,st_id,o_id,d_id,name,amount,type,ad_id,pevalue)values('$lastid','$stid','$oid','$did','$dname','0','1','$emp_id1','$pevalue1')";
										}
										$result1=mysql_query($query1);
										$deduc=0;
                                    $emp_count1++;
											...
											/*  if($type=='dr'){
											$emp_query0="select * from staff_salary where d_id=$emp_id1 order by id desc";
											   }
											   elseif($type=='ow')
											   {
												   $emp_query0="select * from staff_salary where o_id=$emp_id1 order by id desc";
												   
											   }
											   else
											   {
												   $emp_query0="select * from staff_salary where st_id=$emp_id1 order by id desc";
											   }
