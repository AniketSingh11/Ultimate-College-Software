...
$stid=$_GET['id'];
  ...
  foreach($_POST['deduction'] as $value1)
  {
	...
	$query="insert into staff_salary(salary,allowance,deduction,date,st_id,status,extra_salary,extra_salary_type)values('$salary','$allowance','$deduction','$date1','$stid','1','$ex_salary','$extrasalary_type')";
	$result=mysql_query($query);	
	if($result)
	{
		$querys=mysql_query("update staff set extra_salary_type='$extrasalary_type',extra_salary='$ex_salary' where st_id=$stid");
		header("location:emp_salary_add.php?id=$stid&msg=succ");		
	}
	else
	{
		header("location:emp_salary_add.php?id=$stid&msg=err");		
	}
 ...
 <div id="wrapper">
     ...
     <div id="content">	
		 <div id="content-header">
			 <h1><?php echo $staffs['fname']." ".$staffs['lname'];?> - Salary Details Add <a href="emp_salary_list.php?id=<?php echo $stid;?>"><button type="button" class="btn btn-success"> <i class="fa fa-angle-double-left"></i> Back</button></a></h1>
		 </div>  <!-- #content-header -->	
...
<div class="col-sm-6">
                            ...
                            <?php
				                ...
				                <div class="checkbox">
									<label>
									    <input type="checkbox" name="allowance[]" class="" checked value="<?php echo $emp_display["id"]; ?>" data-required="true" data-mincheck="1">
...
<!--<div class="col-sm-4">
                                <h4>Extra Salary</h4>
	                        <div class="form-group">
				                <div class="checkbox" style="position: relative;margin-top: 33px;">
									<label>
									    <input type="radio" id="" name="extrasalary_type" class=""  value="in_hand">
									   In-Hand
									</label><br>
									<label>
									    <input type="radio" name="extrasalary_type" class=""  value="bank">
									  Bank
									</label>
								</div>              
							</div>
