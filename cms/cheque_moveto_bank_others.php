 ...
 if (isset($_POST['submit']))
{
    ...
    { 
	 $fiid=$selectedOption;
	 $invoicelist1=mysql_query("SELECT * FROM finvoice_others WHERE fi_id=$fiid"); 
								  $invoice=mysql_fetch_array($invoicelist1);
								  $oldamount=$invoice['fi_total'];
	 $cashqry=mysql_query("UPDATE finvoice_others SET ba_id='$baid',c_status='2' WHERE fi_id=$fiid");
...
('$date','$date_day','$date_month','$date_year','$acc_no','$b_name','Fees Cheque Pay','$amount','$baid','$acyear','1','$fiid')";
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover"><a href="cheque_feesinvoice.php" title="NEWS Management">Cheque Fees Payment</a></li>
		...
		<div id="main-content">
			...
			<a href="cheque_feesinvoice_others.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
				...
				<div class="block-border">
                    ...
                    <p>
                   		<select name="ms_example[ ]" multiple="multiple" id="msc" class="required">
                            ...
                            $select_record1=mysql_query("SELECT * FROM finvoice_others WHERE bid=$bid AND ay_id=$acyear and fi_ptype='cheque' AND i_status='0' AND ba_id='0'");
							...
							$studentlist=mysql_query("SELECT admission_number FROM student WHERE ss_id=$ssid"); 
							  $student=mysql_fetch_array($studentlist);	?>
                                            <option value="<?php echo $queryfetch1['fi_id'];?>"><?php echo $student['admission_number']."/Cheque No: ".$queryfetch1['pay_number']." - Cash:".$queryfetch1['fi_total']." Rs/-";?></option>
                              <?php } ?>
                                        </select>
                                        <div class="btn-group">
