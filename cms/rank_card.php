    ...
    <?php 
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover">Students List For Progress Card</li>                
			</ul>
		...
		<div id="main-content">
            ...
            <a href="board_select_rank.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
             <a href="particular_student_rank_card.php?b_id=<?=$bid?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-success"> Print particular  Student (Multiple)  </button></a>
			...
			<a href='progresscard_allprt.php?cid=<?=$cid?>&sid=<?=$sid?>&bid=<?=$bid?>' target="_blank">	<button class="btn btn-small btn-success" > Print All Students </button></a>
			</div>
            <div class="grid_12">
				<div class="block-border">
					<div class="block-header">
			  ...
			  while($row=mysql_fetch_array($qry))
        		{?>
                                ...
                                <td>
                                 ...
                                 <a href="progresscard_prt.php?ssid=<?php echo $row['ss_id'];?>&cid=<?php echo $cid;?>&sid=<?php echo $sid;?>&bid=<?php echo $bid;?>" title="View" target="_blank"> <button class="btn btn-small btn-success" > Print </button> </a>
...
<script type="text/javascript">
	...
	function change_function() { 
	 ...
	 window.location.href = 'rank_card.php?bid='+cid;	  
	} 
