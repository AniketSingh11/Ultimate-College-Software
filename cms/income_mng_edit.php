 ...
 if (isset($_POST['submit']))
{
	...
	$sql=mysql_query("UPDATE income SET r_no='$r_no',b_no='$b_no',date_day='$date_day',date_month='$date_month',date_year='$date_year',title='$title',des='$des',amount='$amount',ay_id='$acyear' WHERE in_id='$inid'") or die("Could not insert data into DB: " . mysql_error());
    ...
    if($sql){
        ...
        header("Location:income_mng_edit.php?incid=$incid&inid=$inid&msg=succ");
    }
    exit;
}
				...
				<div class="block-border">
                    ...
                    <div class="_25">
						...
						$classl = "SELECT * FROM in_category";
										    ...
										    echo '<select name="incid1" id="incid1" class="required" readonly>';
											while ($row1 = mysql_fetch_assoc($result1)):
												if($row['inc_id'] ==$row1['inc_id']){
