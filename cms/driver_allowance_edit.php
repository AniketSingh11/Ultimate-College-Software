 ...
 if (isset($_POST['submit']))
{
	...
	$total_amount=$_POST['amount'];
		 ...
		 $result=mysql_query("UPDATE d_allowance SET from_date='$from_date',to_date='$to_date',working_days='$working_days',perday_amount='$perday_amount',total_amount='$total_amount' WHERE d_id='$d_id'");
	 
	if($result){
	    header("Location:driver_allowance_edit.php?did=$d_id&msg=succ");
	    
       }else{
           
           header("Location:driver_allowance_edit.php?did=$d_id&msg=delsucc");
       }
}
...
<body id="top">
 ...
 <!--! end of #search-bar -->
    ...
    <div id="main" role="main">
    	<?php 
							$d_id=$_GET['did'];
					$qry=mysql_query("select * from  d_allowance where  d_id='$d_id'");
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				<li><a href="dashboard.php" title="Home"><span id="bc-home"></span></a></li>
				          <li class="no-hover">Edit  Driver Allowance Details</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Edit Driver Allowance Details</h1>                
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Edit Driver Allowance Details</h1><span></span>
					</div>
					<form id="validate-form" class="block-content form" action="" method="post">
                         ...
                         <div class="_25">
                                    <p>
                                        <label for="textfield"> Driver : <?php
											$sql = mysql_query("SELECT * FROM driver where driver_id='$driver_id'");
											 $thisrow = mysql_fetch_array($sql);
											$sname=$thisrow['fname']." ".$thisrow['lname'];?>
										<?php echo $thisrow['driver_id']."-".$sname;?> </label>
							...
							<p >
                                ...
                                <input id="datepicker" name="from_date"  value="<?=$from_date?>" class="required" type="text"  />
                            </p>
						</div>
						  ...
						  <div class="_25">
							<p>
                                ...
                                <input id="datepicker1" name="to_date"  value="<?=$to_date?>" class="required" type="text"  />
                            </p>
						</div>
                        ...
                        <div class="_25">
							<p>
                                <label for="textfield">Per Day Allowance Amount <span class="error">*</span></label>
                                  <input  name="p_amount" id="p_amount" onkeyup="count_days()" value="<?=$perday_amount?>" class="required digits" type="text"  />
                            </p>
						</div>
                        ...
                        <div class="_50">
							<p>
                                ...
                                <input id="amount"  name="amount" class="required digits" value="<?=$total_amount?>" type="text" value="" />
                            </p>
						</div>
