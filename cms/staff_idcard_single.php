...
<body id="top">
 ...
 <!--! end of #search-bar -->
     ...
     <?php 
		...
		<div id="main-content">
            ...
            <div class="block-border">
					...
					<form id="validate-form" class="block-content form" target="_blank" action="staff_idcard_single_prt.php" method="GET">
                    	<div class="_50">
                            <p>
                            <label for="required">Staff  No:</label>
						...
						<div class="block-actions">
                            ...
                            <input type="hidden" class="medium" name="type" value="Front" >
  ...
  <?php if(!$_GET['roll']){ include("staffauto.php"); ?>
