...
<div style="margin-left:32px;font-size:11px;">Driver ID :<b><?php echo $row['driver_id']; ?></b></div>
<?php $image=$row['photo']; if($image =='driver_male.png' || $image =='driver_female.png'){ }else{?> 
<div align="right" style="float:right; position:absolute;left:80%;
top:150px;"><img src="./img/driver/<?php echo $row['photo'];?>" alt="Driver photo" width="60" height="60"></div> <?php  } ?>
...
<tr>
<td width="40%">Driver Type</td>
<td width="50%">: <b><?php echo $row['d_type']; ?></b></td>
</tr>
<tr>
<td width="40%">Father / Husband Name :</td>
<td width="50%">: <b><?php echo $row['d_pname']; ?></b></td>
</tr>
<tr>
...
<tr>
<td width="40%">Residence Address </td>
<td width="50%">: <b><?php echo $row['address']; ?></b></td>
</tr>
<tr>
<td width="40%">City</td>
