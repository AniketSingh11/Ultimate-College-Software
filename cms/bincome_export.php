...
$rowCount = 3;
	 ...
	 $qry="SELECT * FROM bfinvoice WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $startdate. "' AND '" . $enddate. "' AND ay_id=$ayid AND c_status!='1' AND i_status='0'";
...
$objPHPExcel->getActiveSheet()->setTitle("Bus Fees Income Report");


// Redirect output to a client’s web browser (Excel5)
header('Content-Type: application/vnd.ms-excel');
header('Content-Disposition: attachment;filename="Bus_FeesIncomeReport-list.xls"');
