 ...
 if (isset($_POST['submit']))
{
	...
	$phone=$_POST['phone'];
		...
		$sql="INSERT INTO agency (a_name,a_address,a_person,a_mobile) VALUES
('$aname','$add','$cname','$phone')";

$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
    if($result){
        header("Location:agency_add.php?msg=succ");
    }
    exit;
}
 ?>
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Add New Agency</li>
			</ul>
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Add New Agency</h1><span></span>
					</div>
					<form id="validate-form" class="block-content form" action="" method="post">
						<div class="_50">
							<p>
                                <label for="textfield">Agency Name</label>
                                <input id="aname" name="aname" class="required" type="text" value="" />
                            </p>
						</div>
                        <div class="_50">
							<p>
                                <label for="textfield">Conatct Person Name</label>
                                <input id="cname" name="cname" class="required" type="text" value="" />
                            </p>
						</div>
                        <div class="_50">
							<p>
                                <label for="textfield">Address</label>
                                <textarea id="add" name="add" class="required" rows="5" ></textarea>
                            </p>
						</div>
                        <div class="_50">
							<p>
