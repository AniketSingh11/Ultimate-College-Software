 ...
 if (isset($_POST['submit']))
{
	...
	$sql="UPDATE student SET s_id='$sid' WHERE ss_id='$ssid'";
...
$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
	...
	if($sibling=='1'){
		$qry=mysql_query("UPDATE sibling SET s_id='$sid' WHERE p_id='$pid' AND ss_id=$ssid");
	}else{
		$qry=mysql_query("UPDATE parent SET s_id='$sid' WHERE p_id='$pid'");
	}

	}
	 header("Location:admission_allocat.php?bid=$bid&msg=succ");
	 exit;	
}
 ?>
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li><a href="admission_imp.php" title="Admission" > Student Admission import</a></li>    
				<li class="no-hover">Student Class Allocat <?php echo "( ".$board['b_name']." )";?></li>                
			</ul>
		...
		<div id="main-content">
            ...
            <a href="admission_imp.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
            <div class="grid_12">
            <?php $msg=$_GET['msg'];
			if($msg=="succ"){?>			
...
$().ready(function() {		
    ...
    function showCategory(str) {
		...
		$.get("allocation_calc1.php",{value:str, bid:<?php echo $bid;?>, ayid:<?php echo $acyear;?>},function(data){
			$( "#test" ).html(data);
        });
