...
function addReglement( $mode )
{
    ...
    $this->SetFont( "Arial", "B", 10);
    $this->Cell(10,4, "Bus Route", 0, 0, "C");
...
function addEcheance( $date )
{
    ...
    $this->SetXY( $r1 + ($r2 - $r1)/2 - 5 , $y1+1 );
    $this->SetFont( "Arial", "B", 10);
    $this->Cell(10,4, "Bus Number", 0, 0, "C");
    $this->SetXY( $r1 + ($r2-$r1)/2 - 5 , $y1 + 5 );
    $this->SetFont( "Arial", "", 10);
    $this->Cell(10,5,$date, 0,0, "C");
}

function addEcheance1( $date ,$y)
{
    $r1  = 40;
    $r2  = $r1 + 100;
    $y1  = $y+10;
...
function addCadreTVAs()
{
  ...
  /*  $this->RoundedRect($r1, $y1, ($r2 - $r1), ($y2-$y1), 2.5, 'D');
   ...
   // $this->Line( $r1+91, $y1, $r1+91, $y2);  // avant TOTAUX
    $this->SetXY( $r1+9, $y1);
    $this->Cell(10,4, "Expenses");
    $this->SetX( $r1+29 );
    $this->Cell(10,4, "Income");
    $this->SetX( $r1+48 );
    $this->Cell(10,4, "Amount");
    $this->SetX( $r1+63 );
...
function addCadreEurosFrancs($x,$y,$z,$start)
{
    $r1  = $this->w - 70;
    $r2  = $r1 + 60;
    $y1  = $start;
   ...
   // $this->Line( $r1+38, $y1, $r2, $y1+4); // Sous Euros & Francs
   // $this->Line( $r1+38,  $y1, $r1+38, $y2); // Entre Euros & Francs
    $this->SetFont( "Arial", "B", 8);
    $this->SetXY( $r1+22, $y1 );
    $this->Cell(15,4, "Amount", 0, 0, "C");
    $this->SetFont( "Arial", "", 8);
    // $this->SetXY( $r1+42, $y1 );
    //  $this->Cell(15,4, "FRANCS", 0, 0, "C");
     $this->SetFont( "Arial", "B", 6);
    $this->SetXY( $r1, $y1+5 );
    $this->Cell(20,4, "TOTAL INCOME", 0, 0, "C");
    $this->SetFont( "Arial", "B", 8);
    $this->Cell(0,4,"RS. $x",2);
    $this->SetXY( $r1, $y1+10 );
    $this->SetFont( "Arial", "B", 6);
    $this->Cell(20,4, "TOTAL EXPENSES", 0, 0, "C");
    $this->SetFont( "Arial", "B", 8);
    $this->Cell(20,4,"RS. $y",2);
 
    $this->SetXY( $r1, $y1+15 );
    $this->SetFont( "Arial", "B", 6);
    $this->Cell(20,4, "TOTAL AMOUNT", 0, 0, "C");
    $this->SetFont( "Arial", "B", 8);
    $this->Cell(0,4,"RS. $z",2);
}
