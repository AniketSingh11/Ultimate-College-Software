					...
					if($rid){							 
							...
							$sdid=$class['sd_id'];
								...
								$driver1=mysql_fetch_array($driverlist1);
								  ?>
			<div class="grid_12">
				<h1><?php  echo $class['r_name'];?> Route Master - Bus Fees Rate</h1>
                <a href="bus_fees_new.php?rid=<?php echo $rid;?>" title="add" style="margin-left:10px;"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> Add / Edit</button></a>
				...
				$count1 = str_pad($count, 2, '0', STR_PAD_LEFT);
					...
					?>
                                ...
                                <button class="btn btn-small btn-success" >Active</button><?php }else{?><button class="btn btn-small btn-gray" >Inactive</button> <?php } ?>
								 ...
								 <td width="40px"><a href="busfeesrate_edit.php?bfid=<?php echo $busfees['bf_id'];?>&rid=<?php echo $rid;?>" title="Edit"><img src="./img/edit.png" alt="edit"></a> <a href="busfeesrate_delete.php?bfid=<?php echo $busfees['bf_id']; ?>&rid=<?php echo $rid; ?>" class="delete" title="delete" onClick="return confirm('are you sure you wish to delete this record');"><img src="./img/del.png" alt="delete"></a></td>
								</tr> 
                                 <?php 
						}
							$count++;
