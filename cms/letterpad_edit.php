 ...
 if (isset($_POST['submit']))
{
	 ...
	 $lid=addslashes(trim($_POST['lid']));
	 
	  
	 
		$qry=mysql_query("UPDATE letter_pad SET title='$title',description='$descript' WHERE l_id='$lid'") or die(mysql_error());
    if($qry){
         header("Location:letterpad_edit.php?l_id=$lid&msg=succ");
    }
    exit;
}
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Edit Letterhead</li>
			</ul>
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Edit Letterhead</h1><span></span>
					</div>
                    <?php 
							$lid=$_GET['l_id'];
					...
					<form id="validate-form" class="block-content form" action="" method="post">
						 <div class="_100">
							<p>
                                ...
                                <input id="textfield" name="title" value="<?=$titles?>" class="required" type="text" />
                            </p>
						</div>
                         <div class="_100">
							<p><label for="textarea"> Description: <span class="error">*</span></label><textarea id="textarea" name="descript"   rows="5" cols="40"><?=$description?></textarea></p>
						</div>
						...
						<div class="block-actions">
							...
							<ul class="actions-left">
                            <input type="hidden" class="medium" name="lid" value="<?php echo $lid;?>" > 
