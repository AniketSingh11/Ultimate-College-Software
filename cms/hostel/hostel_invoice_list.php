 ...
 <div id="wrapper">
     ...
     <div id="content">		
		 ...
		 <div id="content-header">
			 <h1>Hostel Invoice  Details </h1><?php if($filter){?><span style="float:right; margin-right:30px;"><b>Filter by : </b> <?php echo $cat_name;?></span><?php } ?>
		 </div>  <!-- #content-header -->	
						 ...
						 <div class="portlet-header">
							...
							<div class="btn-group" style="float:right;">
							  ...
							  <ul class="dropdown-menu" role="menu">
                                <li <?php if(!$filter){ echo 'class="active"';}?>><a href="hostel_invoice_list.php">Over All</a></li>
                            <?php 
									...
									?>
										...
										<li   <?php if($_GET["filt"]==$row["h_id"]){?>class="active" <?php }?> ><a href="hostel_invoice_list.php?filt=<?=$row["h_id"]?>"><?=stripslashes($row["h_name"]);?></a></li>
									 <?php } ?>
