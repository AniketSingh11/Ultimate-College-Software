 ...
 $query="insert into hms_studentcash_amount(hsr_id,admission_number,amount,r_ay_id,date)
	    ...
	    header("location: regroom_student_details.php?msg=succ&ss_id=$student_id");
      }else{
           
           header("location: regroom_student_details.php?msg=err&err_msg=$err_msg");
 ...
 <div id="wrapper">
     ...
     <div id="content">	
		 <div id="content-header">
			 <h1> Apply Register Room  <a onclick="history.go(-1)"><button type="button" class="btn btn-success"> <i class="fa fa-angle-double-left"></i> Back</button></a></h1>
		 </div>  <!-- #content-header -->	
...
<div class="col-sm-12">
				            	...
				            	<div class="form-group">
									...
									<select id="student" name="student" data-required="true" class="form-control" style="width:50%">
                                        ...
                                        <?php 
										$emp_query="select * from student where  ay_id='$acyear' order by firstname asc";
										$emp_result=mysql_query($emp_query);
										while($emp_display=mysql_fetch_array($emp_result))
										{
...
alert(v);
 ...
 function change_function1(){ 
	    ...
	    var cid=document.getElementById('cid').value;
		 window.location.href = 'regroom_student_details.php?cid='+cid;
