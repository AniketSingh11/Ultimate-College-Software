 ...
 <div id="wrapper">
     ...
     <div id="content">		
		 ...
		 <div id="content-header">
			 <h1>Staff Borrow Book Details </h1><?php if($filter){?><span style="float:right; margin-right:30px;"><b>Filter by : </b> <?php echo $cat_name;?></span><?php } ?>
		 </div>  <!-- #content-header -->	
				   ...
				   <div class="col-md-12">
					 <div class="portlet">
                        ...
                        <label for="select">Board :</label>
							 ...
							 <h3>
							Staff Borrow Book  Details List 
							 </h3>
                             <a href="staff_book_details.php" title="Add"><button type="button" class="btn btn-warning">Add staff Book</button></a>
...
function change_function1(){ 
    ...
    var bid =document.getElementById('bid').value;
	 window.location.href = 'staff_borrow_bookdetails_list.php?bid='+bid;
