...
?>		 <div class="row">
		...
		?>                             
                                ...
                                <button class="btn btn-small btn-success" >Active</button><?php }else{?><button class="btn btn-small btn-gray" >Inactive</button> <?php } ?>
                                             ...
                                             <td><a title="edit" href="leave_type_edit.php?id=<?php echo $lt_id; ?>"><img src="img/layout/edit.png"/></a><?php if($others!=1){?> <a title="delete" href="leave_type_delete.php?id=<?php echo $lt_id; ?>" onClick="return confirm('are you sure you wish to delete this record');"><img src="img/layout/delete.png"/></a> <?php } ?> </td>
										 </tr>
		<?php         
		$emp_count++;		
        }        
