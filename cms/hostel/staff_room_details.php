 ...
 <div id="wrapper">
     ...
     <div id="content">		
		 ...
		 <div id="content-header">
			 <h1>staff Room Details </h1><?php if($filter){?><span style="float:right; margin-right:30px;"><b>Filter by : </b> <?php echo $cat_name;?></span><?php } ?>
		 </div>  <!-- #content-header -->	
				 ...
				 <div class="col-md-12">
					 <div class="portlet">
						 <div class="portlet-header">
							 <h3>
								staff Room  Details List 
							 </h3>
                             <a href="regroom_staff_details.php" title="Add Employee"><button type="button" class="btn btn-warning">Add staff</button></a>
							<div class="btn-group" style="float:right;">
							  <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown">
							    Filter by Category Type <span class="caret"></span>
							  </button>
							  <ul class="dropdown-menu" role="menu">
                                <li <?php if(!$filter){ echo 'class="active"';}?>><a href="staff_room_details.php">Over All</a></li>
                            <?php 
									...
									?>
										...
										<li   <?php if($_GET["filt"]==$row["h_id"]){?>class="active" <?php }?> ><a href="staff_room_details.php?filt=<?=$row["h_id"]?>"><?=stripslashes($row["h_name"]);?></a></li>
									 <?php } ?>
                             ...
                             <table 
								...
								data-paginate="true">
									...
									<tbody>
										...
										if($filter!=""){
											$emp_query="select * from  hms_staff_room  where category='$filter' and  status='0' order by date_time desc";
										}else{
											$emp_query="select * from hms_staff_room  where status='0' order by date_time desc";
										}
