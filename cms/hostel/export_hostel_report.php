...
$result = mysql_query("SELECT * FROM hms_student_room  where $type='$id' and status='0' order by category desc") or die(mysql_error());
...
$reader->setReadDataOnly(false);
     ...
     /*   for ($i = 1; $i < mysql_num_fields($result); $i++)
        ...
        */
        ...
        $objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, "Join Date");;$column++;
        ...
        */
        ...
        $objPHPExcel->getActiveSheet()->getColumnDimension('F')->setWidth(20);cellFont("F1","Calibri");
        $objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, "Join Date");cellFont("F1","Calibri");$column++;
        ...
        header('Content-Disposition: attachment;filename="Hostel_report-list.xls"');
