 ...
 <div id="wrapper">
     ...
     <div id="content">	
		 <div id="content-header">
			 <h1>Overall Room availability <a  onclick="history.go(-1);"><button type="button" class="btn btn-success"> <i class="fa fa-angle-double-left"></i> Back</button></a></h1>
		 </div>  <!-- #content-header -->	
...
<?php   if(isset($_GET['bid']))
            ...
            ?>
				 <div class="portlet-header">
					 ...
					 <h3>						 
						Overall Hostel Room availability
					 </h3>			 
				 </div>  <!-- /.portlet-header -->			
                             ...
                             <table 
								...
								data-paginate="true">
									<thead>
										<tr>
											<th data-sortable="true" width="5%">S.No</th>
											 ...
											 <th data-filterable="true" data-sortable="true">Cart availability</th>
									...
									<tbody>
										...
										$emp_query="select * from hms_student_room  where category='$s_id' and status='0' order by floor desc";
...
$emp_count++;
											...
											$emp_query="select * from hms_staff_room  where category='$s_id' and status='0' order by floor desc";
