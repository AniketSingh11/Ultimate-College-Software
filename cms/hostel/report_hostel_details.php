 ...
 <div id="wrapper">
     ...
     <div id="content">	
		 <div id="content-header">
			 <h1>Overall Hostel Report <a  onclick="history.go(-1);"><button type="button" class="btn btn-success"> <i class="fa fa-angle-double-left"></i> Back</button></a></h1>
		 </div>  <!-- #content-header -->	
...
<?php if($s_id){ ?>  
                 <center>   <a href="export_hostel_report.php?type=category&id=<?=$s_id?>">    <button type="button" class="btn btn-warning">   Download Excel</button></a></center>
                             ...
                             <table 
								...
								data-paginate="true">
									...
									<tbody>
										...
										$emp_query="select * from hms_student_room  where category='$s_id' and status='0' order by category desc";
...
$emp_count++;
											...
											$emp_query="select * from hms_staff_room  where category='$s_id' and status='0' order by category desc";
...
<?php         
 ...
 if(selbook>0){
		  window.location="report_hostel_details.php?hid="+selbook;
	  }	
}
