 ...
 <div id="wrapper">
     ...
     <div id="content">		
		 ...
		 <div id="content-header">
			 <h1>staff Vacate Room Details </h1><?php if($filter){?><span style="float:right; margin-right:30px;"><b>Filter by : </b> <?php echo $cat_name;?></span><?php } ?>
		 </div>  <!-- #content-header -->	
...
<div class="row">
				 <div class="col-md-12">
					 <div class="portlet">
						 <div class="portlet-header">
							 <h3>
								staff Vacate Room  Details List 
							 </h3>
							...
							<div class="btn-group" style="float:right;">
							  ...
							  <ul class="dropdown-menu" role="menu">
                                <li <?php if(!$filter){ echo 'class="active"';}?>><a href="staff_vacateroom_details.php">Over All</a></li>
                            <?php 
									...
									?>
										...
										<li   <?php if($_GET["filt"]==$row["h_id"]){?>class="active" <?php }?> ><a href="staff_vacateroom_details.php?filt=<?=$row["h_id"]?>"><?=stripslashes($row["h_name"]);?></a></li>
									 <?php } ?>
                             ...
                             <table 
								...
								data-paginate="true">
									...
									<tbody>
										...
										if($filter!=""){
											$emp_query="select * from  hms_staff_room  where category='$filter' and  status='1' order by date_time desc";
										}else{
											$emp_query="select * from hms_staff_room  where status='1' order by date_time desc";
										}
		...
		?>                             
										 <tr>
                                             ...
                                             <td><?php echo $staff_number."-".$firstname; ?> </td>
                                            
                                          
                                            <td><?php echo date("d/m/Y",strtotime($vacate_date));?></td>
                                             
                                             								 
					 <td><a title="View" href="staff_vacateroomdetails_view.php?id=<?php echo $hsr_id; ?>"><img src="img/layout/view.png"/></a> </td>
										 </tr>
		<?php 
