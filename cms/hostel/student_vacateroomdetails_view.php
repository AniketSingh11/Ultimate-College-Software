 ...
 <div id="wrapper">
     ...
     <div id="content">	
		 <div id="content-header">
			 <h1>View Vacate Student Room Details  <a onclick="history.go(-1);"><button type="button" class="btn btn-success"> <i class="fa fa-angle-double-left"></i> Back</button></a></h1>
		 </div>  <!-- #content-header -->	
...
<?php } ?>
				 <div class="portlet-header">			
					 <h3> View Vacate Student Room Details </h3>			
				 </div>  <!-- /.portlet-header -->	
                 <?php
