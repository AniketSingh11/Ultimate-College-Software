 ...
 <div id="wrapper">
     ...
     <div id="content">	
		 <div id="content-header">
			 <h1> Staff Book Report <a  onclick="history.go(-1);"><button type="button" class="btn btn-success"> <i class="fa fa-angle-double-left"></i> Back</button></a></h1>
		 </div>  <!-- #content-header -->	
...
<?php if($s_id){ ?>  
                 <center>     <a href="export_staffbook_report.php?ay_id=<?=$acyear?>&s_id=<?=$s_id?>">    <button type="button" class="btn btn-warning">   Download Excel</button></a>    <a title="view" href="#info-dialog1<?php echo $s_id;?>" data-toggle="modal">    <button type="button" class="btn btn-warning">   Staff profile</button></a></center>
...
<?php         
 ...
 function change_function1(){ 
	    ...
	    var staff = parseFloat(document.getElementById('staff').value);
		 ...
		 window.location.href = "staff_reportbook_details.php?sid="+staff+'&bid='+bid;
 ...
 function select_employee() { 
	 var staff = parseFloat(document.getElementById('staff').value);
	  ...
	  if(staff>0){
		  window.location="staff_reportbook_details.php?sid="+staff;
	  }	
}
