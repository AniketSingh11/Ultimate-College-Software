 ...
 <!--! end of #search-bar --> 		
    ...
    <?php 
		...
		<div id="main-content">
            ...
            <a href="board_select_std_fincome.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
			...
			<div class="grid_12">
				...
				<a href="export_studentwisereport.php?cid=<?=$cid?>&sid=<?=$sid?>&ay_id=<?=$acyear?>"><button class="btn btn-small btn-success"><img src="img/icons/packs/fugue/16x16/table--plus.png"> Download Excel</button></a>
            ...
            <div class="grid_12">
			  ...
			  while($row=mysql_fetch_array($qry))
        		{?>
                                ...
                                <td class="view"><center><a href="student_feesinvoice.php?ssid=<?php echo $row['ss_id'];?>&bid=<?php echo $bid;?>"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png">View</button></a></center></td>
...
// Code that uses other library's $ can follow here.
  ...
  <script type="text/javascript">
	...
	function change_function() { 
	 ...
	 window.location.href = 'studentwise_income_report.php?bid='+cid;	  
	} 
  </script>
  <!-- end scripts-->
