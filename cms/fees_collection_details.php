...
if($_POST){
   ...
   $sql="INSERT INTO feescollection (sdate,edate,amount_total,amount_given,fee_by,cashier,ay_id,status) VALUES ('$sdate','$edate','$total','$given','$user','$cashier','$acyear','$status')";
   ...
   foreach ($income as $tmp) {
     ...
     header("Location:fees_collection.php?msg=succ");
} 
?>
                    ...
                    if ($sdate && $edate) {
                        ...
                        <div class="grid_12">
                            ...
                            <br>
                            <a target="_blank" href="fees_collection_prt.php?sdate=<?= $sdate?>&edate=<?= $edate?>&cashier=<?= $cashier?>&id=<?= $id?>"><input type="button" value="Print Income & Expense Ledger" name="Print" class="btn btn-green" style="width:250px" > </a>
