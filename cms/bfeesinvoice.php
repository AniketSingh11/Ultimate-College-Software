    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover">Bus Fees Invoice</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
                ...
                <a href="busfeesbilling.php?bid=<?php echo $bid;?>" title="add"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> Add New</button></a>
				 <a href="busfeesbilling_print.php?bid=<?php echo $bid;?>&status=<?php  if($_GET['status']=="All")  { echo "All"; } else if($_GET['status']=="Paid"){ echo "Paid"; } else { echo "Rejected";}?>" title="print" target="_blank"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png">Print</button></a>
                ...
                <div class="alert success"><span class="hide">x</span>Your Record Successfully Deleted !!!</div>
                 <?php } 
				 $qry1=mysql_query("SELECT * FROM bfinvoice WHERE bid=$bid AND ay_id=$acyear");
							$total=0;
				...
				?>
                                ...
                                <td>
                                	<?php if($row['i_status']==1)
                                	  echo '<a href="#"><button class="btn btn-danger btn-small">Rejected</button></a>';
                                	  else
                                	  	echo '<a href="#"><button class="btn btn-primary btn-small">Paid</button></a>';
                                	?>
                                </td>
								<td class="view"><center><a href="bfeesinvoice_detail.php?bfiid=<?php echo $row['bfi_id'];?>&bid=<?php echo $bid;?>" title="Edit"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> View</button></a></center></td>
								 <?php 
							$count++;
							} ?>                               																
							</tbody>
...
// Code that uses other library's $ can follow here.
  ...
  <script type="text/javascript">
    ...
    window.location.href = 'bfeesinvoice.php?bid='+cid+'&status='+val;   
  }
