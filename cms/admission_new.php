...
('$emapData[4]','$emapData[19]','$emapData[19]','1','$todaydate','$cid','$sid','$emapData[5]','$acyear','$lastid','$emapData[1]','$bid')";

$result1 = mysql_query($sql1) or die("Could not insert data into DB: " . mysql_error());

				if(! $result || !$result1 )
				{	
						header("Location:admission_new.php?bid=$bid&msg=eonfile");
						exit;
				}
				$sql1=mysql_query("UPDATE admin_no_count SET count='$adminno2' WHERE id='1'");		
				header("Location:admission_new.php?bid=$bid&msg=succ");
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><a href="admission_imp.php" title="Admission">Admission</a></li>
				<li class="no-hover">Student Admission import <?php echo "( ".$board['b_name']." )";?></li>  
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Student Admission import <?php echo "( ".$board['b_name']." )";?></h1>                
			<a href="admission_imp.php?bid=<?php echo $bid;?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
			</div>
            <div class="grid_12">
            <?php $msg=$_GET['msg'];
			if($msg=="succ"){?>			
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Import Student Datas <?php echo "( ".$board['b_name']." )";?></h1><span></span>
					</div>
