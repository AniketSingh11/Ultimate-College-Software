    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover"><a href="income_category.php" title="Academic ex_catetory">Incomes Category list</a></li>
                <li class="no-hover"><?php  echo $class['in_category'];?> Incomes Details</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1><?php  echo $class['in_category'];?>  Incomes Details</h1>
                <a href="income_category.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
                <a href="income_new.php?incid=<?php echo $incid;?>" title="add" style="margin-left:10px;"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> Add New</button></a>
				<?php $msg=$_GET['msg'];
				if($msg=="dsucc"){?>
                <div class="alert success"><span class="hide">x</span>Your Record Successfully Deleted !!!</div>
                 <?php }
							$qry1=mysql_query("SELECT * FROM income WHERE inc_id=$incid");
							$total=0;
            	...
            	<div class="block-border">
					...
					<div class="block-content">
						<table id="table-example" class="table">
							...
							<tbody>
                            <?php 
							$qry=mysql_query("SELECT * FROM income WHERE inc_id=$incid ORDER BY in_id DESC");
							$count=1;
			  while($row=mysql_fetch_array($qry))
        		{?>
                                ...
                                <td><center>Rs. <?php echo number_format($row['amount'],2); ?></center></td>                               
                                 ...
                                 <a href="income_edit.php?inid=<?php echo $row['in_id'];?>&incid=<?php echo $incid;?>" title="Edit"><img src="./img/edit.png" alt="edit"></a> <a href="income_delete.php?inid=<?php echo $row['in_id']; ?>&incid=<?php echo $incid; ?>" class="delete" title="delete" onClick="return confirm('are you sure you wish to delete this record');"><img src="./img/del.png" alt="delete"></a>
                                 <a href="income_prt.php?inid=<?php echo $row['in_id'];?>" title="print" target="_blank"><img src="./img/print.png" alt="print"></a></td>
								</tr> 
                                <div id="info-dialog<?php echo $count;?>" title="<?php echo $class['in_category']; ?> Incomes Details" style="display: none;">
