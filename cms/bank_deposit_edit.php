 ...
 if (isset($_POST['submit']))
{
	...
	$sql="UPDATE bank_deposit SET date='$date',date_day='$date_day',date_month='$date_month',date_year='$date_year',account_no='$acc_no',b_name='$b_name',deposit_by='$deposit_by',amount='$amount',ay_id='$acyear' WHERE bc_id='$bcid'";
$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
    if($result){
		...
		$cashlist=mysql_query("SELECT * FROM cash WHERE id=1"); 
			  ...
			  $cashqry=mysql_query("UPDATE bank_account SET amount='$accountcash' WHERE ba_id=$baid");
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><a href="bank_deposit.php?baid=<?php echo $baid; ?>" title="bank deposit"><?php  echo $class['name']."-".$class['account_no'];?> Bank Deposit</a></li>
                <li class="no-hover">Edit <?php  echo $class['name']."-".$class['account_no'];?> Bank Deposit</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Edit <?php  echo $class['name']."-".$class['account_no'];?> Bank Deposit</h1>                
			<a href="bank_deposit.php?baid=<?php echo $baid; ?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Edit <?php  echo $class['name']."-".$class['account_no'];?> Bank Deposit</h1><span></span>
					</div>
					<form id="validate-form" class="block-content form" action="" method="post">
                    <div class="_25">
							<p>
                                <label for="textfield">Date <span class="error">*</span></label>
                                <input id="datepicker" name="date" class="required" type="text" value="<?php echo $class1['date'];?>" />
                            </p>
						</div>
                        <div class="_50">
							<p>
                        ...
                        <div class="_25">
							<p>
                                ...
                                <input id="deposit_by" name="deposit_by" class="required" type="text" value="<?php echo $class1['deposit_by'];?>" />
                            </p>
						</div>
                        <div class="_50">
							<p>
                                <label for="textfield">Amount <span class="error">*</span></label>
                                <input id="amount" name="amount" class="required" type="text" value="<?php echo $class1['amount'];?>"  max="<?=$currentcash+$class1['amount']?>"/>
                                <input name="oldamount" type="hidden" value="<?php echo $class1['amount'];?>" />
                            </p>
						</div>
						<div class="clear"></div>
