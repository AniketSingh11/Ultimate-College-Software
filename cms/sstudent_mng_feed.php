    ...
    <?php 
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover">Feedback Detail</li>                
			</ul>
		...
		<div id="main-content">
            ...
            <a href="sboard_select_class_feed.php?bid=<?php echo $bid; ?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
            <div class="grid_12">
            </div>
			<?php
							$cid=$_GET['cid'];
				...
				if($cid && $sid){
							...
							$sectionlist=mysql_query("SELECT * FROM section WHERE s_id=$sid"); 
								  ...
								  ?>
			<div class="grid_12">
				<h1><?php echo $class['c_name']."-".$section['s_name'];?> Feedback List</h1>                                  
			</div>
            <div class="grid_12">
			  ...
			  while($row=mysql_fetch_array($qry))
				...
				?>
                                ...
                                <?php $select_record2=mysql_query("SELECT * FROM feedback WHERE c_id=$cid AND s_id=$sid AND p_id=$pid AND ay_id=$acyear AND status='1' AND send='parent' AND st_id=$stid");						
								$unread=0;
					...
					{ $unread++;
                                ...
                                <td><center><?php echo $unread; ?></center></td>
                                 ...
                                 <center><a href="sstudent_mng_feedback.php?bid=<?php echo $bid; ?>&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>&ssid=<?php echo $ssid; ?>&pid=<?php echo $pid; ?>"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> View</button></a></center>
                                 </td>
								</tr> 
                                 <?php 
							$count++;
