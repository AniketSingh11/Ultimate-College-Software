    ...
    <?php 
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover">Students Progress Card</li>                
			</ul>
		...
		<div id="main-content">
            ...
            <a href="sboard_select_classrank.php?bid=<?php echo $bid; ?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
            <div class="grid_12">
            </div>
			<?php
							$cid=$_GET['cid'];
				...
				if($cid && $sid){
							...
							$sectionlist=mysql_query("SELECT * FROM section WHERE s_id=$sid"); 
								  ...
								  ?>
			<div class="grid_12">
				<h1><?php echo $class['c_name']."-".$section['s_name'];?> Student Progress Card</h1>                                  
			</div>
            <div class="grid_12">
			  ...
			  while($row=mysql_fetch_array($qry))
        		{?>
								...
								<td width="10%">
                                 ...
                                 <a href="srank_list_student.php?ssid=<?php echo $row['ss_id'];?>&cid=<?php echo $cid;?>&sid=<?php echo $sid;?>&bid=<?php echo $bid;?>" title="view"><button class="btn btn-small btn-success" > View </button></a>
                                 </td>
								</tr> 
                                                     <!-- Modal Box Content -->
