...
/********************** Books, Notes and Other Items ******************************************************/
    ...
    $objWorkSheet->setCellValue($column.$rowCount, 'Books, Notes & Other Items Fees');  $column++;
...
if ($bamountthisyear != 0) {
    ...
    $objWorkSheet->setCellValue($column . $rowCount, $count);
    $column++;
    $objWorkSheet->setCellValue($column . $rowCount, 'Bus Fees');
    $column++;
    $objWorkSheet->setCellValue($column . $rowCount, '-');
    $column++;
...
if ($pur_result['purchase_amt'] != 0) {
    ...
    $objWorkSheet->setCellValue($column . $rowCount, $count);
    $column++;
    $objWorkSheet->setCellValue($column . $rowCount, "INVENTORY PURCHASE");
    $column++;
...
if ($mat_result['material_amt'] != 0) {
    ...
    $objWorkSheet->setCellValue($column . $rowCount, $count);
    $column++;
    $objWorkSheet->setCellValue($column . $rowCount, "INVENTORY MATERIAL ISSUE");
    $column++;
    $objWorkSheet->setCellValue($column . $rowCount, '-');
    $column++;
