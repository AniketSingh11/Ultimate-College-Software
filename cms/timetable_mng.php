 ...
 <!--! end of #search-bar -->
    ...
    <?php 
		...
		<div id="main-content">
            ...
            <a href="board_select_table.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
            ...
            <div class="block-border">
					<div class="block-header">
						<h1>Select Standard and Section/Group For Class TimeTable</h1><span></span>
					</div>
                       ...
                       <table id="table-example" class="table">
							<thead>
								<tr style="color:#212121;">
									...
									<th>Staffwise Class TimeTable</th>
                                    <th>Action</th>
								</tr>
							</thead>
			  ...
			  while($row2=mysql_fetch_array($qry2))
        		{ ?>
								<tr class="gradeX">
									...
									<td width="25%"><center><a href="timetable_slideshow.php?sid=<?php echo $row2['s_id'];?>&cid=<?php echo $cid;?>&bid=<?php echo $bid;?>" target="_blank"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> View</button></a></center></td>
                                    <td class="action"><a href="javascript: void(0)"  onclick="popup('timetable_assign.php?sid=<?php echo $row2['s_id'];?>&cid=<?php echo $cid;?>&bid=<?php echo $bid;?>')" title="Edit"><img src="./img/edit.png" alt="edit"></a> <a href="timetable_prt.php?sid=<?php echo $row2['s_id'];?>&cid=<?php echo $cid;?>&bid=<?php echo $bid;?>" target="_blank" class="delete" title="view"><img src="./img/detail.png" alt="delete"></a></td>
								</tr>
                     <?php $count++; } ?> 
							</tbody>
						</table>
...
function change_function() { 
	 ...
	 window.location.href = 'timetable_mng.php?bid='+cid;	  
	} 
  </script>
  <!-- end scripts-->
