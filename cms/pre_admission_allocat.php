...
$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
    ...
    if($result){				
		$sql1=mysql_query("UPDATE pre_admission SET s_id='$sid' WHERE pa_id='$paid'");
    }
	}
	 header("Location:pre_admission_allocat.php?bid=$bid&msg=succ");
	 exit;	
}
 ?>
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><a href="pre_admission_allocation.php?bid=<?php echo $bid;?>" title="Admission Student List">Admission Student List</a></li>  
...
$().ready(function() {		
    ...
    function showCategory(str) {
		...
		$.get("allocation_calc.php",{value:str, bid:<?php echo $bid;?>, ayid:<?php echo $acyear;?>},function(data){
			$( "#test" ).html(data);
        });
