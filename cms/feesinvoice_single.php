    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Fees Invoice Details <?php echo "( ".$student['firstname']." ".$student['lastname']." )"; ?></li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Fees Invoice <?php echo "( ".$student['firstname']." ".$student['lastname']." )"; ?></h1>
            ...
            <div class="grid_12">
				<div class="block-border">
					...
					<div class="block-content">
						<table id="table-example" class="table">
							...
							$qry=mysql_query("SELECT * FROM finvoice WHERE c_id=$cid AND s_id=$sid AND ss_id=$ssid AND bid=$bid AND ay_id=$acyear and c_status!='1'");
							$count=1;
			  while($row=mysql_fetch_array($qry))
				...
				?>
								...
								<td class="view"><center><a href="feesinvoice_report_detail.php?fiid=<?php echo $row['fi_id'];?>&bid=<?php echo $bid;?>"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> View</button></a></center></td>
								 <?php 
							$count++;
							} ?>                               																
							</tbody>
