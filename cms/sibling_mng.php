    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Sibling Student's Parent list</li>                
			</ul>
		...
		<div id="main-content">
            ...
            <div class="grid_12">
				<h1>Sibling Student's Parent list</h1>
			</div>
            <div class="grid_12">
				<div class="block-border">
					...
					<div class="block-content">
						<table id="table-example" class="table">
							...
							<tbody>
                            <?php 
							$qry=mysql_query("SELECT * FROM parent WHERE sibling='1' AND ay_id=$acyear");
							$count=1;
			  while($row=mysql_fetch_array($qry))
        		{
					...
					$siblinglist=mysql_query("SELECT * FROM sibling WHERE p_id=$ssid and ay_id=$acyear");
							$nsibling=mysql_num_rows($siblinglist); 
								  $sibling=mysql_fetch_array($siblinglist);	   
					?>
								<tr class="gradeX">
                                ...
                                <td><center><?php echo $nsibling; ?></center></td>
								 <td width="100px;">
                                 <center><a href="sibling_student.php?pid=<?php echo $row['p_id'];?>"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> View</button></a></center>
                                <!-- <a href="javascript:void(0);" onclick="$('#info-dialog<?php //echo $count;?>').dialog({ modal: true });" title="Details"><img src="./img/detail.png" alt="edit"></a>-->
                                                     ...
                                                     <!-- Modal Box Content -->
			<div id="info-dialog<?php echo $count;?>" title="<?php echo $row['phone_number']; ?>, This Parent details" style="display: none;">
				<p>Parent / Guardian : <strong><?php echo $student['fathersname']; ?></strong>  </p>   
