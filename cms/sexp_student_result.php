    ...
    <?php 
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><a href="sboard_select_markexp.php" title="<?php echo $board['b_name'];?>"><?php echo $board['b_name'];?></a></li>
		...
		<div id="main-content">
			...
			<a href="sboard_select_markexp.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
            <div class="grid_12">
		 ...
		 ?>	
            ...
            <div class="grid_12">
			  ...
			  while($row=mysql_fetch_array($qry))
				...
				?>
							<li>
								<a href="sstudent_result_export.php?bid=<?php echo $row['b_id']; ?>&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>&eid=<?php echo $eid;?>&ayid=<?php echo $acyear;?>">
