    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover"><a href="feesinvoice_reject.php?bid=<?php echo $bid;?>" title="Fees Payment">Fees Paymant </a></li> 
		...
		<div id="main-content">
			...
			<div class="grid_12">
            <a href="feesinvoice_reject.php?bid=<?php echo $bid;?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
			  ...
			  while($row5=mysql_fetch_array($qry5))
        		{
					...
					if($fgid){?>
						...
						<tr>
							...
							<td class="sub_total">Rs. <?php echo $invoice['fi_total'];?></td>
						</tr>
						<tr class="total_bar">
							<td class="grand_total" colspan="3"></td>
							<td class="grand_total">Total:</td>
							<td class="grand_total">Rs. <?php echo $invoice['fi_total'];?></td>
						</tr>
                        <tr>
...
function clear_cart(){
	if(confirm('Are You Reject this Bill invoice, continue?')){
		...
		window.location.href='mfeesinvoice_reject_detail.php?fiid=<?=$ffi_id?>&del_succ=delete';
