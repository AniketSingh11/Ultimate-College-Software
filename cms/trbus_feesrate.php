    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Bus Fees Rate</li>
			</ul>
		...
		<div id="main-content">        		
            ...
            <div class="grid_12">
				<h1>Bus Fees Rate</h1>
                <a href="trbusfeesrate_new.php" title="add" style="margin-left:10px;"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> Add / Edit</button></a>
                <?php $msg=$_GET['msg'];
				if($msg=="dsucc"){?>
						...
						<table id="table-example" class="table">
							<thead>
								<tr>
                                    ...
                                    <th class="action"><center>Fees Type</center></th>
			  ...
			  while($row=mysql_fetch_array($qry))
				...
				$count1 = str_pad($count, 2, '0', STR_PAD_LEFT);
					...
					?>
                                ...
                                <td><center><?php if($busfees['sp_fees']){ echo "Rs.".number_format($busfees['sp_fees'],2);}?></center></td>
                                <td><center><?php if($busfees['sp_fees_onetime']){ echo "Rs.".number_format($busfees['sp_fees_onetime'],2); }?></center></td>
                                <td><center><?php if($busfees['one_time']){ echo "Rs.".number_format($busfees['one_time'],2); }?></center></td>
                                <td><center><?php echo $ftype['fty_name']; ?></center></td>
                                <td><center><?php if($busfees['status']=='1'){ ?>
                                <button class="btn btn-small btn-success" >Active</button><?php }else{?><button class="btn btn-small btn-gray" >Inactive</button> <?php } ?>
                                </center></td>
								 <td width="40px"><a href="trbusfeesrate_edit.php?bfid=<?php echo $busfees['bf_id'];?>" title="Edit"><img src="./img/edit.png" alt="edit"></a> <a href="trbusfeesrate_delete.php?bfid=<?php echo $busfees['bf_id']; ?>" class="delete" title="delete" onClick="return confirm('are you sure you wish to delete this record');"><img src="./img/del.png" alt="delete"></a></td>
								</tr> 
                                 <?php 
						}
							$count++;
