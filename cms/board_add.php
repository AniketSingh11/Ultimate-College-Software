 ...
 if (isset($_POST['submit']))
{
	...
	$medium=$_POST['medium'];
		...
		$sql="INSERT INTO board (b_name,s_code,medium) VALUES
('$bname','$s_code','$medium')";

$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
    if($result){
        header("Location:board_add.php?msg=succ");
    }
    exit;
}
 ?>
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Add New Board</li>
			</ul>
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Add New Board</h1><span></span>
					</div>
					<form id="validate-form" class="block-content form" action="" method="post">
						<div class="_100">
							<p>
                                <label for="textfield">Board Name <span class="error">*</span></label>
                                <input id="textfield" name="bname" class="required" type="text" value="" />
                            </p>
						</div>
                        <div class="_100">
							<p>
                                <label for="textfield">School Code</label>
                                <input id="textfield" name="s_code" type="text" value="" />
                            </p>
						</div>
                        <div class="_100">
							<p>
                                <label for="textfield">Medium <span class="error">*</span></label>
                                <input id="textfield" name="medium" class="required" type="text" value="" />
                            </p>
						</div>
						<div class="clear"></div>
