...
{	
	...
	$qry1=mysql_query("select * from tc_xi_kg where ay_id='$acyear' and a_no='$ano' and b_id='$bid' ");
 ...
 <!--! end of #search-bar -->
    ...
    <div id="main" role="main">    				
		...
		<div id="main-content">
            ...
            <?php }
			 if($_GET['roll']){ ?>
            <a href="tc_xi_single_kg.php?bid=<?php echo $bid;?>"><button class="btn btn-small btn-warning" ><img src="img/icons/packs/fugue/16x16/block--arrow.png"> Create Another One</button></a> <?php } ?>
			</div>
            <?php if(!$_GET['roll']){ ?>
            <div class="grid_12">
            ...
            <?php } if($_GET['roll']){ 
					...
					$studentlist=mysql_query("SELECT * FROM student WHERE admission_number LIKE '$rollno' AND ay_id=$ayid"); 
							...
							$sectionlist=mysql_query("SELECT * FROM section WHERE s_id=$sid"); 
								  ...
								  $tcnolist=mysql_query("SELECT * FROM tc_no where name='KG'"); 
...
?>
						...
						<div class="_100">
							...
							?>
                                ...
                                <input id="textfield" name="doandclass" class="required" type="text" value="<?php echo $student['doa'];?>" />
                            </p>
						 </div>
  ...
  <?php if(!$_GET['roll']){ include("auto3.php"); ?>
...
window.location.href='tc_xi_single_kg.php?bid=<?=$bid?>&ayid='+ayid;
