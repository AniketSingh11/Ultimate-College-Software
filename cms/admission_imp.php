    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><a href="board_select_admin1.php" title="<?php echo $board['b_name'];?>"><?php echo $board['b_name'];?></a></li>
                <li class="no-hover"><?php if($cid){ echo $class['c_name']." - "; }?>Import New Student List</li>                
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1><?php if($cid){ echo $class['c_name']." - "; }?>Import New Student List</h1>
                <a href="board_select_admin1.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
                <a href="admission_new.php?bid=<?php echo $bid;?>" title="add"  style="margin:0px 0 0 10px;"><button class="btn btn-orange btn-small "><img src="img/icons/packs/fugue/16x16/user--plus.png">Import student</button></a>
                <a href="admission_allocat.php?bid=<?php echo $bid;?>" title="add"  style="margin:0px 0 0 10px;"><button class="btn btn-orange btn-small "><img src="img/icons/packs/fugue/16x16/user--plus.png">Student Class Allocat</button></a>
				...
				<div class="block-border" id="tab-panel-2">
					...
					<div class="block-content tab-container">
							...
							if($cid){
							 ...
							 $qry .=" AND s_id='0' ORDER BY firstname ASC";
...
function change_function() { 
	 ...
	 if(cid != 'all'){
	  window.location.href = 'admission_imp.php?cid='+cid+'&bid=<?php echo $bid;?>';	  
	 } else {
	 window.location.href = 'admission_imp.php?bid=<?php echo $bid;?>';	  
	 }
	}
	function change_function1() { 
     var bid =document.getElementById('bid').value;
	 window.location.href = 'admission_imp.php?bid='+bid;	  
	}  
	</script>
