 ...
 <!--! end of #search-bar -->
    ...
    <?php 
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><a href="board_select_attexp.php" title="<?php echo $board['b_name'];?>"><?php echo $board['b_name'];?></a></li>
				<li class="no-hover">Students Attendance Report</li>                
			</ul>
		...
		<div id="main-content">
            ...
            <div class="block-border">
					...
					<form id="validate-form" class="block-content form" action="student_att_export.php" method="POST">
						<div class="_50">
							<p>
  ...
  <script type="text/javascript">
	...
	function change_function() { 
	 ...
	 window.location.href = 'exp_student_att.php?bid='+cid;	  
	} 
  </script>
  <!-- end scripts-->
