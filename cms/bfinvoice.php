    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover"><a href="busfeesbilling.php?bid=<?php echo $bid;?>" title="Bus Fees Payment">Bus Fees Paymant </a></li> 
                <li>Bus Fees Invoice </li>
			</ul>
		...
		<div id="main-content">
			...
			?>
				<h1>Bus Fees Invoice <?php if($i_status==1){ echo "<span style='color: #D75334'>( Rejected Bill )</span>";}?></h1>
			  ...
			  //while($row5=mysql_fetch_array($qry5))
                ...
                <input type="submit" value="Print Invoice" name="Print" onClick="window.open('bfinvoice_prt.php?bfiid=<?php echo $ffi_id; ?>')"  class="btn btn-green" style="width:120px">&nbsp;&nbsp;
                <?php if($i_status!=1){?>
...
function clear_cart(){
	if(confirm('Are You Reject this Bill invoice, continue?')){
		...
		window.location.href='bfinvoice.php?bfiid=<?=$ffi_id?>&del_succ=delete';
