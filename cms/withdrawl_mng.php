    ...
    <div id="main" role="main">
		...
		<div id="main-content">        		
			...
			<div class="grid_12">
                ...
                <a href="withdrawl_mng_new.php?baid=<?php echo $baid;?>" title="add" style="margin-left:10px;"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> Add New</button></a>
				...
				<?php $qry1 ="SELECT * FROM bank_withdrawl";
							if($baid){
				  ...
				  while($row=mysql_fetch_array($qry))
					...
					$baid1=$row['ba_id'];
								...
								<tr class="gradeX">
                                    ...
                                    <td><center><?php echo $row['cheque_no']; ?></center></td>
                                    ...
                                    <td class="action">
                                     ...
                                     <?php if($row['type']=='0'){ ?>
                                     <a href="withdrawl_mng_edit.php?bcid=<?php echo $row['bc_id'];?>&baid=<?php echo $baid;?>" title="Edit"><img src="./img/edit.png" alt="edit"></a> <a href="withdrawl_mng_delete.php?bcid=<?php echo $row['bc_id']; ?>&baid=<?php echo $baid; ?>" class="delete" title="delete" onClick="return confirm('are you sure you wish to delete this record');"><img src="./img/del.png" alt="delete"></a>
                                     <?php } ?>
                                     </td>
								</tr> 
...
// Code that uses other library's $ can follow here.
  ...
  <script type="text/javascript">
	$().ready(function() {
	 ...
	 window.location.href = 'withdrawl_mng.php?baid='+cid;	  
	} 
  </script>
  <!-- end scripts-->
