    ...
    <div id="main" role="main">
		...
		<div id="main-content">
            ...
            <div class="grid_12">
                ...
                <a href="tc_xi_single_kg.php?bid=<?php echo $bid;?>" title="add" style="margin:0px 0 0 10px;"><button class="btn btn-orange btn-small "><img src="img/icons/packs/fugue/16x16/user--plus.png"> Add Single</button></a>
				<?php $msg=$_GET['msg'];
				if($msg=="dsucc"){?>
      ...
      <div class="_25" style="float:left">
            ...
            <div class="grid_12">
              ...
              if($_GET['payment']=='All'){
							   $qry=mysql_query("SELECT * FROM tc_xi_kg WHERE ay_id=$acyear AND b_id=$bid order by tno desc");
              }
               else{
                $pay=$_GET['payment'];
                $qry=mysql_query("SELECT * FROM tc_xi_kg WHERE ay_id=$acyear AND b_id=$bid and status='$pay' order by tno desc");
              }
            } else {
                $qry=mysql_query("SELECT * FROM tc_xi_kg WHERE ay_id=$acyear AND b_id=$bid order by tno desc");
            } 
			  ...
			  while($row=mysql_fetch_array($qry))
				...
				?>
                                ...
                                <td><center><?php echo $row['dobfigure']; ?></center></td>
								 <td class="action">
                                <a href="tc_amount_kg.php?id=<?php echo $row['id'];?>" title="payment" target="_blank"><img src="./img/pay.png" alt="payment"></a>
                                 <a href="tc_xi_edit_kg.php?tcid=<?php echo $row['id'];?>&bid=<?php echo $bid;?>" title="Edit"><img src="./img/edit.png" alt="edit"></a>
                                 <a href="tc_xi_delete_kg.php?tcid=<?php echo $row['id'];?>&bid=<?php echo $bid;?>" class="delete" title="delete" onClick="return confirm('are you sure you wish to delete this record');"><img src="./img/del.png" alt="delete"></a>
                                 <a href="tc_kg.php?tcid=<?php echo $row['id'];?>" title="print" target="_blank"><img src="./img/print.png" alt="print"></a>
                                 </td>
								</tr>             
                                 <?php 
							$count++;
...
// Code that uses other library's $ can follow here.
  ...
  function redirect(val){
    window.location.href = "tc_xi_kg.php?bid=<?= $bid?>&payment="+val;   
  }
  </script>
