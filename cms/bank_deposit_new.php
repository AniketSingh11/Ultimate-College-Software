 ...
 if (isset($_POST['submit']))
{
	...
	$sql="INSERT INTO bank_deposit (date,date_day,date_month,date_year,account_no,b_name,deposit_by,amount,ba_id,ay_id) VALUES
('$date','$date_day','$date_month','$date_year','$acc_no','$b_name','$deposit_by','$amount','$baid','$acyear')";
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Add New <?php  echo $class['name']."-".$class['account_no'];?> Bank Deposit</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Add New <?php  echo $class['name']."-".$class['account_no'];?> Bank Deposit</h1>                
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Add New <?php  echo $class['name']."-".$class['account_no'];?> Bank Deposit</h1><span></span>
					</div>
                    ...
                    <div class="_25">
                        ...
                        <div class="_25">
							<p>
                                ...
                                <input id="deposit_by" name="deposit_by" class="required" type="text" value="" />
                            </p>
						</div>
                        <div class="_50">
							<p>
                                <label for="textfield">Amount <span class="error">*</span></label>
                                <input id="amount" name="amount" class="required" type="text" value="" max="<?=$currentcash?>" />
                            </p>
						</div>
						<div class="clear"></div>
