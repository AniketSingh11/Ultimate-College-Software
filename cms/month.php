    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><?php  echo $class['y_name'];?> Month List</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1><?php  echo $class['c_name'];?>  Month List</h1>
            ...
            <div class="grid_12">
				...
				$monthno=date("m");
				$qry=mysql_query("SELECT * FROM month WHERE ay_id=$ayid");
				$mcount=1;
				$count=1;
				while($row=mysql_fetch_array($qry))
				{
					$mno=$row['m_no'];					
				?>
					<li id="recordsArray" ><img src="img/icons/packs/fugue/24x24/calendar-month.png"> &nbsp;&nbsp; &nbsp;<?php echo $count." - ".$row['m_name']; ?> <?php if($mcount==1){?> &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<img src="img/icons/packs/fugue/24x24/tick.png"><?php } ?> </li>
				<?php $count++; 
				if($mno==$monthno && $row2['ay_id']==$ayid){
						$mcount=0;
					} } ?>
			</ul>
            <?php if($count==1){?>
