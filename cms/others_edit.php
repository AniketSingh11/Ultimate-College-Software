...
$sql="UPDATE others SET fname='$fname',lname='$lname',s_pname='$p_name',dob='$dob',day='$date_day',month='$date_month',year='$date_year',gender='$gender',reg='$reg',blood='$blood',position='$position',expriences='$expriences',email='$email1',phone_no='$phone',address1='$address1',address2='$address2',city='$city',country='$country',pincode='$pincode',photo='$photo',status='$status',r_id='$rid',sp_id='$spid',busfeestype='$busfeestype' WHERE o_id='$o_id'";

		$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
			
				header("Location:others_edit.php?o_id=$o_id&msg=succ&err_img=$err_img");
		
			
			} else {
				//$_SESSION['error'] = "Could not upload file.  Check read/write persmissions on the directory";
				header("Location:others_edit.php?o_id=$o_id&msg=eronfile");
				exit;
			}
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Edit Others Details</li>
			</ul>
		...
		<div id="main-content">
            ...
            <?php 
					$o_id=$_GET['o_id'];
							$stafflist=mysql_query("SELECT * FROM others WHERE o_id=$o_id"); 
								  $staff=mysql_fetch_array($stafflist);
								  ?>
				<div class="block-border">
					<div class="block-header">
						<h1>Edit Others Details &nbsp;:: Others ID - <?php  echo $staff['others_id'];?></h1><span></span>
					</div>
                    
					<form id="validate-form" class="block-content form" action="" method="post" enctype="multipart/form-data">
						<input type="hidden" name="other_id" value="<?php  echo $staff['others_id'];?>">
                        <div class="_25">
							<p>
            ...
            <?php } }?>									
						...
						<div class="block-actions">
							...
							<ul class="actions-left">
                            <input type="hidden" class="medium" name="o_id" value="<?php echo $o_id;?>" >
