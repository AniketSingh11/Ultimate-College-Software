...
<body id="top">
 ...
 <!--! end of #search-bar -->
    ...
    <?php 
		$stid=$_GET['stid'];
		if($stid){$stafflist=mysql_query("SELECT * FROM staff WHERE st_id=$stid"); 
		...
		<div id="main-content">
            ...
            <div class="block-border">
					...
					<form id="validate-form" class="block-content form" action="" method="GET">
						<div class="_50">
							<p>
								<label for="select">Staff : <span class="error">*</span></label>
                                	<?php
                                            $classl1 = "SELECT * FROM staff where s_type='Teaching'";
                                            $result11 = mysql_query($classl1) or die(mysql_error());
                                            echo '<select name="stid" id="stid" class="required"> <option value="">Select Staff</option>';
											while ($row11 = mysql_fetch_assoc($result11)): ?>
                                                <option value="<?php echo $row11['st_id'];?>"><?php echo $row11['fname']." ".$row11['mname']." ".$row11['lname'];?></option>                                            <?php endwhile;
                                            echo '</select>';
                                            ?>
								</select>
							</p>
            ...
            <form id="validate-form1" class="block-content form" action="" method="post">
                    <div class="_100">
							<p>
