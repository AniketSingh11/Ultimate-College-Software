    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><a href="board_select_percentagepaid.php" title="<?php echo $board['b_name'];?>"><?php echo $board['b_name'];?></a></li>
            ...
            <div class="block-border">
             ...
             <?php 
			  ...
			  while($row1=mysql_fetch_array($qry1))
                ...
                <a href="payment_incomestudent_export.php?perrange1=<?php echo $perrange1."&perrange2=".$perrange2."&cid=".$cid."&sid=".$sid."&bid=".$bid."&acid=".$acyear;?>" target="_blank" style="margin:0px 10px 0 0px; float:right;"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/inbox-download.png"> Download Report</button></a>
			  ...
			  while($student=mysql_fetch_array($studentlist))
        		{
							      ...
							      $total=total_amount($bid,$cid,$fdis,$acyear,$ftype,$latejoin);
...
function change_function() { 
	 ...
	 window.location.href = 'payment_percentageincome_report.php?bid='+cid;	  
	}	
