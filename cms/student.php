    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><a href="section.php?cid=<?php echo $cid;?>" title="section"><?php  echo $class['c_name'];?> Section/Group List</a></li>
                <li class="no-hover"><?php echo $class['c_name']."-".$section['s_name'];?> Student List</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
                ...
                <a href="student_new.php?cid=<?php echo $cid;?>&sid=<?php echo $sid;?>" style="margin:0px 0 0 10px;"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> Import Student Datas</button></a>
                <a href="student_single.php?cid=<?php echo $_GET['cid']; ?>&sid=<?php echo $_GET['sid']; ?>" style="margin:0px 0 0 10px;"><button class="btn btn-orange btn-small "><img src="img/icons/packs/fugue/16x16/user--plus.png">  Add Single</button></a>
			  ...
			  while($row=mysql_fetch_array($qry))
        		{?>
                                ...
                                <button class="btn btn-small btn-success" >Active</button><?php }else{?><button class="btn btn-small btn-gray" >Inactive</button> <?php } ?>
                                 ...
                                 <a href="student_edit.php?ssid=<?php echo $row['ss_id'];?>&cid=<?php echo $cid;?>&sid=<?php echo $sid;?>" title="Edit"><img src="./img/edit.png" alt="edit"></a>
                                 <a href="student_delete.php?ssid=<?php echo $row['ss_id']; ?>&cid=<?php echo $cid; ?>&sid=<?php echo $sid;?>" class="delete" title="delete" onClick="return confirm('are you sure you wish to delete this record');"><img src="./img/del.png" alt="delete"></a>
