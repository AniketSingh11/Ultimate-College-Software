					...
					$qry2=mysql_query("SELECT * FROM fgroup_detail where fg_id!=4 AND otherfees='0'");													
						...
						$frid=$frate['fr_id'];
											...
											//echo "<br>";
												if($frid){
													//echo "update";
													$sql=mysql_query("UPDATE frate SET rate='$fdisvalue',rate1='$fdisvalue1' WHERE fr_id='$frid'") or die("Could not insert data into DB: " . mysql_error());
            ...
            <?php
				...
				if($cid){
							$classlist=mysql_query("SELECT * FROM class WHERE c_id=$cid"); 
								  ...
								  if(!$sid && (($class['c_name']=="XI STD") || ($class['c_name']=="XII STD" || $class['c_name']=="XI") || ($class['c_name']=="XII"))){
