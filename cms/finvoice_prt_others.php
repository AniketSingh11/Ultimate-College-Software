  ...
  .total{ float:right; margin-right:50px;}
    ...
    .main-table td{
        ...
        <header class="header">
          ...
          -->
          <span style="font-size: 15px !important;">SCHOOL/COLLEGE MANAGEMENT SYSTEM</span><br>
          <span>Hetauda, Nepal</span><br>
		...
		<div class="main-table">
            ...
            <?php $tr=$tr-1; ?>
				    ...
				    <td style="border-bottom:0 !important;border-left:0 !important;">
					    <center><?php echo 'Books, Notes & Other Items';
            ...
            <td style="border-bottom:0 !important;border-left:0 !important;"></td>
						<td style="border-bottom:0 !important;border-left:0 !important;">
							<center>Cheque Bounce Charges	</center></td>				   
						
						
						<!--<td></td>--><td style="border-right:0 !important;text-align: right;">
						<?php echo number_format($invoice['cheque_service'],2);?></td>
						<!--<td style="border-right:0 !important;"></td>-->
				    </tr>	
				    <?php } ?>
			     </tbody>
           <?php
				 ...
				 <tfoot>
				    <tr>
				     ...
				     <!--<td style=""></td>-->
				     <td style="border-right:0 !important;text-align: right;"><?php echo number_format($invoice['fi_total']+$invoice['cheque_service'],2);?></td>
				     <!--<td style="border-right:0 !important;"></td>-->
				    </tr>
				 </tfoot>
			   </table>
