 ...
 if (isset($_POST['submit']))
{
	$pdate=mysql_real_escape_string($_POST['pdate']);
	 ...
	 $smsg=mysql_real_escape_string($_POST['msg']);
    ...
    { 
	 ...
	 $stafflist=mysql_query("SELECT * FROM staff WHERE st_id=$stid"); 
								 ...
								 $msg1 = "Dear ".$name.", ".$msg." IMS";
								 $ch = curl_init();
                                 curl_setopt($ch,CURLOPT_URL, $url);
                                 curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
                                 curl_setopt($ch, CURLOPT_POST, 1);
                                 if($mtype=="1"){
                                 	curl_setopt($ch, CURLOPT_POSTFIELDS, "uname=imshar&pass=k!5Zw~4K&send=IMSHAR&dest=$phone_no&msg=$msg1&concat=1&unicode=1");
								 }else{
									 curl_setopt($ch, CURLOPT_POSTFIELDS, "uname=imshar&pass=k!5Zw~4K&send=IMSHAR&dest=$phone_no&msg=$msg1");
								 }
								...
								$stat= explode(',', $buffer);
	  							/*$status=$stat[0];
									if($status == "Status=0"){	*/						
									 	$sql="INSERT INTO mobile_sms_specific (day,month,year,date,title,msg,st_id,ay_id) VALUES
('$publish_day','$publish_month','$publish_year','$pdate','$title','$smsg','$stid','$acyear')";
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">SMS To Specific Staff</li>
			</ul>
            ...
            <?php } ?>
				...
				<div class="block-border">
                    ...
                    <p>
                            ...
                            <?php
                            $select_record1=mysql_query("SELECT * FROM staff where status='1'");
							$succ="";
							$error="";
							while($queryfetch1=mysql_fetch_array($select_record1))
							{ ?>
                                            <option value="<?php echo $queryfetch1['st_id'];?>"><?php echo $queryfetch1['fname']." ".$queryfetch1['lname'];?></option>
                              <?php } ?>
                                        </select>
                                        <div class="btn-group">
                        ...
                        <div class="_50">
                         ...
                         <div class="_100">
							<p><label for="textarea">Msg Details: <span class="error">* (Ctrl + G is a Shortcut for Tamil Typing)</span></label><textarea id="textarea1" name="msg" class="required" rows="5" cols="40"></textarea></p>
						</div>
                        <div class="_25">
							<p>
								<label for="select">Msg Type</label>
                                   <select name="mtype" id="mtype">
                                                <option value="0">Engilsh</option>	
