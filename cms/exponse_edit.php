 ...
 if (isset($_POST['submit']))
{
	...
	$sql=mysql_query("UPDATE exponses SET r_no='$r_no',b_no='$b_no',date_day='$date_day',date_month='$date_month',date_year='$date_year',title='$title',des='$des',amount='$amount',exc_id='$excid',exs_id='$exsid',ay_id='$acyear' WHERE ex_id='$exid'") or die("Could not insert data into DB: " . mysql_error());
							...
							<p>
                               ...
                               <option value="">select</option>
                                ...
                                while ($row1 = mysql_fetch_assoc($result1))
                                {
                                    ...
                                    $c_id=$row1["exs_id"];
                            ?>
                              <option value='<?=$c_id?>'<?php if($exsid==$c_id){ echo "selected";}?> ><?=$subname?></option>
                              <?php 
                                }
                                ?>
                                </select>
