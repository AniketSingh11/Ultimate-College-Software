            ...
            <?php } if($_GET['roll']){ 
					...
					$studentlist=mysql_query("SELECT * FROM student WHERE admission_number LIKE '$rollno' AND ay_id=$ayid"); 
							...
							$sectionlist=mysql_query("SELECT * FROM section WHERE s_id=$sid"); 
								  ...
								  if(($class['c_name']=="LKG") || ($class['c_name']=="UKG")){
