 ...
 <!--! end of #search-bar -->
    ...
    <div id="main" role="main">
		...
		if(!empty($_GET['cancel'])){
			$addin=mysql_query("UPDATE finvoice_others SET i_status='0' WHERE fi_id=$canid");
			header("location:feesinvoice_reject_others.php?msg=esucc");
		}
		if(!$bid){
            ...
            <a href="feesinvoice.php?bid=<?php echo $bid;?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
			   ...
			   ?>
                ...
                <?php if($i_status==1 && $_SESSION['admin_type']=="0"){
					if($c_status!='2'){?>
					<!--
                <input type="button" value="Add Invoice" onClick="window.open('feesinvoice_reject_detail_others.php?cancel=<?php echo $ffi_id;?>')" class="btn btn-red" style="width:120px">
                -->
                <?php } }?>
                </td>
                </tr>
