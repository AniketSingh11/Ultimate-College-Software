...
<h2 style="padding:0px; padding-bottom:2px; margin:0px; font-family:georgia">SCHOOL/COLLEGE MANAGEMENT SYSTEM</h2>
<h5 style="padding:0px; padding-bottom:2px; margin:0px; font-size:16px; font-weight:lighter">Senneerkuppam, Poonamallee,Hetauda, Nepal</h5>
...
<div style="width:3.5%; float:left"> -- </div><div style=" width:72.4mm; float:left;  height:17px; font-weight:bold; font-size:13px; font-family:georgia; line-height: 2px;/*margin-top:-7mm*/"> &nbsp;&nbsp;&nbsp;School/College Management Solution<br><span style=" margin-left:10mm; line-height:26px; font-size:11px; font-family:Times New Roman; text-align:center">P</span></div>
</div>
<div style="width:195.75mm; float:left">
