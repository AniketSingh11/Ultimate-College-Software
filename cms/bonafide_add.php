 ...
 if (isset($_POST['submit']))
{
	...
	$qry1=mysql_query("select * from bonafide where ay_id='$acyear' and admin_no='$admin_no' ");
	...
	$adminlist=mysql_query("SELECT * FROM certificate_count WHERE cc_id='1'");
	...
	$sql1=mysql_query("UPDATE certificate_count SET count='$refno2' WHERE cc_id='1'");
	  }
	
		$sql="INSERT INTO bonafide (admin_no,name,gender,city,p_name,standard,year,dob,ay_id,purpose,ref_number,date) VALUES
('$admin_no','$name','$gender','$city','$p_name','$standard','$year','$dob','$acyear','$purpose','$ref_number','$date')";
...
$lastid=mysql_insert_id();
    ...
    if($result){	
     ...
     header("Location:bonafide_add.php?lid=$lastid&msg=succ");	   
    }
    exit;
}
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Add New Bonafide</li>
			</ul>
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Add New Bonafide</h1><span></span>
					</div>
					<form id="validate-form" class="block-content form" action="" method="post">
						<div class="_50" id="suggest">
							<p>
                                <label for="textfield">Admin No</label>
                                <input name="admin_no" id="admin_no"  onkeyup="suggest(this.value);"  autocomplete="off" class="required" type="text" value="" />
...
<div id="suggestionsList" class="suggestionList"></div>
                        ...
                        <div class="_50">
							<p>
                                ...
                                <input id="p_name" name="p_name" class="required" type="text" value="" />
                            </p>
						</div>
  ...
  <!-- end scripts-->
   <script type="text/javascript">
    ...
    function fill(thisValue,s,p,std,y,d,cas,gen,city) {
