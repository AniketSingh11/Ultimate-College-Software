...
//echo"SELECT * FROM board WHERE b_id=$bid";die;		
		  ...
		  $enddate= $edate_year.$edate_month.$edate_day;
					...
					$qry1=mysql_query("SELECT * FROM finvoice_other WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $startdate. "' AND '" . $enddate.  "' AND ay_id='" . $acyear. "' and fi_ptype='cheque' AND bid=$bid AND ay_id=$acyear  AND i_status='0' ORDER BY fr_no DESC ");
			  ...
			  while($row1=mysql_fetch_array($qry1))
                ...
                <span style="margin-left:20px;"><a href="cheque_feesinvoice_download_report.php?sdate=<?php echo $sdate;?>&edate=<?php echo $edate;?>&b_id=<?php echo $bid;?>&ayid=<?php echo $acyear;?>" style="width:100px"><button class="btn btn-small btn-green"><img src="img/icons/packs/fugue/16x16/inbox-download.png"> Download Report</button></a></span>
