 ...
 if (isset($_POST['submit']))
{
	...
	$stid=$_POST['stid'];
		...
		$sql="INSERT INTO homework (title,day,month,year,detail,c_id,s_id,m_id,st_id,sub_id,b_id,ay_id) VALUES
('$title','$date_day','$date_month','$date_year','$detail','$cid','$sid','$mid','$stid','$subid','$bid','$acyear')";

$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
    if($result){
        header("Location:shomework_single.php?cid=$cid&sid=$sid&mid=$mid&subid=$subid&bid=$bid&msg=succ");
    }
    exit;
}
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover"><a href="shomework_mng.php?cid=<?php echo $cid;?>&sid=<?php echo $sid;?>&mid=<?php echo $mid;?>&subid=<?php echo $subid;?>&bid=<?php echo $bid;?>" title="Homework management">Homework management</a></li>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Add New <?php echo $class['c_name']."-".$section['s_name']." (".$month['m_name'].")";?> Homework <b>(<?php echo $slist['s_name'];?>)</b></h1>                
