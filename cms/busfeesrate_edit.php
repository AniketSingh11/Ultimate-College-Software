 ...
 if (isset($_POST['submit']))
{
	...
	$status=$_POST['status'];
		...
		$sql=mysql_query("UPDATE trbusfees SET fees='$busfees',sp_fees='$spfees',sp_fees_onetime='$onetimespfees',one_time='$onetime',status='$status' WHERE bf_id='$bfid'");		
	if($sql){
			if($ftyid!=$lftyid){
        ...
        header("Location:busfeesrate_edit.php?bfid=$bfid&rid=$rid&msg=succ");
    }
    exit;
}
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover"><a href="bus_feesrate.php?rid=<?php echo $rid; ?>" title="Stopping Name List"><?php  echo $class['r_name'];?> Route Master - Bus Fees Rate</a></li>
                <li class="no-hover">Edit <?php  echo $class['r_name'];?> Bus Fees Rate</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Edit <?php  echo $class['r_name'];?> Bus Fees Rate</h1>                
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Edit <?php  echo $class['r_name'];?> Bus Fees Rate</h1><span></span>
					</div>
                    <?php 
							$bfid=$_GET['bfid'];
							$rid=$_GET['rid'];
					...
					<form id="validate-form" class="block-content form" action="" method="post">
                        ...
                        <table id="table-example" class="table">
							...
							<tbody>
                            <?php 
							$qry=mysql_query("SELECT * FROM trstopping WHERE stop_id=$spid ORDER BY ListingID");
						$row=mysql_fetch_array($qry);
        				$spid=$row['stop_id'];
						$busfeeslist=mysql_query("SELECT * FROM trbusfees WHERE bf_id=$bfid AND sp_id=$spid"); 
