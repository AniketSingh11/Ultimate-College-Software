 ...
 <!--! end of #search-bar -->
    ...
    <?php 
		...
		<div id="main-content">
            ...
            <a href="sboard_select_class_feed1.php?bid=<?php echo $bid; ?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
            <div class="grid_12">
            </div>
			<?php
							$cid=$_GET['cid'];
				...
				if($cid && $sid){
							...
							$sectionlist=mysql_query("SELECT * FROM section WHERE s_id=$sid"); 
								  ...
								  ?>
			<div class="grid_12">
				<h1><?php echo $class['c_name']."-".$section['s_name'];?> Student Feedback List</h1>                                  
			</div>
            <div class="grid_12">
			  ...
			  while($row=mysql_fetch_array($qry))
				...
				?>
                                ...
                                <?php $select_record2=mysql_query("SELECT * FROM ssfeedback WHERE c_id=$cid AND s_id=$sid AND ss_id=$ssid AND ay_id=$acyear AND status='1' AND send='student' AND st_id=$stid");						
								$unread=0;
					...
					{ $unread++;
                                ...
                                <td><center><?php echo $unread; ?></center></td>
                                 ...
                                 <center><a href="sstudent_mng_feedback1.php?bid=<?php echo $bid; ?>&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>&ssid=<?php echo $ssid; ?>"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> View</button></a></center>
                                 </td>
								</tr> 
                                 <?php 
							$count++;
