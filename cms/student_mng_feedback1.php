    ...
    <?php 
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><a href="feedback_mng1.php?bid=<?php echo $bid; ?>&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>&subid=<?php echo $subid; ?>" title="Feedback list">Feedback list</a></li>
		...
		<div id="main-content">
            ...
            <a href="feedback_mng1.php?bid=<?php echo $bid; ?>&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>&subid=<?php echo $subid; ?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
            <div class="grid_12">
            </div>
			<?php
            ...
            <div class="grid_12">
				<div class="block-border">
                  ...
                  <tr style="border:1px solid #C1C0C0;">
                      <td width="150px;">
                          <?php if($send=="staff"){ echo "<strong> ".$staff['fname']." ".$staff['mname']." ".$staff['lname']."-</strong> Staff<br><span style=' font-size:12px'>".$subject3['date']."</span> "; } else { echo "<strong> ".$student['firstname']." ".$student['middlename']." ".$student['lastname']."</strong>- Student<br><span style=' font-size:12px'>".$subject3['date']."</span> ";}?>                      </td>
