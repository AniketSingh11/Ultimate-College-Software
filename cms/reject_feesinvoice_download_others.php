		...
		$boardlist=mysql_query("SELECT * FROM board WHERE b_id=$bid"); 
		  ...
		  $enddate= $edate_year.$edate_month.$edate_day;
					...
					if($sdate && $edate && $bid){ 
						...
						$qry1=mysql_query("SELECT * FROM finvoice_other WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $startdate. "' AND '" . $enddate.  "' AND ay_id='" . $acyear. "' and bid=$bid AND ay_id=$acyear  AND i_status='1' ");
     ...
     /*   for ($i = 1; $i < mysql_num_fields($result); $i++)
        ...
        */
        ...
        $objPHPExcel->getActiveSheet()->getColumnDimension('E')->setWidth(20);cellFont("E2","Calibri");
		 ...
		 $objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, "Student_Category");$column++;
       ...
       //$column = 'G';
		...
		$qry=mysql_query("SELECT * FROM finvoice_others WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $startdate. "' AND '" . $enddate.  "' AND ay_id='" . $acyear. "' and bid=$bid AND ay_id=$acyear  AND i_status='1' ");
							//echo "SELECT * FROM finvoice WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $startdate. "' AND '" . $enddate.  "' AND ay_id='" . $acyear. "' and bid=$bid AND ay_id=$acyear  AND i_status='1' ";die;
...
//echo "SELECT * FROM class WHERE c_id=$cid";		die;		
        ...
        $objPHPExcel->getActiveSheet()->setTitle($class_name."-".$section_name."Fees Invoice Reject");
       ...
       header("Content-Disposition: attachment;filename=Fees Invoice Reject-list.xls");
