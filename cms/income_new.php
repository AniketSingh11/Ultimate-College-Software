 ...
 if (isset($_POST['submit']))
{
	...
	$sql="INSERT INTO income (r_no,b_no,date_day,date_month,date_year,title,des,amount,inc_id,ay_id) VALUES
('$receiptno','$b_no','$date_day','$date_month','$date_year','$title','$des','$amount','$incid','$acyear')";
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover"><a href="income_category.php" title="Academic ex_catetory">Income Category list</a></li>
                <li class="no-hover"><a href="income.php?incid=<?php echo $incid; ?>" title="month"><?php  echo $class['in_category'];?> Income Details</a></li>
                <li class="no-hover">Add New <?php  echo $class['in_category'];?> Income Details</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Add New <?php  echo $class['in_category'];?> Income Details</h1>                
