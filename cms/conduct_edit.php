...
$sql="UPDATE conduct SET name='$name',standard='$standard',year='$year',character1='$character1',dob='$dob',purpose='$purpose',c_date='$c_date' WHERE con_id='$contid'";

$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
$lastid=mysql_insert_id();

    if($result){		
     header("Location:conduct_edit.php?contid=$contid&msg=succ");	   
    }
    exit;
}
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Edit conduct Certificate</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Edit conduct Certificate</h1>                
            ...
            <center><a href="conduct_prt.php?contid=<?php echo $_GET['contid'];?>" target="_blank"><button class="btn btn-small btn-warning" ><img src="img/icons/packs/fugue/16x16/block--arrow.png"> Click Here To Print the Last Edited Certificate</button></a></center>
            </div>
            <?php } ?>
            
				<div class="block-border">
					<div class="block-header">
						<h1>Edit conduct Certificate</h1><span></span>
					</div>
                    <?php
                    $contid=$_GET['contid'];
					...
					<form id="validate-form" class="block-content form" action="" method="post">
                        ...
                        <div class="_50">
							<p>
                                ...
                                <input id="textfield" name="character1" class="required" type="text" value="<?php echo $row['character1']; ?>" />
                            </p>
						</div>
                        <div class="_50">
							<p>
                                <label for="textfield">Date of Birth</label>
                                <input id="dob"  name="dob" class="required" type="text" value="<?php echo $row['dob']; ?>" />
                            </p>
						</div>
						 <div class="_50">
							<p>
						...
						<div class="block-actions">
							...
							<ul class="actions-left">
                            <input type="hidden" class="medium" name="contid" value="<?php echo $_GET['contid'];?>" >
