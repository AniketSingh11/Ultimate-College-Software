 ...
 <div id="wrapper">
     ...
     <div id="content">				
		 <div id="content-header">
			 <h1> Employee Leave Details <a href="emp_leave_list_print.php" title="Print" target="_blank" ><button type="button" class="btn btn-success">Print</button></a></h1><?php if($filter){?><span style="float:right; margin-right:30px;"><b>Filter by : </b> Employee Type = <?php echo $filter;?></span><?php } ?>
		 </div>  <!-- #content-header -->	
...
<?php } ?>		 <div class="row">
						 ...
						 <div class="portlet-header">
                            ...
                            <div class="btn-group" style="float:right;">
							  ...
							  <ul class="dropdown-menu" role="menu">
                                <li <?php if(!$filter){ echo 'class="active"';}?>><a href="emp_leave_list.php">Over All</a></li>
							    <li <?php if($filter=="Teaching"){ echo 'class="active"';}?>><a href="emp_leave_list.php?filt=Teaching">Teaching</a></li>
							    <li <?php if($filter=="Non-Teaching"){ echo 'class="active"';}?>><a href="emp_leave_list.php?filt=Non-Teaching">Non-Teaching</a></li>
							  </ul>
							</div>
						 </div>  <!-- /.portlet-header -->
		...
		?>                             
										 <tr>
                                             ...
                                             <td><a href="leave_detail.php?id=<?php echo $emp_id; ?>&syear=<?php echo $ay['s_year'].'&eyear='.$ay['e_year'];?>" title="Salary Details"><button type="button" class="btn btn-sm btn-success">
