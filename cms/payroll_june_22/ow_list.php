...
<td><?php if($emp_display['s_type']=="1"){ echo "Day Salary";} else { echo "Month Salary";}?></td>											 
								...
								<i class="fa fa-cogs"></i> View
											 ...
											 <td><a title="view" href="#styledModal<?php echo $emp_count.''.$emp_id;?>" data-toggle="modal"><img src="img/layout/view.png"/></a> <a title="edit" href="ow_details_edit.php?id=<?php echo $emp_id; ?>"><img src="img/layout/edit.png"/></a> <a title="delete" href="ow_details_delete.php?id=<?php echo $emp_id; ?>" onClick="return confirm('are you sure you wish to delete this record');"><img src="img/layout/delete.png"/></a> </td>
										 </tr>
		<?php         
		$emp_count++;
        }
