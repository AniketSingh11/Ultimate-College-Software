...
$did=$_GET['did'];
  if(isset($_POST["submit"]))
  {
	...
	if($query)
	{
		header("location:driver_day_salary_edit.php?id=$id&did=$did&msg=succ");		
	}
	else
	{
		header("location:driver_day_salary_edit.php?id=$id&did=$did&msg=err");		
	}
 ...
 <div id="wrapper">
     ...
     <div id="content">	
		 <div id="content-header">
			 <h1> <?php echo $staffs['fname']." ".$staffs['lname'];?> - Salary Details Edit <a href="driver_day_salary_list.php?id=<?php echo $did;?>"><button type="button" class="btn btn-success"> <i class="fa fa-angle-double-left"></i> Back</button></a></h1>
		 </div>  <!-- #content-header -->	
