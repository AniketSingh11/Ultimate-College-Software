...
$adminlist=mysql_query("SELECT * FROM staff_no_count WHERE id='1'"); 
          ...
          $adminno2=$adminno+1;
         $admin_number="SPMST".str_pad($adminno, 3, '0', STR_PAD_LEFT);
...
if (move_uploaded_file($image['tmp_name'], $TARGET_PATH)) {
 ...
 $query="insert into staff(staff_id,fname,lname,s_pname,dob,day,month,year,gender,reg,blood,marriage,doj,s_type,position,expriences,job_type,qualf,address1,address2,city,state,pincode,country,lline,phone_no,email,password,b_name,b_acc_no,pf_no,nominee,n_name,n_phone_no,n_email,photo,status,salarytype,uanno)values('$admin_number','$fname','$lname','$pname','$dob','$date_day','$date_month','$date_year','$gender','$reg','$blood','$marriage','$doj','$s_type','$position','$expriences','$job_type','$qualf','$address1','$address2','$city','$state','$pincode','$country','$lline','$phone_no','$email','$staff_id','$b_name','$b_acc_no','$pf_no','$nominee','$n_name','$n_phone_no','$n_email','" . $image['name'] . "','1','$salarytype','$uanno')";
 //echo "insert into staff(staff_id,fname,lname,s_pname,dob,gender,reg,blood,marriage,doj,s_type,position,expriences,job_type,qualf,address1,address2,city,state,pincode,country,lline,phone_no,email,b_name,b_acc_no,pf_no,nominee,n_name,n_phone_no,n_email,photo,status,salarytype)values('$admin_number','$fname','$lname','$pname','$dob','$gender','$reg','$blood','$marriage','$doj','$s_type','$position','$expriences','$job_type','$qualf','$address1','$address2','$city','$state','$pincode','$country','$lline','$phone_no','$email','$b_name','$b_acc_no','$pf_no','$nominee','$n_name','$n_phone_no','$n_email','" . $image['name'] . "','1','$salarytype')"; die;
