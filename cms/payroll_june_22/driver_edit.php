...
header("Location: driver_edit.php?id=$sid&msg=err_img");
exit;
}
...
//$query="update driver set driver_id='$driver_id',fname='$fname', lname='$lname', d_pname='$pname', dob='$dob', age='$s_age', gender='$gender', reg='$reg', blood='$blood', marriage='$marriage', doj='$doj', d_type='$d_type', position='$position', job_type='$job_type', qualf='$qualf', address='$address', address2='$address2',dor='$dor', state='$state', country='$country', lline='$lline', phone_no='$phone_no', email='$email', b_name='$b_name',relivestatus='$relivestatus', b_acc_no='$b_acc_no', pf_no='$pf_no', nominee='$nominee', n_name='$n_name', n_phone_no='$phone_no', n_email='$email',photo='" . $image['name'] . "',status='$status',salarytype='$salarytype' where d_id='$sid' ";

$query="update driver set driver_id='$driver_id',fname='$fname', lname='$lname', d_pname='$pname', dob='$dob',gender='$gender', reg='$reg', blood='$blood', marriage='$marriage', doj='$doj', d_type='$d_type',dor='$dor',relivestatus='$relivestatus', position='$position', expriences='$expriences',job_type='$job_type', qualf='$qualf', address='$address', address2='$address2', city='$city',state='$state', pincode='$pincode',country='$country', lline='$lline', phone_no='$phone_no', email='$email',  b_name='$b_name', b_acc_no='$b_acc_no', pf_no='$pf_no', nominee='$nominee', n_name='$n_name', n_phone_no='$phone_no', n_email='$email',photo='" . $image['name'] . "',status='$status',salarytype='$salarytype',s_type='$s_type',allowance_status='$allowance_status',allowance_amount='$allowance_amount',uanno='$uanno' where d_id='$sid' ";
	$result=mysql_query($query);
	
	if($result)
	{
		header("location:driver_edit.php?id=$sid&msg=succ");
		
	}
	else
	{
		header("location:driver_edit.php?id=$sid&msg=err");		
 ...
 <div id="wrapper">
     ...
     <div id="content">	
		 <div id="content-header">
			 <h1> Driver Details Edit <a href="driver_list.php"><button type="button" class="btn btn-success"> <i class="fa fa-angle-double-left"></i> Back</button></a></h1>
		 </div>  <!-- #content-header -->	
...
<?php } ?>
                 ...
                 <?php
				 $s_id=$_GET["id"];
$emp_query="select * from driver where d_id='$s_id'";
...
<div class="col-sm-6">
				            	<div class="form-group">
									...
									<input type="text" id="driverid" name="driverid" class="form-control" data-required="true"  value="<?php echo $emp_display["driver_id"] ; ?>" readonly>
								</div>
                                <div class="form-group">
                     ...
                     <div class="form-group">	
							<p>
								...
								<textarea name="address2" id="textarea-input" cols="10" rows="3" class="form-control"> <?php echo $emp_display["address"] ; ?></textarea>
								</div>
                                <div class="form-group">
...
<div class="col-sm-6">
                                ...
                                <div class="form-group">
									...
									<input type="text" id="fathername" name="fathername" class="form-control" data-required="true" value="<?php echo $emp_display["d_pname"] ; ?>">
								</div>
                                <!--<div class="form-group">
            ...
            <?php } }?>             
                                ...
                                <div class="form-group">	
									...
									<select name="driver_type" class="form-control" data-required="true">
										<option value="Driver" <?php if($emp_display["d_type"]=='Driver'){ echo 'selected'; } ?>>Driver </option>
										<option value="Non-Driver" <?php if($emp_display["d_type"]=='Non-Driver'){ echo 'selected'; } ?>>Non-Driver</option>
									</select>
								</div>
                                <div class="form-group">	
								...
								<textarea name="address" id="textarea-input" cols="10" rows="3" class="form-control" data-required="true"><?php echo $emp_display["address"]; ?></textarea>
								</div>
                                ...
                                <div class="form-group">
									...
									<input type="email" id="email" name="email" class="form-control" value="<?php echo $emp_display["email"]; ?>" >
								</div>
                                <div class="form-group">
     ...
     <div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" id="bankname" name="bankname" class="form-control"  value="<?php echo $emp_display["b_name"] ; ?>">
								</div>
                                <div class="form-group">
									<label for="name">PF No</label>
									<input type="text" id="pfno" name="pfno" class="form-control"  value="<?php echo $emp_display["pf_no"] ; ?>">
								</div>
								 <div class="form-group">
...
<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" id="accountno" name="accountno" class="form-control" value="<?php echo $emp_display["b_acc_no"] ; ?>">
								</div>
                                 <div class="form-group">	
                                 <?php 
            ...
            <?php } }?>		
                                ...
                                <div class="form-group">
									...
									<input type="text" id="nphone" name="nphone" class="form-control" value="<?php echo $emp_display["n_phone_no"] ; ?>">
								</div>
                                <div class="fileupload fileupload-new" data-provides="fileupload">
							  <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px;">
                              <?php if($emp_display['photo']){ ?>
                              <img  src="../img/driver/<?php echo $emp_display['photo']; ?>" width="95" height="120" style=" margin-bottom:30px;margin-right:30px; float:left; border:1px solid #ccc;" />
                              <?php } ?>
                              </div>
							  <div>
                                ...
                                <?php if($emp_display['photo'] && $emp_display['photo']!="driver_male.png" && $emp_display['photo']!="driver_female.png"){
									 ?>
                                <a href="driver_delete.php?img_id=<?php echo $s_id;?>" title="delete" class="btn btn-default">Delete</a>
                                <?php } ?>
							  </div>
							</div>
