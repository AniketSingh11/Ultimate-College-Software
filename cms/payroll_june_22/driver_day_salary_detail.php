...
<?php } ?>		 <div class="row">
						 ...
						 <div class="portlet-content">
							...
							>
									...
									<tbody>
										...
										if($filter=="Driver"){
											$emp_query="select * from driver where d_type='Driver' and s_type='1' order by fname asc";
										}else if($filter=="Non-Driver"){
											$emp_query="select * from driver where d_type='Non-Driver' and s_type='1' order by fname asc";
										}else{
											$emp_query="select * from driver where s_type='1' order by fname asc";
										}
        ...
        ?>							
				...
				<?php
					if($filter=="Driver"){
						$emp_query="select * from driver where d_type='Driver' order by fname asc";
					}else if($filter=="Non-Driver"){
						$emp_query="select * from driver where d_type='Non-Driver' order by fname asc";
					}else{
