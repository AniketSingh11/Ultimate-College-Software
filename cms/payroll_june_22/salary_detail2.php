...
<style type="text/css">
 ...
 <div id="wrapper">
     ...
     <div id="content">		
		<?php
		/*$stid=$_GET['id'];
$query=mysql_query("select * from staff where d_id='$stid'");
$staffs=mysql_fetch_array($query);*/
?>
		 <div id="content-header">
			 <h1> <?php echo $staff1['fname']." ".$staff1['lname']." - (".$syear."-".$eyear.")";?> Salary Details <a href="driver_salary_detail.php"><button type="button" class="btn btn-success"> <i class="fa fa-angle-double-left"></i> Back</button></a></h1>
		 </div>  <!-- #content-header -->	
				 ...
				 <div class="col-md-12">
					 <div class="portlet">
						 <div class="portlet-header">
                             ...
                             <a href="salary_detail2_down.php?id=<?php echo $d_id."&syear=".$syear."&eyear=".$eyear."&acid=".$acyear;?>" title="Download Report"><button type="button" class="btn btn-success">Download Report</button></a>                         
							  ...
							  while($row=mysql_fetch_array($qry))
								{
									$syear1=$row['s_year'];
									$eyaer1=$row['e_year'];?>
                                  <li <?php if($row['y_name']==$yearstring){ echo 'class="active"';}?>><a href="salary_detail.php?id=<?php echo $d_id;?>&syear=<?php echo $syear1."&eyear=".$eyaer1;?>"><?php echo $row['y_name'];?></a></li>
                                  <?php } ?>                             		
							  </ul>
							</div>                            
                         </div>  <!-- /.portlet-header -->
						 <div class="portlet-content">
							...
							>
									...
									<tbody>
										<?php	
											 $emp_query="select * from staff_month_salary where d_id=$d_id AND ((year=$syear AND month>5) OR (year=$eyear AND month<=5)) order by st_ms_id desc";										
							...
							?>                             
										 <tr>
                                             ...
                                             <td><a title="view" href="#styledModal<?php echo $emp_count.''.$emp_id;?>" data-toggle="modal"><img src="img/layout/view.png"/></a> <a title="Print" href="monthly_salary_print.php?id=<?php echo $emp_id; ?>&stid=<?php echo $d_id."&type=dr"; ?>" target="_blank"><img src="img/layout/print.png"/></a> </td>
										 </tr>
		<?php 
		$emp_count++;
        }
