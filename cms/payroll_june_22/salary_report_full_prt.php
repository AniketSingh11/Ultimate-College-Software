...
<h3>Salary Overall Report ( <?=$sdate_month."-".$sdate_year?> )</h3>
        ...
        <table class="table" width="100%" cellpadding="0" cols="0" border="1" style="border-collapse:collapse;">
							...
							$emp_query="select n_salary,staff_name,position,accno,n_salary from staff_month_salary where month=$sdate_month and year=$sdate_year order by st_ms_id desc";										
