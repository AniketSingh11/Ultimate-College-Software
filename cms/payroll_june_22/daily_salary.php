...
$fixed=$salarylist['salary'];
        ...
        <?php	
							$emp_query="select t1.others_id,t1.fname,t1.category_id,t1.email,t1.phone_no,t1.position from others t1 LEFT JOIN staff_daily_salary t2 ON t1.o_id = t2.o_id AND t2.month=$m_value AND t2.year=$y_value WHERE t2.o_id IS NULL AND t1.status='1' and t1.s_type='1' ";
