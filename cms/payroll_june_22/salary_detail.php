				 ...
				 <div class="col-md-12">
					 <div class="portlet">
						 <div class="portlet-header">
                             ...
                             <a href="salary_detail_down.php?id=<?php echo $st_id."&syear=".$syear."&eyear=".$eyear."&acid=".$acyear;?>" title="Download Report"><button type="button" class="btn btn-success">Download Report</button></a>                         
