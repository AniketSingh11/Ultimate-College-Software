 ...
 if (isset($_POST['submit']))
{
	...
	$fgid=$_POST['fgid'];
		...
		$qry=mysql_query("UPDATE fgroup SET fg_name='$fg_name',fty_id='$fty_id' WHERE fg_id='$fgid'");
    if($qry){
        header("Location:fgroup_edit.php?fgid=$fgid&msg=succ");
    }
    exit;
}
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover"><a href="fgroup.php" title="Home">Fees Group Name </a></li>
		...
		<div id="main-content">
			...
			<a href="fgroup.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
			</div>
            <div class="grid_12">
            <?php $msg=$_GET['msg'];
			if($msg=="succ"){?>			
            ...
            <?php } ?>
				...
				<div class="block-border">
                    ...
                    <?php 
							$fgid=$_GET['fgid'];
							$classlist=mysql_query("SELECT * FROM fgroup WHERE fg_id=$fgid"); 
