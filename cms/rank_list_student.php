     ...
     <?php 
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover"><a href="rank_card.php?cid=<?php echo $cid."&sid=".$sid."&bid=".$bid;?>" title="<?php echo $board['b_name'];?>">Student List</a></li> 
		...
		<div class="grid_12">
                ...
                <?php if($cid && $subid && $sid){?>
                 <a href="rank_card.php?cid=<?php echo $cid."&sid=".$sid."&bid=".$bid;?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
                                 
                <?php  }?>     
                
                 <?php if($cid && $sid && $ssid){		
			 ?>  <a href="progresscard_prt.php?cid=<?php echo $cid."&sid=".$sid."&bid=".$bid."&ssid=".$ssid;?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"> Print </button></a>
                <?php }?>
			  ...
			  while($row1=mysql_fetch_array($qry1))
        		{
					...
					// echo $pass."-".$subount."<br>";
					 if($pass==$subount){
                        ...
                        <center><img src="img/logo_sms.png" style="width:30%;"></center>
				<ul class="client_details" style="claer: both;">
