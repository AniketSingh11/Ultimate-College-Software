...
$(function(){
  var currencies = [
    <?php
$sql = mysql_query("SELECT * FROM student s INNER JOIN class c on(s.c_id=c.c_id)WHERE s.b_id='$bid' AND s.ay_id='$ayid' AND s.user_status=1 AND NOT(c.c_name='PRE KG' or c.c_name='LKG' or c.c_name='UKG')");
