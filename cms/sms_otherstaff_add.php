 ...
 if (isset($_POST['submit']))
{
    ...
    { 
	 $stid=$selectedOption;	 
	  ...
	  $stafflist=mysql_query("SELECT fname,lname,phone_no FROM others WHERE o_id='$stid'"); 
...
$buffer = trim(curl_exec($ch));
								...
								$stat= explode(',', $buffer);
	  							/*$status=$stat[0];
									if($status == "Status=0"){	*/						
									 	$sql="INSERT INTO mobile_sms_specific (day,month,year,date,title,msg,o_id,ay_id) VALUES
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">SMS To Specific OtherStaff</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>SMS To Specific Other Staff</h1>                
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>SMS To Specific Other Staff</h1><span></span>
					</div>
                    ...
                    <p>
                            ...
                            <?php
                            $select_record1=mysql_query("SELECT * FROM others  where status='1'");
							$succ="";
							$error="";
							while($queryfetch1=mysql_fetch_assoc($select_record1))
							{ ?>
                                            <option value="<?php echo $queryfetch1['o_id'];?>"><?php echo $queryfetch1['fname']." ".$queryfetch1['lname'];?></option>
                              <?php } ?>
