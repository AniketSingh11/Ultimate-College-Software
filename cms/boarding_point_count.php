    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Boarding Point Total Count</li>
			</ul>
		...
		<div id="main-content">        		
            ...
            <?php 
					...
					if($rid){	
							 	if($rid!="all"){
								  ...
								  ?>
			<div class="grid_12">
				<h1><?php  echo $routename;?> - Route Student Boarding Point Count</h1>
                <a href="boarding_point_count_prt.php?rid=<?php echo $rid;?>&ayid=<?php echo $acyear;?>" style="margin-left:10px;" target="_blank" ><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> Print Report</button></a>
                <?php if($rid!="all"){ ?>
            ...
            <div class="grid_12">
            	<div class="block-border">
					<div class="block-header">
                    	<h1><?php  echo $routename;?> - Route Stop Count Details</h1>
                        <span></span>
					</div>
					<div class="block-content">
                    	<table class="table" border="1">
							...
							<tbody>
                            <?php 
							$atotal=0; $ttotal=0; $tboys=0; $tgirls=0;
			  ...
			  while($rlist=mysql_fetch_assoc($route))
        		{		
						...
						$total=0; $boys=0; $girls=0; $totalstudent=0;			
