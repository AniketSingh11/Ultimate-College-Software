 ...
 if (isset($_POST['submit']))
{
	...
	$ndes=addslashes($_POST['ndes']);
		...
		$sql="INSERT INTO news (n_title,n_des,status,ay_id) VALUES
('$ntitle','$ndes','1','$acyear')";

$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
    if($result){
        header("Location:news_add.php?msg=succ");
    }
    exit;
}
 ?>
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Add New NEWS</li>
			</ul>
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Add New NEWS</h1><span></span>
					</div>
					<form id="validate-form" class="block-content form" action="" method="post">
						<div class="_100">
							<p>
                                <label for="textfield">NEWS Title</label>
                                <input id="textfield" name="ntitle" class="required" type="text" value="" />
                            </p>
						</div>
                        <div class="_100">
							<p>
                            <label for="textarea">NEWS Description: <span class="error">*</span></label>
                            <textarea id="textarea" name="ndes" class="required" rows="5" cols="40"></textarea>
                            </p>
						</div>
						<div class="clear"></div>
