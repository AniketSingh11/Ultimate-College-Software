 ...
 if (isset($_POST['submit']))
{
	...
	$qry=mysql_query("select * from others_category where 	category_name='$c_name' or  c_code='$c_code' ") or die(mysql_error());
	  if(mysql_num_rows($qry)=="0")
	  {
	
		$sql="INSERT INTO others_category (category_name,c_code,ay_id) VALUES('$c_name','$c_code','$acyear')";
		$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
		header("Location:otherscategory_add.php?msg=succ");
	  }else{
	      header("Location:otherscategory_add.php?msg=err");
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Add Others Category Details</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Add Others Category Details</h1>                
            ...
            <?php $msg=$_GET['msg'];
			if($msg=="succ"){?>			
            <div class="alert success"><span class="hide">x</span>Your Category Successfully Created!!!</div>
            <?php }  if($msg=="err"){?>			
            <div class="alert error"><span class="hide">x</span>Category Name (or)Category Code Already Given !!!</div>
           <?php }?>
				<div class="block-border">
					<div class="block-header">
						<h1>Add Others Category Details</h1><span></span>
					</div>
					<form id="validate-form" class="block-content form" action="" method="post" enctype="multipart/form-data">
						<div class="_25">
							<p>
                                ...
                                <input id="c_name" name="c_name" minlength="2" class="required" type="text"   />
                            </p>
						</div>
						<div class="_25">
							<p>
                                <label for="textfield">Category Code : <span class="error">*</span></label>
                                <input id="c_code" name="c_code" minlength="2" class="required" type="text"   />
                            </p>
						</div>
