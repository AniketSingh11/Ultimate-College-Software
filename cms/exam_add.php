 ...
 if (isset($_POST['submit']))
{
	...
	$end_date=$date_split2[2]."-".$date_split2[1]."-".$date_split2[0];
		...
		$sql="INSERT INTO exam (e_id,e_name,sdate,edate,sday,smonth,syear,eday,emonth,eyear,ay_id) VALUES
('','$ename','$from_date','$end_date','$sday','$smonth','$syear','$eday','$emonth','$eyear','$acyear')";

$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
    if($result){
        header("Location:exam_add.php?msg=succ");
    }
    exit;
}
 ?>
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Add New Exam Name</li>
			</ul>
					...
					<form id="validate-form" class="block-content form" action="" method="post">
                        ...
                        <div class="_25">
							<p>
                                ...
                                <input id="datepicker" name="sdate" class="required" type="text" value="" readonly/>
                            </p>
						</div>
                        <div class="_25">
							<p>
                                <label for="textfield">Term To Date : <span class="error">*</span></label>
                                <input id="datepicker1" name="edate" class="required" type="text" value="" readonly/>
                            </p>
						</div>
						<div class="clear"></div>
