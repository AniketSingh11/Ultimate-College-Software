...
{	
	...
	$bid=$_POST['bid'];
		...
		$sql="INSERT INTO samacheer_x (ano,tno,eno,xmno,sname,fname,nation,community,adidravidar,bc,mbc,convert_christ,de_community,sex,dob,identity1,identity2,doa,leaving,edu_rule,scholarship,med_inspection,school_left,conduct,guardian,dtc,course,academic_year,standard,first_lan,med_ins,ay_id,bid) VALUES
('$ano','$tno','$eno','$xmno','$sname','$fname','$nation','$community','$adidravidar','$bc','$mbc','$convert_christ','$de_community','$sex','$dob','$identity1','$identity2','$doa','$leaving','$edu_rule','$scholarship','$med_inspection','$school_left','$conduct','$guardian','$dtc','$course','$academic_year','$standard','$first_lan','$med_ins','$acyear','$bid')";

$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
$lastid=mysql_insert_id();
    if($result){
        header("Location:samacheer_x_single.php?lid=$lastid&msg=succ");
    }
    exit;
}
    ...
    <div id="main" role="main">    				
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Add new X-Samacheer Certificate</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Add New X-Samacheer Certificate</h1>                
            ...
            <center><a href="samacheer_x_prt.php?sxid=<?php echo $_GET['lid'];?>" target="_blank"><button class="btn btn-small btn-warning" ><img src="img/icons/packs/fugue/16x16/block--arrow.png"> Click Here To Print the Last Created Certificate</button></a></center>
            </div>
            <?php }
			 if($_GET['roll']){ ?>
            <a href="samacheer_x_single.php?bid=<?php echo $bid;?>"><button class="btn btn-small btn-warning" ><img src="img/icons/packs/fugue/16x16/block--arrow.png"> Create Another One</button></a> <?php } ?>
			</div>
            <?php if(!$_GET['roll']){ ?>
            <div class="grid_12">
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Add new X-Samacheer Certificate</h1><span></span>
					</div>
                    ...
                    <div class="_25">
                        ...
                        <div class="_25">
							<p>
                                <label for="textfield">X Marksheet Number : <span class="error">*</span></label>
                                <input id="textfield" name="xmno" class="required" type="text" value="" />
                            </p>
						</div>
						<div class="_25">
							<p>
