		 ...
		 if($_FILES["file"]["size"] > 0)
		 {
			...
			$count=0;
	         while (($emapData = fgetcsv($file, 10000, ",")) !== FALSE)
	         {
				if($count>0){
					$tcnolist=mysql_query("SELECT * FROM tc_no where id=1"); 
								  ...
								  $emisno=$emis['count'];
								  $eno="EMIS".str_pad($emisno, 5, '0', STR_PAD_LEFT);
								  $tno="TC".str_pad($tcno, 5, '0', STR_PAD_LEFT);
	         ...
	         $result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
				...
				header("Location:tc_xi_new.php?bid=$bid&msg=succ");
				}
				$count++;
	         }
	         fclose($file);
    ...
    <div id="main" role="main">    				
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Import Transfer Certificate</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Import Transfer Certificate</h1>                
			<a href="tc_xi.php?bid=<?php echo $bid;?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
             <a href="sample/tc_sample.csv" target="_blank" style="margin:0px 10px 0 0px; float:right;"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/inbox-download.png"> Download Sample File</button></a>
			</div>
            <div class="grid_12">
            <?php $msg=$_GET['msg'];
			if($msg=="succ"){?>			
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Import Transfer Certificate</h1><span></span>
					</div>
