    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover">Staff Management</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
                ...
                <a href="staff_add.php" title="add"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> Add New</button></a>
                 <a href="staff_importdata.php" title="add"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png">Import Staff Datas</button></a>
				 <a href="staff_edit_all.php" title="add"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/table--plus.png">All Staff profile Edit </button></a>
            ...
            <div class="block-border" id="tab-panel-1">
					<div class="block-header">
						...
						<ul class="tabs" style="margin-right:60px;">
							<li><a href="#tab-1">Teaching</a></li>
							<li><a href="#tab-2">Non-Teaching</a></li>
						</ul>
                        <span></span>
					</div>
			  ...
			  while($row=mysql_fetch_array($qry))
        		{ ?>
                                ...
                                <td width="100px">
                                 ...
                                 <a href="staff_edit.php?stid=<?php echo $row['st_id'];?>" title="Edit"><img src="./img/edit.png" alt="edit"></a> <a href="staff_delete.php?stid=<?php echo $row['st_id']; ?>" class="delete" title="delete" onClick="return confirm('are you sure you wish to delete this record');"><img src="./img/del.png" alt="delete"></a>
                ...
                <center> <?php if($row['status']=='1'){ ?>
                        ...
                        <br>
							...
							<tbody>
                            <?php 
							$qry=mysql_query("SELECT * FROM staff WHERE s_type='Non-Teaching' ");
							$count1=1;
			  while($row=mysql_fetch_array($qry))
        		{ ?>
								<tr class="gradeX">
