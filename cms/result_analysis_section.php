     ...
     <?php 
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><a href="board_select_analysis.php" title="<?php echo $board['b_name'];?>"><?php echo $board['b_name'];?></a></li>
				<li class="no-hover">Result Analysis</li>
			</ul>
		...
		<div id="main-content">
            ...
            <a href="board_select_analysis.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
...
${demo.css}
 ...
 // Bring life to the dials
	...
	function change_function() { 
	 ...
	 window.location.href = 'result_analysis_section.php?bid='+cid;	  
	} 
  </script>
  <!-- end scripts-->
