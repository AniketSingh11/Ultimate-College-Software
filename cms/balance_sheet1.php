...
<table class="table table-striped" id="table-example">  
                            ...
                            ?>
                                    ...
                                    <tbody>
                                        <tr>
                                        <th colspan='5'><span style="margin:0px 50px 10px 0px; float:right;"><img src="img/icons/packs/fugue/16x16/calendar-next.png"> Date : <strong> <?php echo $sameday; ?></strong></span></th>
                                        </tr>
                                    ...
                                    /********************** Manager Fees Collection End ******************************/
                                            ...
                                            while ($row5 = mysql_fetch_assoc($qry5)) {
                                                ...
                                                $fgd_id = $row5['fgd_id'];
                                                $fg_amount = 0;
                                                $feeslist2 = mysql_query("SELECT SUM(b.amount) as amount FROM finvoice a, fsalessumarry b WHERE (a.fi_year*10000) + (a.fi_month*100) + a.fi_day between '" . $startdate . "' AND '" . $enddate . "' AND a.c_status!='1' and a.fi_by='$user' AND a.i_status='0' AND a.fi_id=b.fi_id AND b.fgd_id=$fgd_id");
