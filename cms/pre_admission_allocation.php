    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><a href="board_select_admin_select.php" title="<?php echo $board['b_name'];?>"><?php echo $board['b_name'];?></a></li>
		...
		<div id="main-content">
			...
			<div class="grid_12">
                ...
                <a href="board_select_admin_select.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
                <a href="pre_admission_allocat.php?bid=<?php echo $bid;?>" title="add" style="margin:0px 0 0 10px;"><button class="btn btn-orange btn-small "><img src="img/icons/packs/fugue/16x16/user--plus.png">Student Allocation</button></a>
...
function change_function() { 
	 ...
	 if(cid != 'all'){
	  window.location.href = 'pre_admission_allocation.php?cid='+cid+'&bid=<?php echo $bid;?>';	  
	 } else {
	 window.location.href = 'pre_admission_allocation.php?bid=<?php echo $bid;?>';	  
	 }
	} 
	function change_function1() { 
     var bid =document.getElementById('bid').value;
	 window.location.href = 'pre_admission_allocation.php?bid='+bid;	  
	}
	</script> 
