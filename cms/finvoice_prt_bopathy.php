...
<div align="center" id="printablediv" style="width:148mm;">  <!-- ImageReady Slices (Bonafide(1).jpg) -->
  ...
  .block-content-invoice1{
	...
	.total{ float:right; margin-right:50px;}
		...
		<div>
		   <table>
		   <tr>
		   <td style="width:80%;text-align:left;">No. <?php echo $invoice['fr_no'];?><td>
		   
		   <td>Date: <span style="width:100%;"><?php echo $invoice['fi_day']."/".$invoice['fi_month']."/".$invoice['fi_year'];?></span></td>
		   </tr>
		   <tr>
		   <td style="width:80%;text-align:left;">Name: <span style="width:100%;"><?php echo $student1['firstname']." ".$student1['lastname']."(".$student1['admission_number'].")";?></span><td>			  
		   <td>Std: <span style="width:100%;"><?php echo $row['c_name']."-".$row1['s_name'];?></span></td>
		   </tr>
		   </table>
        ...
        <div class="main-table">
			   ...
			   <table style="text-align:center; border-collapse:collapse;">
   			     <thead>
				   <th style="border-left:0 !important;">Items</th>
				   <!--<th>Quantity</th>-->
				   <th style="border-right:0 !important;">Rs.</th>
				   <!--<th style="border-right:0 !important;">Ps.</th>-->
			     </thead>
                 <?php if($method=="Full" || $method=="")  { ?>
			     <tbody>
                    <?php 
					$count=1;
					$myarray = array();
				   ...
				   <tr>
				    <td style="border-bottom:0 !important;border-left:0 !important;">
					    <center><?php 
                            ...
                            if($row5['discount']!="0")
                                echo '<br>Discount Applied Rs '.$row5['discount'].' For '.$row5['discount_remark'];?>
						</center>					   
					</td>
					
					<!--<td></td>-->
					<td style="border-right:0 !important;"><?php echo number_format($amount,2);?></td>
				   ...
				   <?php $count++;}  } ?>
				    ...
				    <tr>
						...
						<!--<td></td>-->
						<td style="border-right:0 !important;"><?php echo number_format($invoice['cheque_service'],2);?></td>
						<!--<td style="border-right:0 !important;"></td>-->
				    </tr>	
				    <?php } ?>
			     </tbody>
				 ...
				 <tfoot>
				    <tr>
				     ...
				     <!--<td style=""></td>-->
				     <td style="border-right:0 !important;"><?php echo number_format($invoice['fi_total'],2);?></td>
				     <!--<td style="border-right:0 !important;"></td>-->
				    </tr>
				 </tfoot>
			   </table>
            ...
            <div style="text-align:left;"> 
                ...
                <p style="text-align:right;">For School/College Management Solution</p>

            </div>

            <div style="text-align:right;">
				<!--<p>Cashier</p>-->
				<p><?php echo $invoice['fi_by'];?></p>
            </div>			
