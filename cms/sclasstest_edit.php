 ...
 if (isset($_POST['submit']))
{
	...
	$bid=$_POST['bid'];
		...
		$sql="UPDATE classtest SET title='$title',day='$date_day',month='$date_month',year='$date_year',detail='$detail',b_id='$bid' WHERE ct_id='$ctid'";

$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
    if($result){
        header("Location:sclasstest_edit.php?cid=$cid&sid=$sid&mid=$mid&subid=$subid&ctid=$ctid&bid=$bid&msg=succ");
    }
    exit;
}
 ...
 <!--! end of #search-bar -->
    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Edit <?php echo $class['c_name']."-".$section['s_name']." (".$month['m_name'].")";?> Class Test <b>(<?php echo $slist['s_name'];?>)</b></h1>                
