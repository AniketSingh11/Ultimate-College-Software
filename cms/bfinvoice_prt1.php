...
function convert_number_to_words($number) {
    ...
    return $string;
                  ...
                  $did=$row5['d_id'];
                  $qry_d=mysql_query("SELECT * FROM driver WHERE d_id=$did"); 
                  $row_d=mysql_fetch_array($qry_d);
...
#invoice .name { font-size: 12px; }
           ...
           <td>Date </td><td><span style="width:100%;"><?php echo $invoice['fi_day']."/".$invoice['fi_month']."/".$invoice['fi_year'];?></span></td>
           </tr>
           <tr>
           <td>Class</td><td><span style="width:100%;"><?php echo $row['c_name']?></span></td>
           <td>Sec</td><td><span style="width:100%;"><?php echo $row1['s_name']?></span></td>
           </tr>
           <tr>
           <td>Name</td><td><span style="width:100%;"><?php echo $student1['firstname']." ".$student1['lastname']."(".$student1['admission_number'].")";?></span></td>
           <td>Roll No</td><td><span style="width:100%;"><?php echo $student1['roll_no'];?></span></td>              
           
           </tr>
           </tr>
           <tr>
           <td>Driver Ph.</td><td><span style="width:100%;"><?php echo $row_d['phone_no'];?></span></td>
            <td>TO Ph.</td><td><span style="width:100%;"><?php echo $row5['r_contact'];?></span></td>
           <td></td>              
...
Rupees <?php $amount=$invoice['fi_total']+$invoice['cheque_service'];
                  ...
                  <span style="float:right; padding-right:40px; margin-top:20px; "><strong><?php //echo $invoice['bfi_by'];?>Signature</strong></span>
                  </div>
                  </td>
                    </tr>
                    </tfoot>
