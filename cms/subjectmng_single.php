 ...
 if (isset($_POST['submit']))
{
	...
	//die();
	$sql="INSERT INTO subjectlist (s_code,s_name,c_id,s_id,b_id,ay_id,paper,s_type,extra_sub) VALUES
('$s_code','$s_name','$cid','$sid','$bid','$acyear','$paper','$stype',$extra)";

$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
    if($result){
        header("Location:subjectmng_single.php?cid=$cid&sid=$sid&bid=$bid&msg=succ");
    }
    exit;
}
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Add Subject</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Add New Subject details (<?php echo $class['c_name']."-".$section['s_name'];?>)</h1>                
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Add New Subject Details</h1><span></span>
					</div>
					<form id="validate-form" class="block-content form" action="" method="post">
						<div class="_50">
							<p>
                                <label for="textfield">Subject Code : <span class="error">*</span></label>
                                <input id="textfield" name="s_code" class="required" type="text" value="" />
                            </p>
						</div>
                        <div class="_50">
							<p>
                        ...
                        <div class="_25">
							<p>
                                ...
                                <select name="s_type">
                                	<option value="0">FA-SA Concept</option>
                        ...
                        <div class="_25">
							<p>
								...
								<label><input type="radio" name="paper" value="0" checked /> None</label>
								<label><input type="radio" name="paper" value="1" /> Two Paper</label>
							</p>
						</div>
                        <?php } ?>
                         <div class="_25">
