 ...
 <!--! end of #search-bar -->
    ...
    <?php 
		...
		<div id="main-content">
			...
			<a href="sboard_select_test.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
			...
			<div class="grid_12">
			  ...
			  while($row=mysql_fetch_array($qry))
				...
				?>
							<li>
								<a href="sclasstest_mng.php?bid=<?php echo $row['b_id']; ?>&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>&subid=<?php echo $row['sub_id'];?>&mid=<?php echo $monthsw['m_id'];?>">
