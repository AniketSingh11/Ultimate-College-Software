 ...
 if (isset($_POST['submit']))
{
	...
	$oldamount=$_POST['oldamount'];
		...
		$sql="UPDATE bank_withdrawl SET date='$date',date_day='$date_day',date_month='$date_month',date_year='$date_year',account_no='$acc_no',b_name='$b_name',withdrawl_by='$withdrawl_by',amount='$amount',ay_id='$acyear' WHERE bc_id='$bcid'";
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Edit Bank withdrawl</li>
			</ul>
