 ...
 <div id="wrapper">
     ...
     <div id="content">		
		 ...
		 <div id="content-header">
			 <h1> Driver Salary Details </h1><?php if($filter){?><span style="float:right; margin-right:30px;"><b>Filter by : </b> Driver Type = <?php echo $filter;?></span><?php } ?>
		 </div>  <!-- #content-header -->	
						 ...
						 <div class="portlet-header">
                            ...
                            <div class="btn-group" style="float:right;">
							  ...
							  <ul class="dropdown-menu" role="menu">
							    ...
							    <li <?php if($filter=="Driver"){ echo 'class="active"';}?>><a href="emp_salary_detail.php?filt=Driver">Driver</a></li>
							    <li <?php if($filter=="Non-Driver"){ echo 'class="active"';}?>><a href="emp_salary_detail.php?filt=Non-Driver">Non-Driver</a></li>
							  </ul>
							</div>
						 </div>  <!-- /.portlet-header -->
