...
<h3>Employee Day Salary Details <?php echo $syear." - ".$eyear;?></h3><br>
...
$cur_Date=date('d');
										...
										$emp_query=mysql_query("select * from staff_daily_salary  where month=$m_value and year=$y_value order by st_ms_id desc");
...
$fixed=$salarylist['salary'];
		...
		?>                             
										 <tr>
                                             ...
                                             <td><?php if($emp_display['d_total']!='0'){ echo $emp_display['d_total']; } else { echo "-"; }?></td>
