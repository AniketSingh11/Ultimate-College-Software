...
?>
		 <div id="content-header">
			 <h1> <?php echo $staffs['fname']." ".$staffs['lname'];?> - Salary Details <a href="emp_details_list.php"><button type="button" class="btn btn-success"> <i class="fa fa-angle-double-left"></i> Back</button></a></h1>
		 </div>  <!-- #content-header -->	
...
?>
				 ...
				 <div class="col-md-12">
					 ...
					 <div class="portlet">
						 ...
						 <div class="portlet-header">
                             ...
                             <a href="emp_salary_add.php?id=<?php echo $stid;?>" title="Add Employee Salary"><button type="button" class="btn btn-warning">Add Employee Salary</button></a>
                         </div>  <!-- /.portlet-header -->
						 ...
						 <div class="portlet-content">						
							...
							>
									...
									<tbody>
										<?php	
											$emp_query="select * from staff_salary where st_id=$stid order by id desc";										
		...
		?>                             
                                ...
                                <button class="btn btn-small btn-success" >Active</button><?php }else{?><button class="btn btn-small btn-gray" >Inactive</button> <?php } ?>
											 ...
											 <td><a title="view" href="#styledModal<?php echo $emp_count.''.$emp_id;?>" data-toggle="modal"><img src="img/layout/view.png"/></a><a title="edit" href="emp_salary_edit.php?id=<?php echo $emp_id; ?>&stid=<?php echo $stid; ?>"><img src="img/layout/edit.png"/></a> <a title="delete" href="emp_salary_delete.php?id=<?php echo $emp_id; ?>&stid=<?php echo $stid; ?>" onClick="return confirm('are you sure you wish to delete this record');"><img src="img/layout/delete.png"/></a> </td>
										 </tr>
		<?php 
		$emp_count++;
        }
