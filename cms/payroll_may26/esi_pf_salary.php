					 ...
					 <div class="portlet">
						 ...
						 <div class="portlet-content">
							...
							>
								  ...
								  //echo "SELECT a.* FROM staff_month_salary a, staff_month_salary_summary b WHERE a.month=$m_value AND a.year=$y_value AND a.st_ms_id = b.st_ms_id AND b.ad_id IN (".implode(',',$myarray).") AND b.pevalue";
