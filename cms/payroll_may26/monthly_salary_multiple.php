...
//die();
	...
	$emp_query1="select * from staff_allw_ded where type='Deductions' order by id asc";
                                      ...
                                      $query1="insert into staff_month_salary_summary(st_ms_id,st_id,o_id,d_id,name,amount,type,ad_id,pevalue)values('$lastid','$stid','$oid','$did','$dname','$d_salary','1','$emp_id1','$pevalue')"; 
                                        }else{
                                   
										$query1="insert into staff_month_salary_summary(st_ms_id,st_id,o_id,d_id,name,amount,type,ad_id,pevalue)values('$lastid','$stid','$oid','$did','$dname','0','1','$emp_id1','$pevalue')";
										}
										$result1=mysql_query($query1);
										$deduc=0;
                                    $emp_count1++;
