                                  ...
                                  <th><center>Gender</center></th>
                                    ...
                                    <?php
									  ...
									  if($d_type)
									  {
										...
										$qry=mysql_query("SELECT * FROM driver where d_type='$d_type' and s_type='1' ORDER BY fname asc");	
										
									  }
									  else
									  {
										  $qry=mysql_query("SELECT * FROM driver where s_type='1' ORDER BY fname asc");	
									  }
							$count=1;
