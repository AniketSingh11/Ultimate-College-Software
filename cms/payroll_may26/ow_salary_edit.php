...
$oid=$_GET['oid'];
  ...
  foreach($_POST['deduction'] as $value1)
  {
	...
	if($query)
	{
		header("location:ow_salary_edit.php?id=$id&oid=$oid&msg=succ");		
	}
	else
	{
		header("location:ow_salary_edit.php?id=$id&oid=$oid&msg=err");		
	}
 ...
 <div id="wrapper">
     ...
     <div id="content">	
		 <div id="content-header">
			 <h1> <?php echo $staffs['fname']." ".$staffs['lname'];?> - Salary Details Edit <a href="ow_salary_list.php?id=<?php echo $oid;?>"><button type="button" class="btn btn-success"> <i class="fa fa-angle-double-left"></i> Back</button></a></h1>
		 </div>  <!-- #content-header -->	
