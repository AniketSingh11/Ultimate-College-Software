...
//$gross_total=$fixed*$salarylistt[0];
	...
	/*********************** Calculation *******************************/						
							echo '
				<div class="clear"></div><div class="col-sm-12"> <p class="title">Salary Details :</p><div class="form-group"><label for="name"><font color="red">'.$mon.' Month working days count :  '.$salarylistt[0].'  </font></label></div>
			<div class="form-group"><label for="name"><font color="red">One-day salary :  '.$fixed.'  </font></label></div>
			<div class="form-group"><label for="name"><font color="red">Total salary :  '.$fixed.' * '.$salarylistt[0].' = '.$gross_total.'</font></label></div>
