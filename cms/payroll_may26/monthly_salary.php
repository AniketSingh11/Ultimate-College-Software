						 ...
						 <div class="portlet-content">
							...
							?>                             
										 <tr>
                                             ...
                                             <td><a title="view" href="#styledModal<?php echo $emp_count.''.$emp_id;?>" data-toggle="modal"><img src="img/layout/view.png"/></a> <a title="Print" href="monthly_salary_print.php?id=<?php echo $emp_id; ?>&stid=<?php if($st_id){ echo $st_id."&type=st";}else if($o_id){ echo $o_id."&type=ow";}else if($d_id){ echo $d_id."&type=dr";}?>" target="_blank"><img src="img/layout/print.png"/></a>
        ...
        ?>							
                         ...
                         <div class="portlet-content">
							...
							>
									...
									<tbody>
										<?php	
											$emp_query="select t1.staff_id,t1.fname,t1.s_type,t1.email,t1.phone_no,t1.position from staff t1 LEFT JOIN staff_month_salary t2 ON t1.st_id = t2.st_id AND t2.month=$m_value AND t2.year=$y_value WHERE t2.st_id IS NULL AND t1.status='1'";
							$emp_result=mysql_query($emp_query);
							$emp_count=1;
							while($emp_display=mysql_fetch_array($emp_result))
							{
