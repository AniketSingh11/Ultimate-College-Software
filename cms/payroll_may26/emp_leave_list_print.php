...
<img src="../img/printer.png"></a>Teaching Category : <span class="error">*</span></label>
                               <select id="s_type" name="s_type" onChange="stafftype()" class="required">
                                ...
                                <option value="Teaching" <?php if($_GET['s_type']=="Teaching"){ echo "selected"; }?>>Teaching</option>
                                  <option value="Non-Teaching" <?php if($_GET['s_type']=="Non-Teaching"){ echo "selected"; }?>>Non_Teaching</option>
...
<h3><?php
if($s_type=="Teaching")
echo "Employee Leave Details List";
                                  ...
                                  <th><center>Email</center></th>
                                    ...
                                    <?php
									  ...
									  if($s_type)
									  {
										...
										$qry=mysql_query("SELECT * FROM staff where s_type='$s_type' ORDER BY fname ASC");	
										
									  }
									  else
									  {
										  $qry=mysql_query("SELECT * FROM staff ORDER BY fname ASC");	
									  }
							$count=1;
...
// Code that uses other library's $ can follow here.
  ...
  <script type="text/javascript">
	...
	function change_function() { 
	 ...
	 window.location.href = 'emp_leave_list_print.php?s_type='+s_type;	  
	} 
  </script>
  <!-- end scripts-->
...
//alert(s_type);
window.location.href="emp_leave_list_print.php?s_type="+document.getElementById('s_type').value;
