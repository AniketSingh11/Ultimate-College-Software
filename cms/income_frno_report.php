		...
		<div id="main-content">
            ...
            <div class="block-border">
             ...
             <?php 
					...
					$qry1="SELECT * FROM finvoice WHERE (fr_no >=" . $s_erno. " AND fr_no <=" . $e_erno. ") AND ay_id=$acyear and c_status!='1' ";
			  ...
			  while($row1=mysql_fetch_array($qry1))
               ...
               <span style="margin-left:20px;"><a href="frincome_export.php?s_erno=<?php echo $s_erno;?>&e_erno=<?php echo $e_erno;?>&b_id=<?php echo $bid;?>&ayid=<?php echo $acyear;?>" style="width:100px"><button class="btn btn-small btn-green"><img src="img/icons/packs/fugue/16x16/inbox-download.png"> Download Report</button></a></span>
				...
				<div class="block-border">
					...
					<div class="block-content">
						<table id="table-example" class="table">
							...
							<tbody>
                            <?php 
							$qry="SELECT * FROM finvoice WHERE   c_status!='1' and (fr_no >=" . $s_erno. " AND fr_no <=" . $e_erno. ")";
