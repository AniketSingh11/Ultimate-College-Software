 ...
 if (isset($_POST['submit']))
{
	...
	$qry1=mysql_query("select * from c_attend where ay_id='$acyear' and admin_no='$admin_no' ");
	...
	if(mysql_num_rows($qry1)!=0){
	    ...
	    $adminlist=mysql_query("SELECT * FROM certificate_count WHERE cc_id='4'");
	    ...
	    $sql1=mysql_query("UPDATE certificate_count SET count='$refno2' WHERE cc_id='4'");
	}
		
		$sql="INSERT INTO c_attend (admin_no,name,standard,year,percent,work,ay_id,purpose,ref_number,c_date) VALUES
('$admin_no','$name','$standard','$year','$percent','$work','$acyear','$purpose','$ref_number','$c_date')";

$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
$lastid=mysql_insert_id();

    if($result){		
     header("Location:c_attend_add.php?lid=$lastid&msg=succ");	   
    }
    exit;
}
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Add New Attendance Certificate</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Add New Attendance Certificate</h1>                
            ...
            <center><a href="c_attend_prt.php?cattid=<?php echo $_GET['lid'];?>" target="_blank"><button class="btn btn-small btn-warning" ><img src="img/icons/packs/fugue/16x16/block--arrow.png"> Click Here To Print the Last Added Certificate</button></a></center>
            </div>
            <?php } ?>
            
				<div class="block-border">
					<div class="block-header">
						<h1>Add New Attendance Certificate</h1><span></span>
					</div>
...
<div id="suggestionsList" class="suggestionList"></div>
                        ...
                        <div class="_50">
							<p>
                                ...
                                <input id="percent" name="percent" class="required" type="text" value="" />
                            </p>
						</div>
                        <div class="_50">
							<p>
                                <label for="textfield">No of Working Days</label>
                                <input name="work" id="work" type="text" value="" />
                            </p>
						</div>
  ...
  <!-- end scripts-->
   <script type="text/javascript">
    ...
    function fill(thisValue,s,p,std,y,d,c,g,ci,per,w) {
