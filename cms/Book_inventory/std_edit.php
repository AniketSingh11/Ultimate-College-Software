...
if (isset($_POST['submit']))
{
	...
	$cid=$_POST['cid'];
		...
		$qry=mysql_query("UPDATE class SET c_name='$c_name' WHERE c_id='$cid'");
    if($qry){
        header("Location:std_edit.php?cid=$cid&msg=succ");
    }
    exit;
}
						...
						<div class="widget-content">
							...
							<form class="form uniformForm validateForm" method="post" action="" >
								...
								<div class="field-group">
									...
									<div class="field">
										<input type="text" name="cname" id="cname" size="20" value="<?php echo $class['c_name']; ?>" class="validate[required]" />	
									</div>
								</div> <!-- .field-group -->
								<div class="actions">		
