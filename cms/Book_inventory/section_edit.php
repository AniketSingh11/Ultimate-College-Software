...
if (isset($_POST['submit']))
{
	...
	$sid=$_POST['sid'];
		...
		$qry=mysql_query("UPDATE section SET s_name='$s_name' WHERE s_id='$sid'");
    if($qry){
			...
			<div class="grid-24">
				...
				<div class="widget">
						...
						<div class="widget-content">
							...
							$sid=$_GET['sid'];
							$cid=$_GET['cid'];
							$classlist=mysql_query("SELECT * FROM section WHERE s_id=$sid"); 
							...
							<form class="form uniformForm validateForm" method="post" action="" >
								...
								<div class="field-group">
									...
									<div class="field">
										<input type="text" name="sname" id="sname" size="20" value="<?php echo $class['s_name']; ?>" class="validate[required]" />	
									</div>
								</div> <!-- .field-group -->
								<div class="actions">		
                                <input type="hidden" class="medium" name="cid" value="<?php echo $class['c_id'];?>" > 
