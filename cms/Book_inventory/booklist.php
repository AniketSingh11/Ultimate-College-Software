...
<div id="wrapper">
	...
	<div id="content">		
		...
		<div id="contentHeader">
			<h1>Book and Things Management</h1>
		</div> <!-- #contentHeader -->	
        ...
        <div class="grid-24">
				...
				<div class="widget">
						...
						<div class="widget-content">
							...
							<form class="form uniformForm validateForm" method="get" action="booklist.php" >
        ...
        <div class="notify notify-success">						
            ...
            <div class="grid-24">
				...
				<div class="widget widget-table">
						...
						<div class="widget-header">
                        <a href="booklist_new.php?cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>" style="margin:3px 0 0 20px;"><button class="btn btn-orange ">Add New</button></a>
							<span class="icon-list"></span>
							<h3 class="icon chart"><?php
							 	  echo $class['c_name'];
							    if($class_name=="XI STD" || $class_name=="XI" || $class_name=="XII STD" || $class_name=="XII"){ 	  echo "-".$section['s_name']; }?> Books and Things Details </h3>
                       </div>
