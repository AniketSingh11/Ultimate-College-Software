        ...
        <div class="notify notify-success">						
			...
			<div class="grid-24">
				...
				<div class="widget widget-table">
                        ...
                        <a href="notebook_al_new.php" style="margin:3px 0 0 20px;"><button class="btn btn-success ">Add New</button></a>
						...
						<tbody>
                        <?php 
							$qry=mysql_query("SELECT * FROM book Where type='N' AND brdid=$brdid AND ay_id=$acyear");
							$count=1;
				...
				?>
							<tr class="gradeA">
                                ...
                                <td><?php echo $agencylist['a_name']; ?></td>
                                 <td class="action"><a href="notebook_al_edit.php?bid=<?php echo $row['b_id'];?>" title="Edit"><img src="./images/edit.png" alt="edit"></a> <a href="notebook_al_delete.php?bid=<?php echo $row['b_id']; ?>" class="delete" title="delete" onClick="return confirm('are you sure you wish to delete this record');"><img src="./images/del.png" alt="delete"></a></td>
							</tr>	
                            <?php // } } 
							$count++;
							} ?>																						
