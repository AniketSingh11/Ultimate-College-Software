        ...
        <div class="notify notify-success">						
			...
			<div class="grid-24">
				...
				<div class="widget widget-table">
                        ...
                        <a href="std_new.php" style="margin:3px 0 0 20px;"><button class="btn btn-success ">Add New</button></a>
			  ...
			  while($row=mysql_fetch_array($qry))
        		{ ?>
							<tr class="gradeA">
								...
								<td><a href="section.php?cid=<?php echo $row['c_id'];?>"><button class="btn btn-primary btn-small">View</button></a></td>
								 <td class="action"><a href="std_edit.php?cid=<?php echo $row['c_id'];?>" title="Edit"><img src="./images/edit.png" alt="edit"></a> <a href="std_delete.php?cid=<?php echo $row['c_id']; ?>" class="delete" title="delete" onClick="return confirm('are you sure you wish to delete this record');"><img src="./images/del.png" alt="delete"></a></td>
							</tr>	
                            <?php // } } 
							$count++;
							} ?>																						
