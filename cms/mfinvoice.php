    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover"><a href="mbilling.php?bid=<?php echo $bid;?>" title="Fees Payment">Fees Paymant </a></li> 
                <li> Fees Invoice </li>
			</ul>
...
function clear_cart(){
	if(confirm('Are You Reject this Bill invoice, continue?')){
		...
		window.location.href='mfinvoice.php?fiid=<?=$ffi_id."&bid=".$bid?>&del_succ=delete';
