							  ...
							  while($row1=mysql_fetch_assoc($qry1))
								{
									   ...
									   $slist=mysql_fetch_assoc($subjectlist1);
									   $subjectype=$slist['s_type'];
$objPHPExcel->getActiveSheet()->getColumnDimension('D')->setWidth(5);cellFont("D2","Cambria");
$objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, $slist['s_name']);$column++;$count++;
}

$objPHPExcel->getActiveSheet()->getColumnDimension('J')->setWidth(10);cellFont("J2","Cambria");
$objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, "Total");$column++;

$objPHPExcel->getActiveSheet()->getColumnDimension('K')->setWidth(10);cellFont("K2","Cambria");
$objPHPExcel->getActiveSheet()->setCellValue($column.$rowCount, "result");$column++;

$objPHPExcel->getActiveSheet()->getColumnDimension('L')->setWidth(10);cellFont("L2","Cambria");
...
$rowCount++;
	...
	/*****************************************sheet 2 *************************************************/
$name=$class['c_name']."-".$section['s_name']."-".$exam['e_name'];
