 ...
 if (isset($_POST['submit']))
{
	 ...
	 $qry=mysql_query("select * from vehicle_trip where v_id='$v_id' and v_date='$v_date'");
 ...
 $sql="INSERT INTO vehicle_trip (v_id,r_id,v_date,start_km,end_km,fuel_fill,fuel_amount,date) VALUES
 ('$v_id','$r_id','$v_date','$start_km','$end_km','$fuel_fill','$fuel_amount','$date')";

$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
    if($result){
        header("Location:vehicle_tripadd.php?msg=succ");
    }
    exit;
	  }else{
	     
	      header("Location:vehicle_tripadd.php?msg=error");
	 }
}
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Add New Vehicle Trip</li>
			</ul>
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Add New Vehicle Trip</h1><span></span>
					</div>
						 ...
						 <div class="_50">
							<p>
								<label for="select">Date: <span class="error">*</span></label>
								   ...
								   <input  id="datepicker" style="width:470px;" name="v_date"  class="required" type="text" value="" />
							</p>
						</div>
						<div class="clear"></div>
                        <div class="_50">
							<p>
								<label for="select">Vehicle No : <span class="error">*</span></label>
                                	<?php
                                            ...
                                            echo '<select name="v_id" id="v_id" style="width:470px;" class="required"> <option value="">Select Vehicle No</option>';
							...
							<p>
								<label for="select">Root master: <span class="error">*</span></label>
                                	<?php
                                            ...
                                            $result1 = mysql_query($classl) or die(mysql_error());
                                            echo '<select name="r_id[]" style="width:470px;"  multiple="multiple" id="r_id" class="required">';
											while ($row1 = mysql_fetch_assoc($result1)):
                        ...
                        <div class="_50">
							<p>
								<label for="select">Today  Start Km: <span class="error">*</span></label>
								   ...
								   <input id="textfield" name="start_km" class="required" type="text" value="" />
							</p>
						</div>
						 ...
						 <div class="_50">
							<p>
								<label for="select">Today  End Km: <span class="error">*</span></label>
								   ...
								   <input id="textfield" name="end_km" class="required" type="text" value="" />
							</p>
						</div>
						...
						<div class="_50">
							<p>
								<label for="select">Fuel Filling Details:</label>
								   ...
								   <input id="textfield" name="fuel_fill"  type="text" value="" />
							</p>
						</div>
						...
						<div class="_50">
							<p>
								<label for="select">Amount:</label>
								   ...
								   <input id="textfield" name="fuel_amount"  type="text" value="" />
							</p>
						</div>
