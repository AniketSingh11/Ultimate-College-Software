    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><a href="mboard_select_chequeinvoice.php" title="<?php echo $board['b_name'];?>"><?php echo $board['b_name'];?></a></li>
		...
		<div id="main-content">
			...
			<div class="grid_12">
                ...
                <a href="mboard_select_chequeinvoice.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
                ...
                <div class="alert success"><span class="hide">x</span>Your Record Successfully Deleted !!!</div>
                 <?php } 
				  $qry1=mysql_query("SELECT * FROM mfinvoice WHERE bid=$bid AND ay_id=$acyear and fi_ptype='cheque' AND i_status!=1 AND c_status!=1");
							$total=0;
            ...
            <div class="grid_12">
				<div class="block-border">
					...
					<div class="block-content">
						<table id="table-example" class="table">
							...
							<tbody>
                            <?php 
							$qry=mysql_query("SELECT * FROM mfinvoice WHERE bid=$bid AND ay_id=$acyear and  fi_ptype='cheque' AND i_status!=1");
							$count=1;
			  while($row=mysql_fetch_array($qry))
				...
				?>
								...
								<td class="view"><center><a href="mchequefeesinvoice_detail.php?fiid=<?php echo $row['fi_id'];?>&bid=<?php echo $bid;?>"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> Edit</button></a></center></td>
								</tr>
								 <?php 
							$count++;
							} ?>                               																
...
// Code that uses other library's $ can follow here.
  ...
  <script type="text/javascript">
	...
	function change_function() { 
	 ...
	 window.location.href = 'mcheque_feesinvoice.php?bid='+cid;	  
	} 
  </script>
  <!-- end scripts-->
