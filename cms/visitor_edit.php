 ...
 if (isset($_POST['submit']))
{
	...
	$itime=mysql_real_escape_string($_POST['itime']);
	$otime=mysql_real_escape_string($_POST['otime']);
	$mobile=mysql_real_escape_string($_POST['mobile']);
	$reason=mysql_real_escape_string($_POST['reason']);
	$remark=mysql_real_escape_string($_POST['remark']);
		
		$qry=mysql_query("UPDATE visitor SET name='$name',date='$date',i_time='$itime',o_time='$otime',reason='$reason',remark='$remark',ay_id='$acyear',mobile='$mobile' WHERE id='$nid'");
    if($qry){
		$msg="succ";
    }
}
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover"><a href="visitor.php" title="Visitor Management">Visitor Management</a></li>
                <li class="no-hover">Edit Visitor</li>
			</ul>
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Edit Visitor</h1><span></span>
					</div>
                    <?php 
							
							$classlist=mysql_query("SELECT * FROM visitor WHERE id=$nid"); 
					...
					<form id="validate-form" class="block-content form" action="" method="post">
                        ...
                        <div class="_25">
							<p>
                                ...
                                <input id="itime" name="itime" class="required" type="text" value="<?php echo $class['i_time']; ?>" />
                            </p>
						</div>
                        <div class="_25">
							<p>
                                <label for="textfield">Out Time <span class="error">*</span></label>
                                <input id="otime" name="otime" class="required" type="text" value="<?php echo $class['o_time']; ?>" />
                            </p>
						</div>
                        <div class="_25">
							<p>
                                <label for="textfield">Contact No <span class="error">*</span></label>
                                <input id="textfield" name="mobile" class="required" type="text" value="<?php echo $class['mobile']; ?>" />
                            </p>
						</div>
                        <div class="_25">
							<p>
                                <label for="textfield">Reason <span class="error">*</span></label>
                                <input id="textfield" name="reason" class="required" type="text" value="<?php echo $class['reason']; ?>" />
                            </p>
						</div>
                        <div class="_50">
							<p>
                            <label for="textarea">Remarks: </label>
                            <textarea id="textarea" name="remark" rows="5" cols="40"><?php echo $class['remark']; ?></textarea>
                            </p>
						</div>
						<div class="clear"></div>
