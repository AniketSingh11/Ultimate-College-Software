 ...
 <!--! end of #search-bar -->
    ...
    <?php 
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><a href="board_select_idcard.php" title="<?php echo $board['b_name'];?>"><?php echo $board['b_name'];?></a></li>
				<li class="no-hover">ID Card Generator</li>                
			</ul>
		...
		<div id="main-content">
            ...
            <a href="board_select_idcard.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
            ...
            <div class="block-border">
					...
					<form id="validate-form" class="block-content form" action="idcard_prt.php" target="_blank" method="GET">
						<div class="_50">
							<p>
  ...
  <script type="text/javascript">
	...
	function change_function() { 
	 ...
	 window.location.href = 'idcard.php?bid='+cid;	  
	} 
  </script>
  <!-- end scripts-->
