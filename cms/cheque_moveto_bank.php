 ...
 if (isset($_POST['submit']))
{
    ...
    { 
	 $fiid=$selectedOption;
	 $invoicelist1=mysql_query("SELECT * FROM finvoice WHERE fi_id=$fiid"); 
								  $invoice=mysql_fetch_array($invoicelist1);
								  $oldamount=$invoice['fi_total'];
	 $cashqry=mysql_query("UPDATE finvoice SET ba_id='$baid',c_status='2' WHERE fi_id=$fiid");
 ...
 <!--! end of #search-bar -->
    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<a href="cheque_feesinvoice.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
				...
				<div class="block-border">
                    ...
                    <p>
                   		<select name="ms_example[ ]" multiple="multiple" id="msc" class="required">
                            ...
                            $select_record1=mysql_query("SELECT * FROM finvoice WHERE bid=$bid AND ay_id=$acyear and fi_ptype='cheque' AND i_status='0' AND ba_id='0'");
