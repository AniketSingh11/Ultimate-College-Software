		...
		<div id="main-content">
            ...
            <div class="block-border">
					...
					<form id="validate-form" class="block-content form" action="" method="get" action="">
                        ...
                        <div class="_25">
							<p>
								<label for="select">End FR Number : <span class="error">*</span></label>
             ...
             <?php 
					...
					$qry1="SELECT * FROM mfinvoice WHERE (fr_no >=" . $s_erno. " AND fr_no <=" . $e_erno. ") AND ay_id=$acyear and c_status!='1' AND i_status='0' ";
			  ...
			  while($row1=mysql_fetch_array($qry1))
                ...
                <h1> Income Report Based FR.No</h1>
                <span style="">Board Name : <strong><?php if($bid=='All'){ echo "All";}else{ echo $board['b_name']; }?></strong></span>
               <span style="margin-left:20px;"><a href="mfrincome_export.php?s_erno=<?php echo $s_erno;?>&e_erno=<?php echo $e_erno;?>&b_id=<?php echo $bid;?>&ayid=<?php echo $acyear;?>" style="width:100px"><button class="btn btn-small btn-green"><img src="img/icons/packs/fugue/16x16/inbox-download.png"> Download Report</button></a></span>
				...
				<div class="block-border">
					...
					<div class="block-content">
						<table id="table-example" class="table">
							...
							<tbody>
                            <?php 
							$qry="SELECT * FROM mfinvoice WHERE  c_status!='1' AND i_status='0' and (fr_no >=" . $s_erno. " AND fr_no <=" . $e_erno. ") AND ay_id='$acyear' ";
