 ...
 if (isset($_POST['submit']))
{
	...
	$address=$_POST['address'];
		...
		$sql="INSERT INTO bank_account (name,account_no,b_name,address) VALUES
('$name','$a_no','$b_name','$address')";
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Add New Bank Account</li>
			</ul>
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Add New Bank Account</h1><span></span>
					</div>
					<form id="validate-form" class="block-content form" action="" method="post">
                        ...
                        <div class="_50">
							<p>
                                ...
                                <input id="textfield1" name="a_no" class="required" type="text" value="" />
                            </p>
						</div>
                        <div class="_25">
							<p>
                                <label for="textfield">Bank Name <span class="error">*</span></label>
                                <input id="textfield2" name="b_name" class="required" type="text" value="" />
                            </p>
						</div>
                        <div class="_50">
							<p>
                                <label for="textfield">Address</label>
                                <textarea id="textarea" name="address" rows="4" cols="40"></textarea>
                            </p>
						</div>
						<div class="clear"></div>
