    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover"><?php if($cid){ echo $class['c_name']." - "; }?> Inactive Student List</li>                
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
                ...
                <h1><?php if($cid){ echo $class['c_name']." - "; }?> Inactive Student List</h1>
                <a href="student_inactive_export.php?<?php echo "cid=".$cid."&bid=".$bid."&acid=".$acyear;?>" target="_blank"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/inbox-download.png"> Download Report</button></a>
			</div>
            <div class="grid_12">
...
function change_function() { 
	 ...
	 if(cid != 'all'){
	  window.location.href = 'student_inactive.php?cid='+cid+'&bid=<?php echo $bid;?>';	  
	 } else {
	 window.location.href = 'student_inactive.php?bid=<?php echo $bid;?>';	  
	 }
	}
