...
('$stid','$title','$msg','$todaydate','$acyear','1','staff')");
	 if($sql){
		 	 header("Location:toadmin_feedback.php?msg=succ");		 	 
	 }else{
		 header("Location:toadmin_feedback.php?msg=err");
	 }
 }
 ?>
</head>
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Admin Feedback Details / Reply</li>                
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Admin - Feedback Details and Reply</h1>                                  
			</div>
            <div class="grid_12">
				<div class="block-border">
					<div class="block-header">
                    	<h1>Admin Feedback Details and Reply</h1>                        <span></span>
					</div>
					...
					{ 
					 $sfid=$subject3['sf_id'];
					 $sql=mysql_query("UPDATE sfeedback SET status='0' WHERE sf_id='$sfid' AND send='admin'");
					//$stid=$subject3['st_id'];
					$send=$subject3['send'];
					?>
                  <tr style="border:1px solid #C1C0C0;">
                      <td width="150px;">
                          <?php if($send=="admin"){ echo "<strong>Admin<br></strong><span style=' font-size:12px'>".$subject3['date']."</span> "; } else { echo "<strong> You </strong><br>".$subject3['date']."";}?>                      </td>
