           ...
           ?>
				...
				?>
                        ...
                        <tr>
							...
							<?php if($invoice['fi_total']==NULL || $invoice['fi_total']==0) { ?>
                ...
                <input type="submit" value="Print Discount Receipt" name="Print" onClick="window.open('fundinvoice_prt_others.php?fiid=<?php echo $ffi_id; ?>&type=new')"  class="btn btn-warning" style="width:150px">&nbsp;&nbsp;
                <?php } ?>
...
function clear_cart(){
	if(confirm('Are You Reject this Bill invoice, continue?')){
		...
		window.location.href='finvoice_others.php?fiid=<?=$ffi_id?>&del_succ=delete';
