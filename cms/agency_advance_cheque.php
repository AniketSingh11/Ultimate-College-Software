                    ...
                    <div class="grid_12">
                        <div class="block-border">
                            ...
                            <div class="block-content">
                                <table id="table-example" class="table">
                                    ...
                                    <tbody>
                                        <?php
                                        $qry = mysql_query("SELECT * FROM agency left join agency_advance on(agency_advance.a_id = agency.a_id) where p_type='cheque'");
                                        $count = 1;
						...
						if($c_status==0 || $c_status==2 ){				    
							...
							$cstat="error";
                                        ...
                                        <td class="action">
                                            <!--<a href="agency_advance_view.php?aid=<?php echo $row['adv_id']; ?>" title="View"><img src="./img/detail.png" alt="view"></a>-->
                                            <a href="agency_advance_cheque_edit.php?aid=<?php echo $row['adv_id']; ?>" title="Edit"><img src="./img/edit.png" alt="edit"></a> 
