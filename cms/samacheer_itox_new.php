    ...
    <div id="main" role="main">    				
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Import I to IX Samacheer Certificate</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Import I to IX Samacheer Certificate</h1>                
			<a href="samacheer_itox.php?bid=<?php echo $bid;?>" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
             <a href="sample/samacheer_itox_sample.csv" target="_blank" style="margin:0px 10px 0 0px; float:right;"><button class="btn btn-small btn-success" ><img src="img/icons/packs/fugue/16x16/inbox-download.png"> Download Sample File</button></a>
			</div>
            <div class="grid_12">
            <?php $msg=$_GET['msg'];
			if($msg=="succ"){?>			
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Import I to IX Samacheer Certificate</h1><span></span>
					</div>
