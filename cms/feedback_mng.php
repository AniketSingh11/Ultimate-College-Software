 ...
 <!--! end of #search-bar -->
    ...
    <?php 
		...
		<div id="main-content">
            ...
            <a href="board_select_feedback.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
			  ...
			  while($row1=mysql_fetch_array($qry1))
        		{
					if(!$subid){
						$subid1=$row1['sub_id'];
						header("Location:feedback_mng.php?cid=$cid&sid=$sid&subid=$subid1&bid=$bid");
						exit;
					}
					$slid=$row1['sl_id'];
					...
					?>
                 <a href="feedback_mng.php?cid=<?php echo $cid;?>&sid=<?php echo $sid;?>&subid=<?php echo $row1['sub_id']; ?>&bid=<?php echo $bid;?>" style="margin:0px 0 0 10px;"><button class="btn btn-small btn-error" ><img src="img/icons/packs/fugue/16x16/table--plus.png"> <?php echo $slist['s_name']; ?></button></a>
                <?php } ?>
                <br>                                 
			</div>
            ...
            <div class="grid_12">
			  ...
			  while($row=mysql_fetch_array($qry))
				...
				?>
                                ...
                                <?php $select_record2=mysql_query("SELECT * FROM feedback WHERE c_id=$cid AND s_id=$sid AND st_id=$stid AND ay_id=$acyear AND p_id=$pid");						
								$unread=0;
					...
					{ $unread++;
                                ...
                                <td><center><?php echo $unread; ?></center></td>
                                 ...
                                 <center><a href="student_mng_feedback.php?bid=<?php echo $bid; ?>&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>&ssid=<?php echo $ssid; ?>&pid=<?php echo $pid; ?>&stid=<?php echo $stid; ?>&subid=<?php echo $subid; ?>"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> View</button></a></center>
                                 </td>
								</tr> 
                                 <?php 
							$count++;
...
// Code that uses other library's $ can follow here.
  ...
  <script type="text/javascript">
	...
	function change_function() { 
	 ...
	 window.location.href = 'feedback_mng.php?bid='+cid;	  
	} 
  </script>
  <!-- end scripts-->
