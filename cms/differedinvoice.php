    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover">Differed Income List</li>
			</ul>
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Differed Income List</h1>
                <a href="board_select_differed.php" style="margin:3px 0 0 20px;"><button class="btn btn-small btn-primary"><img src="img/icons/packs/fugue/16x16/arrow-curve-180-double.png"> Back </button></a>
                ...
                <div class="alert success"><span class="hide">x</span>Your Record Successfully Deleted !!!</div>
                 <?php } 
				  $qry1=mysql_query("SELECT * FROM finvoice WHERE bid=$bid AND ay_id=$acyear and c_status!='1' order by fi_id desc");
							$total=0;
            ...
            <div class="grid_12">
						...
						<table id="table-example" class="table">
							<thead>
								<tr>
                                    ...
                                    <th>Student type</th>
                                    <th>Inovice By</th>
                                    <th>Differed Amount</th>
                                    <th>Inovice Detail</th>
								</tr>
							</thead>
							<tbody>
                            <?php 
							$qry=mysql_query("SELECT * FROM finvoice WHERE bid=$bid AND ay_id=$acyear and c_status!='1' order by fi_id desc");
							$count=1;
							$tdiffer_amount=0;
			  while($row=mysql_fetch_array($qry))
				...
				?>			<tr class="gradeX">
								...
								<td class="view"><center><a href="feesinvoice_detail1.php?fiid=<?php echo $row['fi_id'];?>&bid=<?php echo $bid;?>"><button class="btn btn-primary btn-small"><img src="img/icons/packs/fugue/16x16/pictures-stack.png"> View</button></a></center></td>
								 <?php 
							$count++;
							  } }
							} ?>                               																
...
// Code that uses other library's $ can follow here.
  ...
  <script type="text/javascript">
	...
	function change_function() { 
	 ...
	 window.location.href = 'differedinvoice.php?bid='+cid;	  
	} 
  </script>
  <!-- end scripts-->
