                        ...
                        <div class="widget-content">
                            ...
                            <div class="dashboard_report first activeState">
                                <div class="pad">
                                    ...
                                    $student=mysql_query("SELECT * FROM student WHERE ay_id=$acyear AND user_status='1'");
                                    $num_rows3 = mysql_num_rows($student);
                                    ?>
                    ...
                    if ($_GET['cid'] && $_GET['sid']) {
                        ...
                        <div class="widget widget-table">
                            ...
                            <div class="widget-header">
                                ...
                                <h3 class="icon chart"><?php echo $class['c_name'] . "-" . $section['s_name']; ?> Books and Things Details </h3>
                            </div>
