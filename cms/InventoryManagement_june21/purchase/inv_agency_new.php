...
if (isset($_POST['submit']))
{
	...
	$mobile=$_POST['mobile'];
		...
		$sql="INSERT INTO inv_agency (agency_name,agency_addr,agency_cperson,agency_cno) VALUES
('$aname','$address','$person','$mobile')";

$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
    if($result){
        header("Location:inv_agency_new.php?msg=succ");
    }
    exit;
}
						...
						<div class="widget-content">
                            ...
                            <div class="field-group">
                                ...
                                <div class="field-group">
									...
									<div class="field">
										<input type="text" name="mobile" id="mobile" size="32" class="validate[required]" maxlength="10"/>	
									</div>
								</div> <!-- .field-group -->
