...
if (isset($_POST['submit']))
{
	...
	$sql="INSERT INTO inv_uom (uom_name,uom_status,uom_mode) VALUES
             ('$uomname','$status','$uommode')";

$result = mysql_query($sql) or die("Could not insert data into DB: " . mysql_error());
    if($result){
        header("Location:inv_uom_new.php?msg=succ");
    }
    exit;
}
				...
				<div class="widget">
						...
						<div class="widget-content"> 
								<div class="field-group">
									...
									<div class="field">
										<input type="text" name="uomname" id="uomname" size="32" class="validate[required]" />	
									</div>
								</div> 
                                <!-- .field-group 
                                <div class="field-group">		
                                ...
                                <div class="field-group">		
									...
									<div class="field">
										<select name="uom_mode" id="uom_mode" class="required select2">
                                            ...
                                            <option value="1">Non Fixed</option>											
										</select>										
									</div>		
								</div> 
                                <!-- .field-group -->
