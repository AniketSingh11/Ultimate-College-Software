                ...
                <div class="grid-24">
                    ...
                    <div class="grid_12">
                        <div class="widget widget-table">
                            <div class="widget-header">
                                <h1>Paid Bill List</h1><span></span>
                            </div>
                    ...
                    if ($sdate && $edate) {
                        ...
                        $sum_qry = mysql_query("SELECT sum(overall_total) as total FROM inv_material_parent 
							...
							left join section on (s_id = section_id) where inv_material_parent.paid_status=1 and 
                        ...
                        <div class="block-actions">
                            ...
                            <ul class="actions-left">
                                ...
                                <li style="list-style:none;">
                                    <a href="inv_paid_excel.php?sdate=<?= $sdate; ?>&edate=<?= $edate; ?>" class="btn btn-success" >Download Report</a>
									<a href="inv_paid_print.php?sdate=<?= $sdate; ?>&edate=<?= $edate; ?>" target="_blank" class="btn btn-success" >print</a>
                        ...
                        <div class="widget widget-table">
                            ...
                            <div class="widget-header">
                                ...
                                <h3 class="icon chart"> Paid List</h3>		
                            </div>
