...
if ((isset($_GET['value']) && $_GET['value'] != '')) {
    ...
    $epid = $_GET['matid'];
    if ($epid) {
        $exbilllist = mysql_query("SELECT * FROM inv_material_payment WHERE mat_parent_id=$epid");
    ...
    if ($value == "card") {
        ...
        echo '
							...
							<div class="_25"><p>
                                ...
                                <input id="datepicker1" name="cheque_date" class="required datepicker" type="text" value="' . date('d/m/Y',strtotime($cdate)) . '" />
                            </p></div>
	...
	function bank_type() {
			...
			$.get("inv_payment_type.php",{baid:x},function(data){
			$( "#ajax_pay1" ).html(data);
			});	
		}
		bank_type();
    ...
    if ($_GET['cstatus'] == '2') {
        echo '
							<div class="_25"><p>
                                ...
                                <input id="datepicker2" name="debited_date" class="required datepicker" type="text" value="' . $cdate . '" />
                            </p></div>
							<script type="text/javascript">
							$( ".datepicker" ).datepicker({
                dateFormat: "dd/mm/yy"
...
if ((isset($_GET['feecheck']) && $_GET['feecheck'] != '')) {
    ...
    if ($_GET['feecheck'] == '2') {
        echo '
							<div class="_25"><p>
                                <label for="textfield">Debited Date</label>
                                <input id="datepicker2" name="debited_date" class="required datepicker" type="text" value="' . $date . '" />
                            </p></div>
							<script type="text/javascript">
							$( ".datepicker" ).datepicker({
                dateFormat: "dd/mm/yy"
