        ...
        <br>
            ...
            <br>        
               <table style="text-align:center; border-collapse:collapse;">
                ...
                <tr>
                <?php           
                    $fratelist=mysql_query("SELECT amount FROM others_bill_all WHERE std=$cid1");
                  ...
                  ?>
                    ...
                    <td style="border-right:0 !important;border-right:0 !important;"><?php echo number_format($frate,2);?></td>
                   </tr>      
                   <tr>
                    ...
                    <td style="border-bottom:0 !important;border-left:0 !important;"><?php
                        ...
                        $percent=($invoice['total']/$frate)*100;
                 ...
                 <tfoot>
                    <tr>
                     ...
                     <td style="border-right:0 !important;"><?php echo number_format($frate-$invoice['total'],2);?></td>
                    </tr>
                 </tfoot>
               </table>
