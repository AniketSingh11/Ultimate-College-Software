 ...
 if (isset($_POST['submit']))
{
	...
	if($class['c_name']=="XI" || $class['c_name']=="XII"){
		$gname=$_POST['gname'];
		$sql="INSERT INTO section (s_id,s_name,c_id,ay_id,g_name) VALUES ('','$sname','$cid','$acyear','$gname')";
	} else {
		$gname='';
		$sql="INSERT INTO section (s_id,s_name,c_id,ay_id,g_name) VALUES ('','$sname','$cid','$acyear','$gname')";
	}
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
                ...
                <li class="no-hover">Add New Section/Group</li>
			</ul>
            ...
            <?php } ?>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Add New Section/Group</h1><span></span>
					</div>
					<form id="validate-form" class="block-content form" action="" method="post">
						...
						<div class="_100">
							<p>
                                ...
                                <input id="textfield" name="sname" class="required" type="text" value="" />
                            </p>
						</div>
						<?php }	else {	?>
						<div class="_100">
