                            ...
                            <div id="invoice" class="widget widget-plain">			
                                ...
                                <div class="widget-content">
                                    <table class="table table-striped" id="table-example">	
                                        ...
                                        $etotal = 0;
                                        $qry1 = mysql_query("SELECT fund_amount FROM finvoice WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $startdate . "' AND '" . $enddate . "' AND ay_id=$acyear AND funds='1' and c_status!='1' AND i_status='0' AND fi_by='$user'");
                                        $sdf_total = 0;
                                ...
                                <td colspan="4" class="sub_total"><center><b>Other Fees</b></center></td>
                                        ...
                                        $bamountthisyear = 0;
                                        $bus_lastyear = 0;
                                        $booklist1 = mysql_query("SELECT * FROM bfinvoice WHERE (fi_year*10000) + (fi_month*100) + fi_day between '" . $startdate . "' AND '" . $enddate . "' AND ay_id=$acyear AND c_status!='1' AND i_status='0' AND bfi_by='$user'");
                                        $n=0;
                                        $cls='';
                                        $cle='';
